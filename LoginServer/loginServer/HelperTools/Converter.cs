namespace LoginServer.HelperTools
{
    ...
    public class Converter
    {
        ...
        {
            b[t++] = (byte) (a & ((ulong) 0xffL));
            b[t++] = (byte) ((a >> 8) & ((ulong) 0xffL));
            b[t++] = (byte) ((a >> 0x10) & ((ulong) 0xffL));
            b[t++] = (byte) ((a >> 0x18) & ((ulong) 0xffL));
            b[t++] = (byte) ((a >> 0x20) & ((ulong) 0xffL));
            b[t++] = (byte) ((a >> 40) & ((ulong) 0xffL));
            b[t++] = (byte) ((a >> 0x30) & ((ulong) 0xffL));
            b[t++] = (byte) ((a >> 0x38) & ((ulong) 0xffL));
        }
        ...
        public static void ToGuidMark(ulong a, byte[] b, ref int t)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                if (((a >> (8 * i)) & ((ulong) 0xffL)) != 0L)
                {
                    num = (byte) (num + ((byte) Math.Pow(2.0, (double) i)));
                    src[index] = (byte) ((a >> (8 * i)) & ((ulong) 0xffL));
                    index++;
                }
            }
            b[t++] = num;
        ...
        public static string ToString(byte[] bytes)
        {
            ...
            {
                builder.Append(Convert.ToString((short) num, 0x10).PadLeft(2, '0').ToUpper());
            }
