...
function MissIon508(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<13 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000668 = GetQuestItme(UserWorldId, 900000668, 10)
              if bool900000668 then
                  AddQuestItme(UserWorldId,900000668,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz400001=GetPackage(UserWorldId)
              if weiz400001==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,950)
              end
      end
