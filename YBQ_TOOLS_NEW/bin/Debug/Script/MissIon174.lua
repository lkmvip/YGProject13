...
function MissIon174(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<113 then
          ...
          elseif QuestLevel==2 then
              local  bool900000502 = GetQuestItme(UserWorldId, 900000502, 30)
              if bool900000502 then
                  AddQuestItme(UserWorldId,900000502,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              local weiz801=GetPackage(UserWorldId)
              if weiz801==-1 then
              ...
              if weiz800000024==-1 then
                  ...
                  AddItme(UserWorldId,800000024,weiz800000024,1)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,190000000)
              end
      end
