...
function MissIon128(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<87 then
          ...
          elseif QuestLevel==3 then
              local  bool900000394 = GetQuestItme(UserWorldId, 900000394, 100)
              if bool900000394 then
                  AddQuestItme(UserWorldId,900000394,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
