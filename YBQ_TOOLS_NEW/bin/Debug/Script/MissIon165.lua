...
function MissIon165(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<97 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000487 = GetQuestItme(UserWorldId, 900000487, 20)
              if bool900000487 then
                  AddQuestItme(UserWorldId,900000487,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz9001211=GetPackage(UserWorldId)
              if weiz9001211==-1 then
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,180000)
              end
      end
