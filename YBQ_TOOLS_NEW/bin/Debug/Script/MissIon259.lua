...
function MissIon259(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<120 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000567 = GetQuestItme(UserWorldId, 900000567, 30)
              if bool900000567 then
                  AddQuestItme(UserWorldId,900000567,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
