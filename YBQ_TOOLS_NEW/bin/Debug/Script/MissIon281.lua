...
function MissIon281(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<126 then
          ...
          elseif QuestLevel==2 then
              local  bool900000587 = GetQuestItme(UserWorldId, 900000587, 10)
              if bool900000587 then
                  AddQuestItme(UserWorldId,900000587,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000589 = GetQuestItme(UserWorldId, 900000589, 10)
              if bool900000589 then
                  AddQuestItme(UserWorldId,900000589,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==3 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,200000000)
              end
