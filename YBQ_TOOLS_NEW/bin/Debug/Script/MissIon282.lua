...
function MissIon282(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<128 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000593 = GetQuestItme(UserWorldId, 900000593, 1)
              if bool900000593 then
                  AddQuestItme(UserWorldId,900000593,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
