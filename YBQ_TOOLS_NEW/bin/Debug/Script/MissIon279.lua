...
function MissIon279(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<123 then
          ...
          elseif QuestLevel==2 then
              local  bool900000581 = GetQuestItme(UserWorldId, 900000581, 10)
              if bool900000581 then
                  AddQuestItme(UserWorldId,900000581,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000588 = GetQuestItme(UserWorldId, 900000588, 10)
              if bool900000588 then
                  AddQuestItme(UserWorldId,900000588,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
