...
function MissIon531(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<44 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000685 = GetQuestItme(UserWorldId, 900000685, 10)
              if bool900000685 then
                  AddQuestItme(UserWorldId,900000685,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
