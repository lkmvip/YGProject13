...
function MissIon365(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<120 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000634 = GetQuestItme(UserWorldId, 900000634, 1)
              if bool900000634 then
                  AddQuestItme(UserWorldId,900000634,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000005==-1 then
                  ...
                  AddItme(UserWorldId,909000005,weiz909000005,60)
              end
      end
