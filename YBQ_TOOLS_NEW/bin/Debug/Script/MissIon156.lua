...
function MissIon156(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<79 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000468 = GetQuestItme(UserWorldId, 900000468, 10)
              if bool900000468 then
                  AddQuestItme(UserWorldId,900000468,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
