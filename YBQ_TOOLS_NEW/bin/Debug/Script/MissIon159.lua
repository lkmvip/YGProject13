...
function MissIon159(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<85 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000471 = GetQuestItme(UserWorldId, 900000471, 20)
              if bool900000471 then
                  AddQuestItme(UserWorldId,900000471,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,55000)
              end
