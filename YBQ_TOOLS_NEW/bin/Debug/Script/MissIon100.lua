...
function MissIon100(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<77 then
          ...
          elseif QuestLevel==2 then
              local  bool900000307 = GetQuestItme(UserWorldId, 900000307, 5)
              if bool900000307 then
                  AddQuestItme(UserWorldId,900000307,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000308 = GetQuestItme(UserWorldId, 900000308, 10)
              if bool900000308 then
                  AddQuestItme(UserWorldId,900000308,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
