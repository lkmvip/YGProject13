...
function MissIon541(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<38 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000695 = GetQuestItme(UserWorldId, 900000695, 20)
              if bool900000695 then
                  AddQuestItme(UserWorldId,900000695,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
