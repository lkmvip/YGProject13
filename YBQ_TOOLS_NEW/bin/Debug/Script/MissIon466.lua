...
function MissIon466(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<125 then
          ...
          elseif QuestLevel==2 then
              local  bool909000043 = GetQuestItme(UserWorldId, 909000043, 20)
              if bool909000043 then
                  AddQuestItme(UserWorldId,909000043,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
