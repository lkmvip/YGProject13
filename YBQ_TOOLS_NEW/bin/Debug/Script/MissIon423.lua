...
function MissIon423(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<35 then
          ...
          elseif QuestLevel==2 then
              local  bool900000667 = GetQuestItme(UserWorldId, 900000667, 1)
              if bool900000667 then
                  AddQuestItme(UserWorldId,900000667,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
