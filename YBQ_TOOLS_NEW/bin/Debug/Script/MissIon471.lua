...
function MissIon471(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<130 then
          ...
          elseif QuestLevel==2 then
              local  bool909000054 = GetQuestItme(UserWorldId, 909000054, 1)
              if bool909000054 then
                  AddQuestItme(UserWorldId,909000054,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool909000053 = GetQuestItme(UserWorldId, 909000053, 10)
              if bool909000053 then
                  AddQuestItme(UserWorldId,909000053,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
