...
function MissIon65(UserWorldId,QuestId, CzId, RwJdId)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==3 then
              local weiz900000210=GetPackage(UserWorldId)
              if weiz900000210==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
                  AddItme(UserWorldId,900000210,weiz900000210,1)
              end
              ...
              if weiz909000004==-1 then
                  ...
                  AddItme(UserWorldId,909000004,weiz909000004,1200000)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,1700000)
              end
      end
