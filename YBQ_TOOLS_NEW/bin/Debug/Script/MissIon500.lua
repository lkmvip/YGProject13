...
function MissIon500(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<1 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000651 = GetQuestItme(UserWorldId, 900000651, 1)
              if bool900000651 then
                  AddQuestItme(UserWorldId,900000651,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz800002=GetPackage(UserWorldId)
              if weiz800002==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,90)
              end
      end
