...
function MissIon567(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<44 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000723 = GetQuestItme(UserWorldId, 900000723, 20)
              if bool900000723 then
                  AddQuestItme(UserWorldId,900000723,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz700004=GetPackage(UserWorldId)
              if weiz700004==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,360000)
              end
      end
