...
function MissIon424(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<60 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000766 = GetQuestItme(UserWorldId, 900000766, 1)
              if bool900000766 then
                  AddQuestItme(UserWorldId,900000766,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
