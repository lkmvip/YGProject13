...
function MissIon270(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<115 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000579 = GetQuestItme(UserWorldId, 900000579, 1)
              if bool900000579 then
                  AddQuestItme(UserWorldId,900000579,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
