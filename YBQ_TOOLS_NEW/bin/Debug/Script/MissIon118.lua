...
function MissIon118(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<82 then
          ...
          elseif QuestLevel==2 then
              local  bool900000338 = GetQuestItme(UserWorldId, 900000338, 5)
              if bool900000338 then
                  AddQuestItme(UserWorldId,900000338,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000339 = GetQuestItme(UserWorldId, 900000339, 10)
              if bool900000339 then
                  AddQuestItme(UserWorldId,900000339,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,15000000)
              end
              local weiz1008000348=GetPackage(UserWorldId)
              if weiz1008000348==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
