...
function MissIon82(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          elseif QuestLevel==4 then
              local  bool900000260 = GetQuestItme(UserWorldId, 900000260, 1)
              if bool900000260 then
                  AddQuestItme(UserWorldId,900000260,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=5
          ...
          elseif QuestLevel==5 then
              local  bool900000261 = GetQuestItme(UserWorldId, 900000261, 1)
              if bool900000261 then
                  AddQuestItme(UserWorldId,900000261,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=6
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==8 then
              ...
              if weiz909000004==-1 then
                  ...
                  AddItme(UserWorldId,909000004,weiz909000004,5000000)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,8500000)
              end
      end
