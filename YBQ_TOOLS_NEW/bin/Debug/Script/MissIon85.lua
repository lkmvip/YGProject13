...
function MissIon85(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<66 then
          ...
          elseif QuestLevel==5 then
              local  bool900000299 = GetQuestItme(UserWorldId, 900000299, 1)
              if bool900000299 then
                  AddQuestItme(UserWorldId,900000299,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=6
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==6 then
              local weiz9000085=GetPackage(UserWorldId)
              if weiz9000085==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,2600000)
              end
      end
