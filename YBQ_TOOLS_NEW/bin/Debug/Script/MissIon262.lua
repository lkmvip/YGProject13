...
function MissIon262(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<119 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000570 = GetQuestItme(UserWorldId, 900000570, 1)
              if bool900000570 then
                  AddQuestItme(UserWorldId,900000570,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz800000024==-1 then
                  ...
                  AddItme(UserWorldId,800000024,weiz800000024,3)
              end
