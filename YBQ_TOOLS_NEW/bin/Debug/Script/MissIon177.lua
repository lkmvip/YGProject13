...
function MissIon177(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<0 then
          ...
          elseif QuestLevel==2 then
              local  bool900000507 = GetQuestItme(UserWorldId, 900000507, 1)
              if bool900000507 then
                  AddQuestItme(UserWorldId,900000507,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==3 then
              local weiz1000000618=GetPackage(UserWorldId)
              if weiz1000000618==-1 then
