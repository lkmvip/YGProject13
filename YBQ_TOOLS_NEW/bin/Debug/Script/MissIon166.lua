...
function MissIon166(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<97 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000488 = GetQuestItme(UserWorldId, 900000488, 20)
              if bool900000488 then
                  AddQuestItme(UserWorldId,900000488,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
