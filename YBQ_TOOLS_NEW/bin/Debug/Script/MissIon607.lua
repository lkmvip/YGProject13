...
function MissIon607(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<10 then
          ...
          if QuestLevel==1 then
              ...
              local  bool200204001 = GetQuestItme(UserWorldId, 200204001, 1)
              if bool200204001 then
                  AddQuestItme(UserWorldId,200204001,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz200204002=GetPackage(UserWorldId)
              if weiz200204002==-1 then
