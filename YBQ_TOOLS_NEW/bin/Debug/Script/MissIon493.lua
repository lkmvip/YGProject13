...
function MissIon493(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddMoneyToCharacter(UserWorldId,2000000) 
                  SendSysMsg(UserWorldId,"Nhan duoc 2000000 tien vang!", 9, "He thong")
              AddQuestItme(UserWorldId,900000155,1) --them vat pham cho nhiem vu khac
        end 
