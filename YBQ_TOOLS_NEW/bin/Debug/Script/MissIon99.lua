...
function MissIon99(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<76 then
          ...
          elseif QuestLevel==2 then
              local  bool900000286 = GetQuestItme(UserWorldId, 900000286, 1)
              if bool900000286 then
                  AddQuestItme(UserWorldId,900000286,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000287 = GetQuestItme(UserWorldId, 900000287, 1)
              if bool900000287 then
                  AddQuestItme(UserWorldId,900000287,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
