...
function MissIon484(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<122 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool909000042 = GetQuestItme(UserWorldId, 909000042, 10)  --kiem tra vat pham nhiem vu
              if bool909000042 then --du yeu cau
                  AddQuestItme(UserWorldId,909000042,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 909000042 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
