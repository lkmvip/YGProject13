...
function MissIon67(UserWorldId,QuestId, CzId, RwJdId)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              ...
              if weiz800000001==-1 then
                  ...
                  AddItme(UserWorldId,800000001,weiz800000001,3)
              end
              ...
              if weiz800000002==-1 then
                  ...
                  AddItme(UserWorldId,800000002,weiz800000002,3)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,1850000)
              end
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,15000)
              end
      end
