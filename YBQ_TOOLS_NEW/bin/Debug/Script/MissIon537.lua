...
function MissIon537(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<36 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000691 = GetQuestItme(UserWorldId, 900000691, 10)
              if bool900000691 then
                  AddQuestItme(UserWorldId,900000691,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
