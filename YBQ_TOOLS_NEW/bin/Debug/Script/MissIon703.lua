...
function MissIon703(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<110 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000028 = GetQuestItme(UserWorldId, 909000028, 10)
              if bool909000028 then
                  AddQuestItme(UserWorldId,909000028,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
