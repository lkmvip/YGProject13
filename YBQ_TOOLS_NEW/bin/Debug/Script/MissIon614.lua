...
function MissIon614(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<130 then
          ...
          if QuestLevel==1 then
              ...
              local  bool200204008 = GetQuestItme(UserWorldId, 200204008, 1)
              if bool200204008 then
                  AddQuestItme(UserWorldId,200204008,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000762 = GetQuestItme(UserWorldId, 900000762, 4)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz200204009=GetPackage(UserWorldId)
              if weiz200204009==-1 then
