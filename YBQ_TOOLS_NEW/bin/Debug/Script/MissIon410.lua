...
function MissIon410(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<130 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000645 = GetQuestItme(UserWorldId, 900000645, 70)
              if bool900000645 then
                  AddQuestItme(UserWorldId,900000645,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
