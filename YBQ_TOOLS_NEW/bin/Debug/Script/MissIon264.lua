...
function MissIon264(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<118 then
          ...
          elseif QuestLevel==3 then
              local  bool900000573 = GetQuestItme(UserWorldId, 900000573, 1)
              if bool900000573 then
                  AddQuestItme(UserWorldId,900000573,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==5 then
              ...
              if weiz800000023==-1 then
                  ...
                  AddItme(UserWorldId,800000023,weiz800000023,4)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,250000000)
              end
      end
