...
function MissIon267(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<124 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000575 = GetQuestItme(UserWorldId, 900000575, 20)
              if bool900000575 then
                  AddQuestItme(UserWorldId,900000575,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
