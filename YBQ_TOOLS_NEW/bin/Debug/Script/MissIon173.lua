...
function MissIon173(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<111 then
          ...
          elseif QuestLevel==3 then
              local  bool900000501 = GetQuestItme(UserWorldId, 900000501, 100)
              if bool900000501 then
                  AddQuestItme(UserWorldId,900000501,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,170000000)
              end
