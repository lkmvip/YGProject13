...
function MissIon364(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<120 then
          ...
          if QuestLevel==1 then
              ...
              local  bool999000599 = GetQuestItme(UserWorldId, 999000599, 10)
              if bool999000599 then
                  AddQuestItme(UserWorldId,999000599,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
