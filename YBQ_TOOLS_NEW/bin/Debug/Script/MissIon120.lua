...
function MissIon120(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<83 then
          ...
          elseif QuestLevel==2 then
              local  bool900000343 = GetQuestItme(UserWorldId, 900000343, 1)
              if bool900000343 then
                  AddQuestItme(UserWorldId,900000343,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==3 then
              local weiz9000120=GetPackage(UserWorldId)
              if weiz9000120==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
                  AddItme(UserWorldId,9000120,weiz9000120,1)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,16400000)
              end
