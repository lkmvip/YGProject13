...
function MissIon171(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<107 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000495 = GetQuestItme(UserWorldId, 900000495, 10)
              if bool900000495 then
                  AddQuestItme(UserWorldId,900000495,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000496 = GetQuestItme(UserWorldId, 900000496, 10)
              if bool900000496 then
                  AddQuestItme(UserWorldId,900000496,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,130000000)
              end
      end
