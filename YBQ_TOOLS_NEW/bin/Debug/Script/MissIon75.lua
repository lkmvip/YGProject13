...
function MissIon75(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          elseif QuestLevel==2 then
              local  bool900000236 = GetQuestItme(UserWorldId, 900000236, 10)
              if bool900000236 then
                  AddQuestItme(UserWorldId,900000236,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==3 then
              local weiz900000237=GetPackage(UserWorldId)
              if weiz900000237==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
                  AddItme(UserWorldId,900000237,weiz900000237,1)
              end
