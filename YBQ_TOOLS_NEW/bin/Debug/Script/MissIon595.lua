...
function MissIon595(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<58 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000758 = GetQuestItme(UserWorldId, 900000758, 10)
              if bool900000758 then
                  AddQuestItme(UserWorldId,900000758,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
