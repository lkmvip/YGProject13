...
function MissIon193(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<4 then
          ...
          if QuestLevel==1 then
              ...
              local  bool1000000771 = GetQuestItme(UserWorldId, 1000000771, 1)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,400)
              end
      end
