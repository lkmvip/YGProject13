...
function MissIon140(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<92 then
          ...
          elseif QuestLevel==2 then
              local  bool900000358 = GetQuestItme(UserWorldId, 900000358, 30)
              if bool900000358 then
                  AddQuestItme(UserWorldId,900000358,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000359 = GetQuestItme(UserWorldId, 900000359, 1)
              if bool900000359 then
                  AddQuestItme(UserWorldId,900000359,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
