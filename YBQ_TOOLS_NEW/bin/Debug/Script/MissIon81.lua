...
function MissIon81(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          elseif QuestLevel==4 then
              local  bool900000254 = GetQuestItme(UserWorldId, 900000254, 1)
              if bool900000254 then
                  AddQuestItme(UserWorldId,900000254,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=5
          ...
          elseif QuestLevel==5 then
              local  bool900000255 = GetQuestItme(UserWorldId, 900000255, 1)
              if bool900000255 then
                  AddQuestItme(UserWorldId,900000255,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=6
