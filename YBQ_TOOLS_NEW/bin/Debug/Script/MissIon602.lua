...
function MissIon602(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<100 then
          ...
          if QuestLevel==1 then
              ...
              local  bool100204005 = GetQuestItme(UserWorldId, 100204005, 1)
              if bool100204005 then
                  AddQuestItme(UserWorldId,100204005,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz100204006=GetPackage(UserWorldId)
              if weiz100204006==-1 then
