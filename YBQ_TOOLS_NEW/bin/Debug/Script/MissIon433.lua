...
function MissIon433(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<125 then
          ...
          elseif QuestLevel==2 then
              local  bool900000776 = GetQuestItme(UserWorldId, 900000776, 40)
              if bool900000776 then
                  AddQuestItme(UserWorldId,900000776,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
