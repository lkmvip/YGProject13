...
function MissIon573(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<144 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000729 = GetQuestItme(UserWorldId, 900000729, 1)
              if bool900000729 then
                  AddQuestItme(UserWorldId,900000729,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
