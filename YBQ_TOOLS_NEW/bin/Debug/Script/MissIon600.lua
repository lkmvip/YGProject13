...
function MissIon600(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<60 then
          ...
          if QuestLevel==1 then
              ...
              local  bool100204003 = GetQuestItme(UserWorldId, 100204003, 1)
              if bool100204003 then
                  AddQuestItme(UserWorldId,100204003,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz100204004=GetPackage(UserWorldId)
              if weiz100204004==-1 then
