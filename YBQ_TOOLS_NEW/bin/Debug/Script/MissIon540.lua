...
function MissIon540(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<37 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000694 = GetQuestItme(UserWorldId, 900000694, 20)
              if bool900000694 then
                  AddQuestItme(UserWorldId,900000694,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
