...
function MissIon195(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<12 then
          ...
          elseif QuestLevel==2 then
              local  bool900000415 = GetQuestItme(UserWorldId, 900000415, 4)
              if bool900000415 then
                  AddQuestItme(UserWorldId,900000415,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
