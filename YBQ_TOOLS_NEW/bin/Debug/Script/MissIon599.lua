...
function MissIon599(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<35 then
          ...
          if QuestLevel==1 then
              ...
              local  bool100204002 = GetQuestItme(UserWorldId, 100204002, 1)
              if bool100204002 then
                  AddQuestItme(UserWorldId,100204002,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz100204003=GetPackage(UserWorldId)
              if weiz100204003==-1 then
