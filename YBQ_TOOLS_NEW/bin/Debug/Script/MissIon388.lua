...
function MissIon388(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000785 = GetQuestItme(UserWorldId, 900000785, 1)
              if bool900000785 then
                  AddQuestItme(UserWorldId,900000785,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1008001045=GetPackage(UserWorldId)
              if weiz1008001045==-1 then
