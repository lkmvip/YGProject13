...
function MissIon517(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<23 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000669 = GetQuestItme(UserWorldId, 900000669, 10)
              if bool900000669 then
                  AddQuestItme(UserWorldId,900000669,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz400002=GetPackage(UserWorldId)
              if weiz400002==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,9500)
              end
      end
