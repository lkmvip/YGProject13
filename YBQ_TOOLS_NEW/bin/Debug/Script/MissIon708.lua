...
function MissIon708(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<100 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000033 = GetQuestItme(UserWorldId, 909000033, 1)
              if bool909000033 then
                  AddQuestItme(UserWorldId,909000033,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
