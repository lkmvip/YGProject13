...
function MissIon581(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<148 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000737 = GetQuestItme(UserWorldId, 900000737, 20)
              if bool900000737 then
                  AddQuestItme(UserWorldId,900000737,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
