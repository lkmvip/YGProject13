...
function MissIon147(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<97 then
          ...
          elseif QuestLevel==2 then
              local  bool900000368 = GetQuestItme(UserWorldId, 900000368, 1)
              if bool900000368 then
                  AddQuestItme(UserWorldId,900000368,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000369 = GetQuestItme(UserWorldId, 900000369, 25)
              if bool900000369 then
                  AddQuestItme(UserWorldId,900000369,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
