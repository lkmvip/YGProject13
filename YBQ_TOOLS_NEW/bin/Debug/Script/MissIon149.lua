...
function MissIon149(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<98 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000371 = GetQuestItme(UserWorldId, 900000371, 50)
              if bool900000371 then
                  AddQuestItme(UserWorldId,900000371,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
