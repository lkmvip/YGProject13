...
function MissIon358(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<128 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000620 = GetQuestItme(UserWorldId, 900000620, 1)
              if bool900000620 then
                  AddQuestItme(UserWorldId,900000620,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1000000714=GetPackage(UserWorldId)
              if weiz1000000714==-1 then
