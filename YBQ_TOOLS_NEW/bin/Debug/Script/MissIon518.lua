...
function MissIon518(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<26 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000660 = GetQuestItme(UserWorldId, 900000660, 1)
              if bool900000660 then
                  AddQuestItme(UserWorldId,900000660,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz800000002==-1 then
                  ...
                  AddItme(UserWorldId,800000002,weiz800000002,4)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,16500)
              end
      end
