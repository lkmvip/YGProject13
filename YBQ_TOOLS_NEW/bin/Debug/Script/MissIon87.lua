...
function MissIon87(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<68 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000301 = GetQuestItme(UserWorldId, 900000301, 20)
              if bool900000301 then
                  AddQuestItme(UserWorldId,900000301,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,25000)
              end
              ...
              if weiz909000004==-1 then
                  ...
                  AddItme(UserWorldId,909000004,weiz909000004,1800000)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,3700000)
              end
      end
