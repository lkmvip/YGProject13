...
function MissIon135(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<88 then
          ...
          elseif QuestLevel==2 then
              local  bool900000349 = GetQuestItme(UserWorldId, 900000349, 20)
              if bool900000349 then
                  AddQuestItme(UserWorldId,900000349,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
