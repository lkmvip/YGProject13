...
function MissIon143(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<94 then
          ...
          elseif QuestLevel==2 then
              local  bool900000353 = GetQuestItme(UserWorldId, 900000353, 20)
              if bool900000353 then
                  AddQuestItme(UserWorldId,900000353,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
