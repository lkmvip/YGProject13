...
function MissIon503(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<4 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000654 = GetQuestItme(UserWorldId, 900000654, 5)
              if bool900000654 then
                  AddQuestItme(UserWorldId,900000654,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1000000322=GetPackage(UserWorldId)
              if weiz1000000322==-1 then
