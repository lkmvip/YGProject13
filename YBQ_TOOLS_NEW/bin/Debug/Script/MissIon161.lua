...
function MissIon161(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<89 then
          ...
          elseif QuestLevel==3 then
              local  bool900000477 = GetQuestItme(UserWorldId, 900000477, 1)
              if bool900000477 then
                  AddQuestItme(UserWorldId,900000477,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,80000)
              end
