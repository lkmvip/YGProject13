...
function MissIon701(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000026 = GetQuestItme(UserWorldId, 909000026, 10)
              if bool909000026 then
                  AddQuestItme(UserWorldId,909000026,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
