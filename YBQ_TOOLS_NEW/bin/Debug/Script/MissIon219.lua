...
function MissIon219(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<0 then
          ...
          if QuestLevel==1 then
              ...
              local  bool1000000449 = GetQuestItme(UserWorldId, 1000000449, 1)
              if bool1000000449 then
                  AddQuestItme(UserWorldId,1000000449,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
