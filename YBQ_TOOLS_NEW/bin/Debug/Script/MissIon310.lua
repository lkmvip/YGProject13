...
function MissIon310(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<0 then
          ...
          if QuestLevel==1 then
              ...
              local  bool1008000217 = GetQuestItme(UserWorldId, 1008000217, 1)
              if bool1008000217 then
                  AddQuestItme(UserWorldId,1008000217,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1000000416=GetPackage(UserWorldId)
              if weiz1000000416==-1 then
