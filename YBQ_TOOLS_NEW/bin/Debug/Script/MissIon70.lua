...
function MissIon70(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<63 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000206 = GetQuestItme(UserWorldId, 900000206, 15)
              if bool900000206 then
                  AddQuestItme(UserWorldId,900000206,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
