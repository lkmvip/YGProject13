...
function MissIon458(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<120 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000800 = GetQuestItme(UserWorldId, 900000800, 1)
              if bool900000800 then
                  AddQuestItme(UserWorldId,900000800,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
