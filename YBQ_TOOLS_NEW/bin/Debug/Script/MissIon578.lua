...
function MissIon578(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<140 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000734 = GetQuestItme(UserWorldId, 900000734, 1)
              if bool900000734 then
                  AddQuestItme(UserWorldId,900000734,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1000000638=GetPackage(UserWorldId)
              if weiz1000000638==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,1700000000)
              end
      end
