...
function MissIon702(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<100 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000027 = GetQuestItme(UserWorldId, 909000027, 10)
              if bool909000027 then
                  AddQuestItme(UserWorldId,909000027,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
