...
function MissIon613(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<120 then
          ...
          if QuestLevel==1 then
              ...
              local  bool200204007 = GetQuestItme(UserWorldId, 200204007, 1)
              if bool200204007 then
                  AddQuestItme(UserWorldId,200204007,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000762 = GetQuestItme(UserWorldId, 900000762, 3)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz200204008=GetPackage(UserWorldId)
              if weiz200204008==-1 then
