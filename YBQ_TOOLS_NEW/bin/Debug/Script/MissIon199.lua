...
function MissIon199(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<25 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000413 = GetQuestItme(UserWorldId, 900000413, 5)
              if bool900000413 then
                  AddQuestItme(UserWorldId,900000413,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,13500)
              end
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,5000)
              end
      end
