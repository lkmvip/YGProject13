...
function MissIon350(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<117 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000623 = GetQuestItme(UserWorldId, 900000623, 1)
              if bool900000623 then
                  AddQuestItme(UserWorldId,900000623,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
