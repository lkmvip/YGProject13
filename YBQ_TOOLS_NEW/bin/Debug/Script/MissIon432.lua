...
function MissIon432(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<122 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000775 = GetQuestItme(UserWorldId, 900000775, 10)
              if bool900000775 then
                  AddQuestItme(UserWorldId,900000775,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
