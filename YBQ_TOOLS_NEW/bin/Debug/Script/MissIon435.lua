...
function MissIon435(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<127 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000779 = GetQuestItme(UserWorldId, 900000779, 10)
              if bool900000779 then
                  AddQuestItme(UserWorldId,900000779,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
