...
function MissIon465(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<122 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000042 = GetQuestItme(UserWorldId, 909000042, 10)
              if bool909000042 then
                  AddQuestItme(UserWorldId,909000042,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
