...
function MissIon456(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<100 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000798 = GetQuestItme(UserWorldId, 900000798, 1)
              if bool900000798 then
                  AddQuestItme(UserWorldId,900000798,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
