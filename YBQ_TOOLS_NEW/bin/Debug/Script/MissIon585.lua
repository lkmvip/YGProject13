...
function MissIon585(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<136 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000741 = GetQuestItme(UserWorldId, 900000741, 5)
              if bool900000741 then
                  AddQuestItme(UserWorldId,900000741,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1008000080=GetPackage(UserWorldId)
              if weiz1008000080==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,1000000000)
              end
      end
