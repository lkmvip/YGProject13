...
function MissIon83(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<65 then
          ...
          elseif QuestLevel==2 then
              local  bool900000290 = GetQuestItme(UserWorldId, 900000290, 1)
              if bool900000290 then
                  AddQuestItme(UserWorldId,900000290,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000291 = GetQuestItme(UserWorldId, 900000291, 1)
              if bool900000291 then
                  AddQuestItme(UserWorldId,900000291,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
          ...
          elseif QuestLevel==4 then
              local  bool900000292 = GetQuestItme(UserWorldId, 900000292, 1)
              if bool900000292 then
                  AddQuestItme(UserWorldId,900000292,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=5
