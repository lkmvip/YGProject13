...
function MissIon545(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<49 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000699 = GetQuestItme(UserWorldId, 900000699, 15)
              if bool900000699 then
                  AddQuestItme(UserWorldId,900000699,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz9000545=GetPackage(UserWorldId)
              if weiz9000545==-1 then
