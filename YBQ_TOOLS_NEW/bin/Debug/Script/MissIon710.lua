...
function MissIon710(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<120 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000035 = GetQuestItme(UserWorldId, 909000035, 1)
              if bool909000035 then
                  AddQuestItme(UserWorldId,909000035,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
