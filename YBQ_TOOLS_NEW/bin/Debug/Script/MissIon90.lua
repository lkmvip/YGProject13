...
function MissIon90(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<71 then
          ...
          elseif QuestLevel==4 then
              local  bool900000263 = GetQuestItme(UserWorldId, 900000263, 1)
              if bool900000263 then
                  AddQuestItme(UserWorldId,900000263,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=5
