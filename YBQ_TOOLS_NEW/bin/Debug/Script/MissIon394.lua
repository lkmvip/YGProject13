...
function MissIon394(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<35 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000787 = GetQuestItme(UserWorldId, 900000787, 3)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1008001327=GetPackage(UserWorldId)
              if weiz1008001327==-1 then
