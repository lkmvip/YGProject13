...
function MissIon21(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000404 = GetQuestItme(UserWorldId, 900000404, 2)
              if bool900000404 then
                  AddQuestItme(UserWorldId,900000404,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
