...
function MissIon175(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<114 then
          ...
          elseif QuestLevel==2 then
              local  bool900000503 = GetQuestItme(UserWorldId, 900000503, 10)
              if bool900000503 then
                  AddQuestItme(UserWorldId,900000503,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==4 then
              local  bool900000504 = GetQuestItme(UserWorldId, 900000504, 10)
              if bool900000504 then
                  AddQuestItme(UserWorldId,900000504,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=5
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==5 then
              local weiz100801=GetPackage(UserWorldId)
              if weiz100801==-1 then
