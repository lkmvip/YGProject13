...
function MissIon609(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<60 then
          ...
          if QuestLevel==1 then
              ...
              local  bool200204003 = GetQuestItme(UserWorldId, 200204003, 1)
              if bool200204003 then
                  AddQuestItme(UserWorldId,200204003,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000762 = GetQuestItme(UserWorldId, 900000762, 1)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz200204004=GetPackage(UserWorldId)
              if weiz200204004==-1 then
