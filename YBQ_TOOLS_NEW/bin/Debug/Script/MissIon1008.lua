...
function MissIon1008(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<0 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000420 = GetQuestItme(UserWorldId, 900000420, 20)
              if bool900000420 then
                  AddQuestItme(UserWorldId,900000420,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
