...
function MissIon611(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<100 then
          ...
          if QuestLevel==1 then
              ...
              local  bool200204005 = GetQuestItme(UserWorldId, 200204005, 1)
              if bool200204005 then
                  AddQuestItme(UserWorldId,200204005,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz200204006=GetPackage(UserWorldId)
              if weiz200204006==-1 then
