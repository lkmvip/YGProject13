...
function MissIon560(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<36 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000716 = GetQuestItme(UserWorldId, 900000716, 10)
              if bool900000716 then
                  AddQuestItme(UserWorldId,900000716,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz800000001==-1 then
                  ...
                  AddItme(UserWorldId,800000001,weiz800000001,4)
              end
              local weiz700005=GetPackage(UserWorldId)
              if weiz700005==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,45000)
              end
      end
