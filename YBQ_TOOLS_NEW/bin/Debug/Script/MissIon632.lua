...
--Ten nhiem vu: ([GM] [????? 3? ??]) --- So buoc: (1)
function MissIon632(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool430203004 = GetQuestItme(UserWorldId, 430203004, 1)  --kiem tra vat pham nhiem vu
              local  bool900000762 = GetQuestItme(UserWorldId, 900000762, 1)  --kiem tra vat pham nhiem vu
              if bool430203004 then --du yeu cau
              if bool900000762 then --du yeu cau
                  AddQuestItme(UserWorldId,430203004,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<60 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,430203004,1) --them vat pham nhiem vu cho buoc tiep theo
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz430203005=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,430203005,weiz430203005,1) 
        end 
