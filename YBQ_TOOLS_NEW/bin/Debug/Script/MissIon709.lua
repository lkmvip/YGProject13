...
function MissIon709(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<110 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000034 = GetQuestItme(UserWorldId, 909000034, 1)
              if bool909000034 then
                  AddQuestItme(UserWorldId,909000034,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
