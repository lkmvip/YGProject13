...
function MissIon190(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<100 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000533 = GetQuestItme(UserWorldId, 900000533, 10)
              if bool900000533 then
                  AddQuestItme(UserWorldId,900000533,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000534 = GetQuestItme(UserWorldId, 900000534, 10)
              if bool900000534 then
                  AddQuestItme(UserWorldId,900000534,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
