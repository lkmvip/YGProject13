...
function MissIon266(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<122 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000574 = GetQuestItme(UserWorldId, 900000574, 1)
              if bool900000574 then
                  AddQuestItme(UserWorldId,900000574,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
