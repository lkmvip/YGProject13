...
function MissIon141(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<92 then
          ...
          elseif QuestLevel==2 then
              local  bool900000361 = GetQuestItme(UserWorldId, 900000361, 1)
              if bool900000361 then
                  AddQuestItme(UserWorldId,900000361,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              ...
              if weiz800000004==-1 then
                  ...
                  AddItme(UserWorldId,800000004,weiz800000004,5)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,36500000)
              end
      end
