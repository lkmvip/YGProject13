...
function MissIon84(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<65 then
          ...
          elseif QuestLevel==2 then
              local  bool900000295 = GetQuestItme(UserWorldId, 900000295, 1)
              if bool900000295 then
                  AddQuestItme(UserWorldId,900000295,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000296 = GetQuestItme(UserWorldId, 900000296, 1)
              if bool900000296 then
                  AddQuestItme(UserWorldId,900000296,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
          ...
          elseif QuestLevel==4 then
              local  bool900000297 = GetQuestItme(UserWorldId, 900000297, 1)
              if bool900000297 then
                  AddQuestItme(UserWorldId,900000297,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=5
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==5 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,2400000)
              end
