...
function MissIon565(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<46 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000721 = GetQuestItme(UserWorldId, 900000721, 20)
              if bool900000721 then
                  AddQuestItme(UserWorldId,900000721,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
