...
function MissIon86(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<67 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000300 = GetQuestItme(UserWorldId, 900000300, 20)
              if bool900000300 then
                  AddQuestItme(UserWorldId,900000300,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,3100000)
              end
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,20000)
              end
      end
