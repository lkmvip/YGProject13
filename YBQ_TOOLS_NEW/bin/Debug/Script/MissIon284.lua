...
function MissIon284(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<130 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000590 = GetQuestItme(UserWorldId, 900000590, 1)
              if bool900000590 then
                  AddQuestItme(UserWorldId,900000590,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
