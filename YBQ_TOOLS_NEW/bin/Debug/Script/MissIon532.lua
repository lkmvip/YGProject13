...
function MissIon532(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<45 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000686 = GetQuestItme(UserWorldId, 900000686, 1)
              if bool900000686 then
                  AddQuestItme(UserWorldId,900000686,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
