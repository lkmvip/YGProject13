...
function MissIon542(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<46 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000696 = GetQuestItme(UserWorldId, 900000696, 20)
              if bool900000696 then
                  AddQuestItme(UserWorldId,900000696,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,500000)
              end
              ...
              if weiz1000000002==-1 then
                  ...
                  AddItme(UserWorldId,1000000002,weiz1000000002,4)
              end
