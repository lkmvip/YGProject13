...
function MissIon167(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<99 then
          ...
          elseif QuestLevel==2 then
              local  bool900000489 = GetQuestItme(UserWorldId, 900000489, 25)
              if bool900000489 then
                  AddQuestItme(UserWorldId,900000489,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,64000000)
              end
              ...
              if weiz800000004==-1 then
                  ...
                  AddItme(UserWorldId,800000004,weiz800000004,4)
              end
              local weiz1000000034=GetPackage(UserWorldId)
              if weiz1000000034==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
