...
function MissIon91(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<71 then
          ...
          elseif QuestLevel==4 then
              local  bool900000265 = GetQuestItme(UserWorldId, 900000265, 1)
              if bool900000265 then
                  AddQuestItme(UserWorldId,900000265,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=5
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==5 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,5700000)
              end
      end
