...
function MissIon145(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<95 then
          ...
          elseif QuestLevel==2 then
              local  bool900000364 = GetQuestItme(UserWorldId, 900000364, 30)
              if bool900000364 then
                  AddQuestItme(UserWorldId,900000364,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000365 = GetQuestItme(UserWorldId, 900000365, 1)
              if bool900000365 then
                  AddQuestItme(UserWorldId,900000365,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
