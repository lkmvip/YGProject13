...
--Ten nhiem vu: ([GM] [??? ?? ?1?] ????!!) --- So buoc: (2)
function MissIon481(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<110 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000799 = GetQuestItme(UserWorldId, 900000799, 1)  --kiem tra vat pham nhiem vu
              if bool900000799 then --du yeu cau
              AddQuestItme(UserWorldId,900000799,0) --xoa vat pham nhiem vu
              StatusQuest=2 
      ...
      if Player.Player_FLD_LEVEL<110 then  
         ...
         if QuestLevel==3 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000799,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
            AddQuest(UserWorldId,QuestId, StatusQuest)
