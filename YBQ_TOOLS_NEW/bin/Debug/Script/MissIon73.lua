...
function MissIon73(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          elseif QuestLevel==3 then
              local  bool900000227 = GetQuestItme(UserWorldId, 900000227, 1)
              if bool900000227 then
                  AddQuestItme(UserWorldId,900000227,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
          ...
          elseif QuestLevel==5 then
              local  bool900000228 = GetQuestItme(UserWorldId, 900000228, 1)
              if bool900000228 then
                  AddQuestItme(UserWorldId,900000228,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=6
          ...
          elseif QuestLevel==6 then
              local  bool900000229 = GetQuestItme(UserWorldId, 900000229, 1)
              if bool900000229 then
                  AddQuestItme(UserWorldId,900000229,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=7
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==8 then
              local weiz900000230=GetPackage(UserWorldId)
              if weiz900000230==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
                  AddItme(UserWorldId,900000230,weiz900000230,1)
              end
