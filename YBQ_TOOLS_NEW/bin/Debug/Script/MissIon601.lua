...
function MissIon601(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          if QuestLevel==1 then
              ...
              local  bool100204004 = GetQuestItme(UserWorldId, 100204004, 1)
              if bool100204004 then
                  AddQuestItme(UserWorldId,100204004,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz100204005=GetPackage(UserWorldId)
              if weiz100204005==-1 then
