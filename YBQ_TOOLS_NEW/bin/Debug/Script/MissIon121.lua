...
function MissIon121(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<83 then
          ...
          elseif QuestLevel==2 then
              local  bool900000345 = GetQuestItme(UserWorldId, 900000345, 1)
              if bool900000345 then
                  AddQuestItme(UserWorldId,900000345,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
