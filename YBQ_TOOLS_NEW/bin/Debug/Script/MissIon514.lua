...
function MissIon514(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<19 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000677 = GetQuestItme(UserWorldId, 900000677, 10)
              if bool900000677 then
                  AddQuestItme(UserWorldId,900000677,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,4200)
              end
      end
