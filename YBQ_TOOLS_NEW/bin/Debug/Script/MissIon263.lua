...
function MissIon263(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<121 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000571 = GetQuestItme(UserWorldId, 900000571, 1)
              if bool900000571 then
                  AddQuestItme(UserWorldId,900000571,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
