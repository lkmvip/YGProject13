...
function MissIon251(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<122 then
          ...
          elseif QuestLevel==3 then
              local  bool900000557 = GetQuestItme(UserWorldId, 900000557, 50)
              if bool900000557 then
                  AddQuestItme(UserWorldId,900000557,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              local weiz900000591=GetPackage(UserWorldId)
              if weiz900000591==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
                  AddItme(UserWorldId,900000591,weiz900000591,1)
              end
