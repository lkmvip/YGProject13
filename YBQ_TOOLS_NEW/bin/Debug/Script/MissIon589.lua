...
function MissIon589(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<137 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000745 = GetQuestItme(UserWorldId, 900000745, 20)
              if bool900000745 then
                  AddQuestItme(UserWorldId,900000745,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz800000062=GetPackage(UserWorldId)
              if weiz800000062==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,1100000000)
              end
      end
