...
function MissIon588(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<134 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000744 = GetQuestItme(UserWorldId, 900000744, 20)
              if bool900000744 then
                  AddQuestItme(UserWorldId,900000744,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1008000079=GetPackage(UserWorldId)
              if weiz1008000079==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,800000000)
              end
      end
