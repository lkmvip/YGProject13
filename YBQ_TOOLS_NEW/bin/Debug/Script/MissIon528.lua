...
function MissIon528(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<39 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000682 = GetQuestItme(UserWorldId, 900000682, 1)
              if bool900000682 then
                  AddQuestItme(UserWorldId,900000682,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz9000528=GetPackage(UserWorldId)
              if weiz9000528==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,160000)
              end
