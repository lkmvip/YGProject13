...
function MissIon705(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<100 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000030 = GetQuestItme(UserWorldId, 909000030, 20)
              if bool909000030 then
                  AddQuestItme(UserWorldId,909000030,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
