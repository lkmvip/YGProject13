...
function MissIon544(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<43 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000698 = GetQuestItme(UserWorldId, 900000698, 5)
              if bool900000698 then
                  AddQuestItme(UserWorldId,900000698,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
