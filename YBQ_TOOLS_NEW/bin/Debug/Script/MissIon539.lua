...
function MissIon539(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<36 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000693 = GetQuestItme(UserWorldId, 900000693, 15)
              if bool900000693 then
                  AddQuestItme(UserWorldId,900000693,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
