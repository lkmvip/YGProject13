...
function MissIon155(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<77 then
          ...
          elseif QuestLevel==2 then
              local  bool900000486 = GetQuestItme(UserWorldId, 900000486, 1)
              if bool900000486 then
                  AddQuestItme(UserWorldId,900000486,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==3 then
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,40000)
              end
      end
