...
function MissIon715(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<135 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000040 = GetQuestItme(UserWorldId, 909000040, 1)
              if bool909000040 then
                  AddQuestItme(UserWorldId,909000040,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,1350000)
              end
      end
