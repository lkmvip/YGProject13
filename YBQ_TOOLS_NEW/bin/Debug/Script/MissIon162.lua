...
function MissIon162(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<91 then
          ...
          elseif QuestLevel==4 then
              local  bool900000479 = GetQuestItme(UserWorldId, 900000479, 1)
              if bool900000479 then
                  AddQuestItme(UserWorldId,900000479,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=5
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==5 then
              local weiz1000000159=GetPackage(UserWorldId)
              if weiz1000000159==-1 then
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,100000)
              end
      end
