...
function MissIon604(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<120 then
          ...
          if QuestLevel==1 then
              ...
              local  bool100204007 = GetQuestItme(UserWorldId, 100204007, 1)
              if bool100204007 then
                  AddQuestItme(UserWorldId,100204007,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz100204008=GetPackage(UserWorldId)
              if weiz100204008==-1 then
