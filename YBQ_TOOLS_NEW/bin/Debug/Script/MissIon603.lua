...
function MissIon603(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<110 then
          ...
          if QuestLevel==1 then
              ...
              local  bool100204006 = GetQuestItme(UserWorldId, 100204006, 1)
              if bool100204006 then
                  AddQuestItme(UserWorldId,100204006,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz100204007=GetPackage(UserWorldId)
              if weiz100204007==-1 then
