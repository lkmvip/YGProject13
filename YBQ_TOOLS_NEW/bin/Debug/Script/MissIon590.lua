...
function MissIon590(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<143 then
          ...
          elseif QuestLevel==3 then
              local  bool900000746 = GetQuestItme(UserWorldId, 900000746, 1)
              if bool900000746 then
                  AddQuestItme(UserWorldId,900000746,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
