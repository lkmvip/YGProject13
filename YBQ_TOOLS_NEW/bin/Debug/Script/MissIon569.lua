...
function MissIon569(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<50 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000725 = GetQuestItme(UserWorldId, 900000725, 10)
              if bool900000725 then
                  AddQuestItme(UserWorldId,900000725,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
