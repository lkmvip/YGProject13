...
function MissIon200(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<0 then
          ...
          if QuestLevel==1 then
              ...
              local  bool999000135 = GetQuestItme(UserWorldId, 999000135, 1)
              if bool999000135 then
                  AddQuestItme(UserWorldId,999000135,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
