...
function MissIon172(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<109 then
          ...
          elseif QuestLevel==2 then
              local  bool900000497 = GetQuestItme(UserWorldId, 900000497, 1)
              if bool900000497 then
                  AddQuestItme(UserWorldId,900000497,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000499 = GetQuestItme(UserWorldId, 900000499, 10)
              if bool900000499 then
                  AddQuestItme(UserWorldId,900000499,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
          ...
          elseif QuestLevel==5 then
              local  bool900000498 = GetQuestItme(UserWorldId, 900000498, 1)
              if bool900000498 then
                  AddQuestItme(UserWorldId,900000498,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=6
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==6 then
              local weiz1008000068=GetPackage(UserWorldId)
              if weiz1008000068==-1 then
