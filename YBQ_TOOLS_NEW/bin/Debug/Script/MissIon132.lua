...
function MissIon132(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<93 then
          ...
          elseif QuestLevel==3 then
              local  bool900000398 = GetQuestItme(UserWorldId, 900000398, 2)
              if bool900000398 then
                  AddQuestItme(UserWorldId,900000398,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,130000)
              end
      end
