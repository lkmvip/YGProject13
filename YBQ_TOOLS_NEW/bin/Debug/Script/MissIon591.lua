...
function MissIon591(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<133 then
          ...
          elseif QuestLevel==2 then
              local  bool900000747 = GetQuestItme(UserWorldId, 900000747, 20)
              if bool900000747 then
                  AddQuestItme(UserWorldId,900000747,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
