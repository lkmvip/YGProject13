...
function MissIon580(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<147 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000736 = GetQuestItme(UserWorldId, 900000736, 20)
              if bool900000736 then
                  AddQuestItme(UserWorldId,900000736,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
