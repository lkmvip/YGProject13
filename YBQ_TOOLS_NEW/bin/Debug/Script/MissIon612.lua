...
function MissIon612(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<110 then
          ...
          if QuestLevel==1 then
              ...
              local  bool200204006 = GetQuestItme(UserWorldId, 200204006, 1)
              if bool200204006 then
                  AddQuestItme(UserWorldId,200204006,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000762 = GetQuestItme(UserWorldId, 900000762, 2)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz200204007=GetPackage(UserWorldId)
              if weiz200204007==-1 then
