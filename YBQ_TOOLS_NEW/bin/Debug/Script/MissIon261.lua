...
function MissIon261(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<116 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000569 = GetQuestItme(UserWorldId, 900000569, 1)
              if bool900000569 then
                  AddQuestItme(UserWorldId,900000569,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
