...
function MissIon77(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          elseif QuestLevel==2 then
              local  bool900000240 = GetQuestItme(UserWorldId, 900000240, 50)
              if bool900000240 then
                  AddQuestItme(UserWorldId,900000240,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==5 then
              local  bool900000240 = GetQuestItme(UserWorldId, 900000240, 10)
              if bool900000240 then
                  AddQuestItme(UserWorldId,900000240,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
          ...
          elseif QuestLevel==6 then
              local  bool900000240 = GetQuestItme(UserWorldId, 900000240, 100)
              if bool900000240 then
                  AddQuestItme(UserWorldId,900000240,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==7 then
              local weiz900000241=GetPackage(UserWorldId)
              if weiz900000241==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
                  AddItme(UserWorldId,900000241,weiz900000241,1)
              end
