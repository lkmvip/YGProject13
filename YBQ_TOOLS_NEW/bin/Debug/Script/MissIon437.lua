...
function MissIon437(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<130 then
          ...
          elseif QuestLevel==2 then
              local  bool900000782 = GetQuestItme(UserWorldId, 900000782, 3)
              if bool900000782 then
                  AddQuestItme(UserWorldId,900000782,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
