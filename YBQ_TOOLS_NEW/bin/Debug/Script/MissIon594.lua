...
function MissIon594(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<56 then
          ...
          elseif QuestLevel==2 then
              local  bool900000757 = GetQuestItme(UserWorldId, 900000757, 10)
              if bool900000757 then
                  AddQuestItme(UserWorldId,900000757,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
