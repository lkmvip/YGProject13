...
function MissIon572(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<53 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000728 = GetQuestItme(UserWorldId, 900000728, 20)
              if bool900000728 then
                  AddQuestItme(UserWorldId,900000728,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1008000268=GetPackage(UserWorldId)
              if weiz1008000268==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,1230000)
              end
      end
