...
function MissIon105(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<79 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000320 = GetQuestItme(UserWorldId, 900000320, 20)
              if bool900000320 then
                  AddQuestItme(UserWorldId,900000320,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
