...
function MissIon351(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<117 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000624 = GetQuestItme(UserWorldId, 900000624, 1)
              if bool900000624 then
                  AddQuestItme(UserWorldId,900000624,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
