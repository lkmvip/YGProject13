...
function MissIon492(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000790 = GetQuestItme(UserWorldId, 900000790, 10)  --kiem tra vat pham nhiem vu
              local  bool900000791 = GetQuestItme(UserWorldId, 900000791, 10)  --kiem tra vat pham nhiem vu
              local  bool900000792 = GetQuestItme(UserWorldId, 900000792, 10)  --kiem tra vat pham nhiem vu
              if bool900000790 then --du yeu cau
              if bool900000791 then --du yeu cau
              if bool900000792 then --du yeu cau
                  AddQuestItme(UserWorldId,900000790,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000791,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000792,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000790 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000791 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000792 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
