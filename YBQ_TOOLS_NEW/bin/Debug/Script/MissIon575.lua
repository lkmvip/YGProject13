...
function MissIon575(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<149 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000731 = GetQuestItme(UserWorldId, 900000731, 10)
              if bool900000731 then
                  AddQuestItme(UserWorldId,900000731,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
