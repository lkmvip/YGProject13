...
function MissIon587(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<133 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000743 = GetQuestItme(UserWorldId, 900000743, 20)
              if bool900000743 then
                  AddQuestItme(UserWorldId,900000743,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
