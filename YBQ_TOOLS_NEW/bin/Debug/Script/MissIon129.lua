...
function MissIon129(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<87 then
          ...
          elseif QuestLevel==3 then
              local  bool900000395 = GetQuestItme(UserWorldId, 900000395, 100)
              if bool900000395 then
                  AddQuestItme(UserWorldId,900000395,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              ...
              if weiz800000001==-1 then
                  ...
                  AddItme(UserWorldId,800000001,weiz800000001,1)
              end
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,60000)
              end
      end
