...
function MissIon429(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<130 then
          ...
          elseif QuestLevel==2 then
              local  bool900000771 = GetQuestItme(UserWorldId, 900000771, 1)
              if bool900000771 then
                  AddQuestItme(UserWorldId,900000771,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000773 = GetQuestItme(UserWorldId, 900000773, 1)
              if bool900000773 then
                  AddQuestItme(UserWorldId,900000773,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
