...
function MissIon366(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<60 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000600 = GetQuestItme(UserWorldId, 900000600, 30)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1000000530=GetPackage(UserWorldId)
              if weiz1000000530==-1 then
