...
function MissIon255(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<123 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000562 = GetQuestItme(UserWorldId, 900000562, 10)
              if bool900000562 then
                  AddQuestItme(UserWorldId,900000562,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
