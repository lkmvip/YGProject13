...
function MissIon538(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<40 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000692 = GetQuestItme(UserWorldId, 900000692, 15)
              if bool900000692 then
                  AddQuestItme(UserWorldId,900000692,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
