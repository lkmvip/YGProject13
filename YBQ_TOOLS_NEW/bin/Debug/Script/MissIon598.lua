...
function MissIon598(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<10 then
          ...
          if QuestLevel==1 then
              ...
              local  bool100204001 = GetQuestItme(UserWorldId, 100204001, 1)
              if bool100204001 then
                  AddQuestItme(UserWorldId,100204001,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz100204002=GetPackage(UserWorldId)
              if weiz100204002==-1 then
