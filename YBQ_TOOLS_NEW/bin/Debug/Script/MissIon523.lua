...
function MissIon523(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<32 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000678 = GetQuestItme(UserWorldId, 900000678, 1)
              if bool900000678 then
                  AddQuestItme(UserWorldId,900000678,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,2500)
              end
