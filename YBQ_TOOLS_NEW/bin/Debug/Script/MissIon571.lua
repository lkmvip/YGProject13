...
function MissIon571(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<52 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000727 = GetQuestItme(UserWorldId, 900000727, 20)
              if bool900000727 then
                  AddQuestItme(UserWorldId,900000727,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
