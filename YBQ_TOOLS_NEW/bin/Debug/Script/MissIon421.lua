...
function MissIon421(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<10 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000765 = GetQuestItme(UserWorldId, 900000765, 1)
              if bool900000765 then
                  AddQuestItme(UserWorldId,900000765,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
