...
function MissIon395(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<60 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000017 = GetQuestItme(UserWorldId, 909000017, 50)
              if bool909000017 then
                  AddQuestItme(UserWorldId,909000017,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
