...
function MissIon197(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<18 then
          ...
          elseif QuestLevel==3 then
              local  bool900000412 = GetQuestItme(UserWorldId, 900000412, 10)
              if bool900000412 then
                  AddQuestItme(UserWorldId,900000412,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
