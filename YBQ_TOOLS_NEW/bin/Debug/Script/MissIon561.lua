...
function MissIon561(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<37 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000717 = GetQuestItme(UserWorldId, 900000717, 20)
              if bool900000717 then
                  AddQuestItme(UserWorldId,900000717,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz800000003==-1 then
                  ...
                  AddItme(UserWorldId,800000003,weiz800000003,4)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,110000)
              end
      end
