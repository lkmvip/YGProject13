...
function MissIon119(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<82 then
          ...
          elseif QuestLevel==2 then
              local  bool900000340 = GetQuestItme(UserWorldId, 900000340, 5)
              if bool900000340 then
                  AddQuestItme(UserWorldId,900000340,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000341 = GetQuestItme(UserWorldId, 900000341, 10)
              if bool900000341 then
                  AddQuestItme(UserWorldId,900000341,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
