...
function MissIon568(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<49 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000724 = GetQuestItme(UserWorldId, 900000724, 20)
              if bool900000724 then
                  AddQuestItme(UserWorldId,900000724,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz9000568=GetPackage(UserWorldId)
              if weiz9000568==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,780000)
              end
