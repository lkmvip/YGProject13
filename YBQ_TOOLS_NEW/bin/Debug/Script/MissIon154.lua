...
function MissIon154(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<75 then
          ...
          elseif QuestLevel==2 then
              local  bool900000465 = GetQuestItme(UserWorldId, 900000465, 1)
              if bool900000465 then
                  AddQuestItme(UserWorldId,900000465,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==3 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,8000000)
              end
