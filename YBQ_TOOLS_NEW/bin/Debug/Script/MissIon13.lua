...
function MissIon13(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<0 then
          ...
          elseif QuestLevel==3 then
              local  bool900000554 = GetQuestItme(UserWorldId, 900000554, 1)
              if bool900000554 then
                  AddQuestItme(UserWorldId,900000554,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              local weiz1000000632=GetPackage(UserWorldId)
              if weiz1000000632==-1 then
              ...
              local weiz1000000312=GetPackage(UserWorldId)
              if weiz1000000312==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
