...
function MissIon468(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<127 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000046 = GetQuestItme(UserWorldId, 909000046, 10)
              if bool909000046 then
                  AddQuestItme(UserWorldId,909000046,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool909000047 = GetQuestItme(UserWorldId, 909000047, 10)
              if bool909000047 then
                  AddQuestItme(UserWorldId,909000047,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
