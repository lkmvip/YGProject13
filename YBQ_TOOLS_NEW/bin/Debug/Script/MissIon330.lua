...
function MissIon330(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<119 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000614 = GetQuestItme(UserWorldId, 900000614, 5)
              if bool900000614 then
                  AddQuestItme(UserWorldId,900000614,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
