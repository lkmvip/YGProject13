...
function MissIon510(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<15 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000656 = GetQuestItme(UserWorldId, 900000656, 1)
              if bool900000656 then
                  AddQuestItme(UserWorldId,900000656,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1=GetPackage(UserWorldId)
              if weiz1==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,1500)
              end
      end
