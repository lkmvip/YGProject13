...
function MissIon355(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<125 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000628 = GetQuestItme(UserWorldId, 900000628, 1)
              if bool900000628 then
                  AddQuestItme(UserWorldId,900000628,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              local weiz1000000787=GetPackage(UserWorldId)
              if weiz1000000787==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
              ...
              local weiz1008000265=GetPackage(UserWorldId)
              if weiz1008000265==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
