...
function MissIon461(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<60 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000790 = GetQuestItme(UserWorldId, 900000790, 10)
              if bool900000790 then
                  AddQuestItme(UserWorldId,900000790,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000791 = GetQuestItme(UserWorldId, 900000791, 10)
              if bool900000791 then
                  AddQuestItme(UserWorldId,900000791,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000792 = GetQuestItme(UserWorldId, 900000792, 10)
              if bool900000792 then
                  AddQuestItme(UserWorldId,900000792,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
