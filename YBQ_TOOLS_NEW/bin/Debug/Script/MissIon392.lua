...
function MissIon392(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<140 then
          ...
          if QuestLevel==1 then
              ...
              local  bool1008000389 = GetQuestItme(UserWorldId, 1008000389, 1)
              if bool1008000389 then
                  AddQuestItme(UserWorldId,1008000389,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000021==-1 then
                  ...
                  AddItme(UserWorldId,909000021,weiz909000021,50)
              end
      end
