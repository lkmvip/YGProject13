...
function MissIon343(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<120 then
          ...
          if QuestLevel==1 then
              ...
              local  bool1000000788 = GetQuestItme(UserWorldId, 1000000788, 5)
              if bool1000000788 then
                  AddQuestItme(UserWorldId,1000000788,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              ...
              local  bool1000000771 = GetQuestItme(UserWorldId, 1000000771, 50)
              if bool1000000771 then
                  AddQuestItme(UserWorldId,1000000771,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
