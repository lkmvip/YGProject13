...
function MissIon557(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<51 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000713 = GetQuestItme(UserWorldId, 900000713, 20)
              if bool900000713 then
                  AddQuestItme(UserWorldId,900000713,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
