...
function MissIon104(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<79 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000319 = GetQuestItme(UserWorldId, 900000319, 20)
              if bool900000319 then
                  AddQuestItme(UserWorldId,900000319,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz9000104=GetPackage(UserWorldId)
              if weiz9000104==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,11500000)
              end
      end
