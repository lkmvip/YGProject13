...
function MissIon124(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<85 then
          ...
          elseif QuestLevel==4 then
              local  bool900000384 = GetQuestItme(UserWorldId, 900000384, 40)
              if bool900000384 then
                  AddQuestItme(UserWorldId,900000384,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=5
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==6 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,19500000)
              end
      end
