...
function MissIon133(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<96 then
          ...
          elseif QuestLevel==2 then
              local  bool900000400 = GetQuestItme(UserWorldId, 900000400, 5)
              if bool900000400 then
                  AddQuestItme(UserWorldId,900000400,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==4 then
              local  bool900000401 = GetQuestItme(UserWorldId, 900000401, 5)
              if bool900000401 then
                  AddQuestItme(UserWorldId,900000401,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=5
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==5 then
              local weiz100011=GetPackage(UserWorldId)
              if weiz100011==-1 then
              ...
              if weiz800000004==-1 then
                  ...
                  AddItme(UserWorldId,800000004,weiz800000004,2)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,52000000)
              end
      end
