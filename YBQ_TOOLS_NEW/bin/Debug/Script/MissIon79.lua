...
function MissIon79(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000244 = GetQuestItme(UserWorldId, 900000244, 10)
              if bool900000244 then
                  AddQuestItme(UserWorldId,900000244,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000245 = GetQuestItme(UserWorldId, 900000245, 10)
              if bool900000245 then
                  AddQuestItme(UserWorldId,900000245,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz900000246=GetPackage(UserWorldId)
              if weiz900000246==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
                  AddItme(UserWorldId,900000246,weiz900000246,1)
              end
