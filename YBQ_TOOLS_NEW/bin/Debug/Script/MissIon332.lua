...
function MissIon332(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<120 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000611 = GetQuestItme(UserWorldId, 900000611, 10)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1000000769=GetPackage(UserWorldId)
              if weiz1000000769==-1 then
