...
function MissIon288(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<129 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000592 = GetQuestItme(UserWorldId, 900000592, 1)
              if bool900000592 then
                  AddQuestItme(UserWorldId,900000592,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
