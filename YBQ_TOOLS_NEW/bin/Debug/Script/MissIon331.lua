...
function MissIon331(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<121 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000615 = GetQuestItme(UserWorldId, 900000615, 5)
              if bool900000615 then
                  AddQuestItme(UserWorldId,900000615,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
