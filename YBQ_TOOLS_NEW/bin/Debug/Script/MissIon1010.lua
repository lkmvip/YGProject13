...
function MissIon1010(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<0 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000422 = GetQuestItme(UserWorldId, 900000422, 20)
              if bool900000422 then
                  AddQuestItme(UserWorldId,900000422,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz605000001=GetPackage(UserWorldId)
              if weiz605000001==-1 then
