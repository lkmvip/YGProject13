...
function MissIon509(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<14 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000670 = GetQuestItme(UserWorldId, 900000670, 10)
              if bool900000670 then
                  AddQuestItme(UserWorldId,900000670,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1000000102=GetPackage(UserWorldId)
              if weiz1000000102==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,1200)
              end
      end
