...
function MissIon579(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<146 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000735 = GetQuestItme(UserWorldId, 900000735, 20)
              if bool900000735 then
                  AddQuestItme(UserWorldId,900000735,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
