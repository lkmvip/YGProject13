...
function MissIon593(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<142 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000749 = GetQuestItme(UserWorldId, 900000749, 1)
              if bool900000749 then
                  AddQuestItme(UserWorldId,900000749,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1000000637=GetPackage(UserWorldId)
              if weiz1000000637==-1 then
