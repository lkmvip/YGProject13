...
function MissIon420(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000705 = GetQuestItme(UserWorldId, 900000705, 1)
              if bool900000705 then
                  AddQuestItme(UserWorldId,900000705,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
