...
function MissIon547(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<47 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000701 = GetQuestItme(UserWorldId, 900000701, 15)
              if bool900000701 then
                  AddQuestItme(UserWorldId,900000701,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
