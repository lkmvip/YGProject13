...
function MissIon563(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<39 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000719 = GetQuestItme(UserWorldId, 900000719, 15)
              if bool900000719 then
                  AddQuestItme(UserWorldId,900000719,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
