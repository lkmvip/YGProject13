...
function MissIon463(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<60 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000789 = GetQuestItme(UserWorldId, 900000789, 10)
              if bool900000789 then
                  AddQuestItme(UserWorldId,900000789,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000795 = GetQuestItme(UserWorldId, 900000795, 10)
              if bool900000795 then
                  AddQuestItme(UserWorldId,900000795,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000796 = GetQuestItme(UserWorldId, 900000796, 10)
              if bool900000796 then
                  AddQuestItme(UserWorldId,900000796,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
