...
function MissIon80(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000247 = GetQuestItme(UserWorldId, 900000247, 10)
              if bool900000247 then
                  AddQuestItme(UserWorldId,900000247,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000248 = GetQuestItme(UserWorldId, 900000248, 10)
              if bool900000248 then
                  AddQuestItme(UserWorldId,900000248,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz900000249=GetPackage(UserWorldId)
              if weiz900000249==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
                  AddItme(UserWorldId,900000249,weiz900000249,1)
              end
