...
function MissIon337(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<118 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000611 = GetQuestItme(UserWorldId, 900000611, 2)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1008000431=GetPackage(UserWorldId)
              if weiz1008000431==-1 then
