...
function MissIon353(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<119 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000625 = GetQuestItme(UserWorldId, 900000625, 20)
              if bool900000625 then
                  AddQuestItme(UserWorldId,900000625,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000616 = GetQuestItme(UserWorldId, 900000616, 1)
              if bool900000616 then
                  AddQuestItme(UserWorldId,900000616,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000617 = GetQuestItme(UserWorldId, 900000617, 1)
              if bool900000617 then
                  AddQuestItme(UserWorldId,900000617,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
