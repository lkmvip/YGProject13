...
function MissIon136(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<89 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000350 = GetQuestItme(UserWorldId, 900000350, 20)
              if bool900000350 then
                  AddQuestItme(UserWorldId,900000350,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
