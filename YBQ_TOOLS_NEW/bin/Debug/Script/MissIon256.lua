...
function MissIon256(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<123 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000563 = GetQuestItme(UserWorldId, 900000563, 10)
              if bool900000563 then
                  AddQuestItme(UserWorldId,900000563,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz800000023==-1 then
                  ...
                  AddItme(UserWorldId,800000023,weiz800000023,3)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,80000000)
              end
      end
