...
function MissIon139(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<91 then
          ...
          elseif QuestLevel==3 then
              local  bool900000357 = GetQuestItme(UserWorldId, 900000357, 1)
              if bool900000357 then
                  AddQuestItme(UserWorldId,900000357,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              ...
              local weiz502010=GetPackage(UserWorldId)
              if weiz502010==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
