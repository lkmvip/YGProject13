...
function MissIon333(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<118 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000611 = GetQuestItme(UserWorldId, 900000611, 3)
              if bool900000611 then
                  AddQuestItme(UserWorldId,900000611,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1008000427=GetPackage(UserWorldId)
              if weiz1008000427==-1 then
