...
function MissIon570(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<47 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000726 = GetQuestItme(UserWorldId, 900000726, 15)
              if bool900000726 then
                  AddQuestItme(UserWorldId,900000726,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1000000002=GetPackage(UserWorldId)
              if weiz1000000002==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
                  AddItme(UserWorldId,1000000002,weiz1000000002,3)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,570000)
              end
