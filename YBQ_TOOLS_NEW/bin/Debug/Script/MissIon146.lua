...
function MissIon146(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<97 then
          ...
          elseif QuestLevel==2 then
              local  bool900000366 = GetQuestItme(UserWorldId, 900000366, 1)
              if bool900000366 then
                  AddQuestItme(UserWorldId,900000366,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000367 = GetQuestItme(UserWorldId, 900000367, 25)
              if bool900000367 then
                  AddQuestItme(UserWorldId,900000367,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,56000000)
              end
      end
