...
function MissIon123(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<84 then
          ...
          elseif QuestLevel==2 then
              local  bool900000389 = GetQuestItme(UserWorldId, 900000389, 1)
              if bool900000389 then
                  AddQuestItme(UserWorldId,900000389,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000389 = GetQuestItme(UserWorldId, 900000389, 10)
              if bool900000389 then
                  AddQuestItme(UserWorldId,900000389,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==6 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,18000000)
              end
