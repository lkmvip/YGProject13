...
function MissIon513(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<18 then
          ...
          elseif QuestLevel==2 then
              local  bool900000658 = GetQuestItme(UserWorldId, 900000658, 1)
              if bool900000658 then
                  AddQuestItme(UserWorldId,900000658,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000659 = GetQuestItme(UserWorldId, 900000659, 1)
              if bool900000659 then
                  AddQuestItme(UserWorldId,900000659,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              local weiz1000000902=GetPackage(UserWorldId)
              if weiz1000000902==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,3200)
              end
      end
