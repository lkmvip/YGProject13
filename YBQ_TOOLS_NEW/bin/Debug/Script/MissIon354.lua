...
function MissIon354(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<122 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000626 = GetQuestItme(UserWorldId, 900000626, 1)
              if bool900000626 then
                  AddQuestItme(UserWorldId,900000626,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              local  bool900000627 = GetQuestItme(UserWorldId, 900000627, 1)
              if bool900000627 then
                  AddQuestItme(UserWorldId,900000627,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,50000000)
              end
      end
