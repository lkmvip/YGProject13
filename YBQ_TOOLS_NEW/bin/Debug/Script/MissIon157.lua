...
function MissIon157(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<81 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000469 = GetQuestItme(UserWorldId, 900000469, 10)
              if bool900000469 then
                  AddQuestItme(UserWorldId,900000469,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,45000)
              end
      end
