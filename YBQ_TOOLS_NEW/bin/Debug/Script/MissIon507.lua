...
function MissIon507(UserWorldId,QuestId, CzId, RwJdId)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,750)
              end
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,500)
              end
              ...
              if weiz909000004==-1 then
                  ...
                  AddItme(UserWorldId,909000004,weiz909000004,30000)
              end
      end
