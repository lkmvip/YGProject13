...
function MissIon64(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<60 then
          ...
          elseif QuestLevel==2 then
              local  bool900000194 = GetQuestItme(UserWorldId, 900000194, 10)
              if bool900000194 then
                  AddQuestItme(UserWorldId,900000194,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==3 then
              local weiz900000211=GetPackage(UserWorldId)
              if weiz900000211==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
                  AddItme(UserWorldId,900000211,weiz900000211,1)
              end
              local weiz1000000003=GetPackage(UserWorldId)
              if weiz1000000003==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
                  AddItme(UserWorldId,1000000003,weiz1000000003,5)
              end
              ...
              if weiz800000003==-1 then
                  ...
                  AddItme(UserWorldId,800000003,weiz800000003,2)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,1050000)
              end
      end
