...
function MissIon89(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<70 then
          ...
          elseif QuestLevel==3 then
              local  bool900000306 = GetQuestItme(UserWorldId, 900000306, 1)
              if bool900000306 then
                  AddQuestItme(UserWorldId,900000306,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,30000)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,5200000)
              end
      end
