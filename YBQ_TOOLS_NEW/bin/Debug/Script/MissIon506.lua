...
function MissIon506(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<11 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000672 = GetQuestItme(UserWorldId, 900000672, 5)
              if bool900000672 then
                  AddQuestItme(UserWorldId,900000672,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz700001=GetPackage(UserWorldId)
              if weiz700001==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,600)
              end
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,300)
              end
      end
