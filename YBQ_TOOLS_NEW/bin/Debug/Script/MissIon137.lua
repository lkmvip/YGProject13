...
function MissIon137(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<89 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000351 = GetQuestItme(UserWorldId, 900000351, 20)
              if bool900000351 then
                  AddQuestItme(UserWorldId,900000351,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,28000000)
              end
      end
