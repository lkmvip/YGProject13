...
function MissIon163(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<93 then
          ...
          elseif QuestLevel==2 then
              local  bool900000481 = GetQuestItme(UserWorldId, 900000481, 20)
              if bool900000481 then
                  AddQuestItme(UserWorldId,900000481,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,40000000)
              end
      end
