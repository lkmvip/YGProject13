...
function MissIon265(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<124 then
          ...
          elseif QuestLevel==3 then
              local  bool900000572 = GetQuestItme(UserWorldId, 900000572, 1)
              if bool900000572 then
                  AddQuestItme(UserWorldId,900000572,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
