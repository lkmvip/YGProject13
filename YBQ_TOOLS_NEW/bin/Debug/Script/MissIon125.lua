...
function MissIon125(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<85 then
          ...
          elseif QuestLevel==4 then
              local  bool900000390 = GetQuestItme(UserWorldId, 900000390, 40)
              if bool900000390 then
                  AddQuestItme(UserWorldId,900000390,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=5
