...
function MissIon106(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<81 then
          ...
          elseif QuestLevel==2 then
              local  bool900000322 = GetQuestItme(UserWorldId, 900000322, 1)
              if bool900000322 then
                  AddQuestItme(UserWorldId,900000322,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==3 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,13800000)
              end
