...
function MissIon153(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<75 then
          ...
          elseif QuestLevel==2 then
              local  bool900000467 = GetQuestItme(UserWorldId, 900000467, 1)
              if bool900000467 then
                  AddQuestItme(UserWorldId,900000467,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
