...
function MissIon610(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<80 then
          ...
          if QuestLevel==1 then
              ...
              local  bool200204004 = GetQuestItme(UserWorldId, 200204004, 1)
              if bool200204004 then
                  AddQuestItme(UserWorldId,200204004,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz200204005=GetPackage(UserWorldId)
              if weiz200204005==-1 then
