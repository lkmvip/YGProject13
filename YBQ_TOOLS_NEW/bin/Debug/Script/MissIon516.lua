...
function MissIon516(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<22 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000676 = GetQuestItme(UserWorldId, 900000676, 10)
              if bool900000676 then
                  AddQuestItme(UserWorldId,900000676,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz2=GetPackage(UserWorldId)
              if weiz2==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,7800)
              end
      end
