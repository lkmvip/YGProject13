...
function MissIon122(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<84 then
          ...
          elseif QuestLevel==2 then
              local  bool900000383 = GetQuestItme(UserWorldId, 900000383, 10)
              if bool900000383 then
                  AddQuestItme(UserWorldId,900000383,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
