...
function MissIon549(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<53 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000703 = GetQuestItme(UserWorldId, 900000703, 20)
              if bool900000703 then
                  AddQuestItme(UserWorldId,900000703,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
