...
function MissIon1001(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<0 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000418 = GetQuestItme(UserWorldId, 900000418, 30)
              if bool900000418 then
                  AddQuestItme(UserWorldId,900000418,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
