...
function MissIon72(UserWorldId,QuestId, CzId, RwJdId)
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==5 then
              ...
              if weiz909000004==-1 then
                  ...
                  AddItme(UserWorldId,909000004,weiz909000004,1500000)
              end
              ...
              if weiz800000003==-1 then
                  ...
                  AddItme(UserWorldId,800000003,weiz800000003,3)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,2200000)
              end
      end
