...
function MissIon529(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<41 then
          ...
          elseif QuestLevel==2 then
              local  bool900000683 = GetQuestItme(UserWorldId, 900000683, 1)
              if bool900000683 then
                  AddQuestItme(UserWorldId,900000683,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
