...
function MissIon134(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<88 then
          ...
          elseif QuestLevel==2 then
              local  bool900000348 = GetQuestItme(UserWorldId, 900000348, 20)
              if bool900000348 then
                  AddQuestItme(UserWorldId,900000348,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==3 then
              ...
              if weiz909000002==-1 then
                  ...
                  AddItme(UserWorldId,909000002,weiz909000002,70000)
              end
      end
