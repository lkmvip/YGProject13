...
function MissIon562(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<38 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000718 = GetQuestItme(UserWorldId, 900000718, 10)
              if bool900000718 then
                  AddQuestItme(UserWorldId,900000718,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              local weiz9000562=GetPackage(UserWorldId)
              if weiz9000562==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,135000)
              end
      end
