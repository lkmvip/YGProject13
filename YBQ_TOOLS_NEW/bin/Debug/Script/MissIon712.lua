...
function MissIon712(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<105 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000037 = GetQuestItme(UserWorldId, 909000037, 1)
              if bool909000037 then
                  AddQuestItme(UserWorldId,909000037,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
