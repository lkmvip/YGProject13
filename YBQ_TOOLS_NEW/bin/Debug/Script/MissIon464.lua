...
function MissIon464(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<121 then
          ...
          if QuestLevel==1 then
              ...
              local  bool909000041 = GetQuestItme(UserWorldId, 909000041, 1)
              if bool909000041 then
                  AddQuestItme(UserWorldId,909000041,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
