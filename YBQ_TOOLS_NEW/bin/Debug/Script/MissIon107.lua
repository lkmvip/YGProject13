...
function MissIon107(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<81 then
          ...
          elseif QuestLevel==2 then
              local  bool900000324 = GetQuestItme(UserWorldId, 900000324, 1)
              if bool900000324 then
                  AddQuestItme(UserWorldId,900000324,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
