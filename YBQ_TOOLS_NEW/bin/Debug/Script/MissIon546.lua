...
function MissIon546(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<50 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000700 = GetQuestItme(UserWorldId, 900000700, 10)
              if bool900000700 then
                  AddQuestItme(UserWorldId,900000700,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,920000)
              end
      end
