...
function MissIon630(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<10 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool430203002 = GetQuestItme(UserWorldId, 430203002, 1)  --kiem tra vat pham nhiem vu
              if bool430203002 then --du yeu cau
                  AddQuestItme(UserWorldId,430203002,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<10 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,430203002,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz430203003=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,430203003,weiz430203003,1) 
        end 
