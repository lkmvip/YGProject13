...
function MissIon356(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<122 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000618 = GetQuestItme(UserWorldId, 900000618, 1)
              if bool900000618 then
                  AddQuestItme(UserWorldId,900000618,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
