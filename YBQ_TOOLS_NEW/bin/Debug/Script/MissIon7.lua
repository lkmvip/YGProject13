...
function MissIon7(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<0 then
          ...
          if QuestLevel==1 then
              ...
              local  bool900000419 = GetQuestItme(UserWorldId, 900000419, 20)
              if bool900000419 then
                  AddQuestItme(UserWorldId,900000419,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
          else
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==2 then
              local weiz1008000076=GetPackage(UserWorldId)
              if weiz1008000076==-1 then
