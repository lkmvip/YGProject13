...
function MissIon530(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<44 then
          ...
          elseif QuestLevel==2 then
              local  bool900000684 = GetQuestItme(UserWorldId, 900000684, 1)
              if bool900000684 then
                  AddQuestItme(UserWorldId,900000684,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
