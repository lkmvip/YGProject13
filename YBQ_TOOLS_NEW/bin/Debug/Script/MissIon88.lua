...
function MissIon88(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<69 then
          ...
          elseif QuestLevel==2 then
              local  bool900000303 = GetQuestItme(UserWorldId, 900000303, 1)
              if bool900000303 then
                  AddQuestItme(UserWorldId,900000303,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==5 then
              local weiz9000088=GetPackage(UserWorldId)
              if weiz9000088==-1 then
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,4400000)
              end
              local weiz1008000261=GetPackage(UserWorldId)
              if weiz1008000261==-1 then
                  SendSysMsg(UserWorldId,"There is no space in the equipment column", 9, "SystemMessage")
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
                  return 
              else
