...
function MissIon144(UserWorldId,QuestId, CzId, RwJdId)
  ...
  if CzId==1 then
      if Player.Player_FLD_LEVEL<95 then
          ...
          elseif QuestLevel==2 then
              local  bool900000362 = GetQuestItme(UserWorldId, 900000362, 30)
              if bool900000362 then
                  AddQuestItme(UserWorldId,900000362,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=3
          ...
          elseif QuestLevel==3 then
              local  bool900000363 = GetQuestItme(UserWorldId, 900000363, 1)
              if bool900000363 then
                  AddQuestItme(UserWorldId,900000363,0)
              else
                  SendMissionMsg(UserWorldId,QuestId, 12, RwJdId)
              end
              RwJdId=4
  ...
  elseif CzId==5 then
      ...
      if QuestLevel==4 then
              local weiz9000145=GetPackage(UserWorldId)
              if weiz9000145==-1 then
              ...
              if weiz800000024==-1 then
                  ...
                  AddItme(UserWorldId,800000024,weiz800000024,4)
              end
              ...
              if weiz909000001==-1 then
                  ...
                  AddItme(UserWorldId,909000001,weiz909000001,48000000)
              end
      end
