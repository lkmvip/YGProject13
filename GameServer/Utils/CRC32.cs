namespace ns8
{
    ...
    internal class CRC32
    {
        ...
        public static int smethod_0(byte[] byte_0)
        {
            ...
            {
                maxValue = ((maxValue >> 8) & 0xffffff) ^ uint_0[(int) ((IntPtr) ((maxValue ^ byte_0[i]) & 0xff))];
            }
        ...
        public static string smethod_1()
        {
            ...
            try
            {
                using (FileStream stream = new FileStream(Process.GetCurrentProcess().MainModule.FileName, FileMode.Open, FileAccess.Read, FileShare.Read))
                {
                    BinaryReader reader1 = new BinaryReader(stream);
                    byte[] buffer = new byte[reader1.BaseStream.Length];
                    reader1.Read(buffer, 0, buffer.Length);
                    str = smethod_0(buffer).ToString("X");
                }
            }
            catch (Exception)
            {
