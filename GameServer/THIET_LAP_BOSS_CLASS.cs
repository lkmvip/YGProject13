...
namespace ns9
{
	internal class THIET_LAP_BOSS_CLASS : IDisposable
	{
		private DateTime dateTime_0;

		private static List<int> list_0;

		private string[] string_0 = World.BOSS_hoang_da_thiet_lap.Split(new char[] { ';' });
		...
		static THIET_LAP_BOSS_CLASS()
		{
			THIET_LAP_BOSS_CLASS.ZYDNGuard();
		}

		public THIET_LAP_BOSS_CLASS()
		{
			THIET_LAP_BOSS_CLASS.list_0.Clear();
		...
		public void method_0(int int_0, float float_0, float float_1, int int_1)
		{
			...
			THIET_LAP_BOSS_CLASS.list_0.Add(num);
		}
		...
		public void timer_2_Elapsed(object sender, ElapsedEventArgs e)
		{
			...
			try
			{
				foreach (int list0 in THIET_LAP_BOSS_CLASS.list_0)
				{
		...
		{
			THIET_LAP_BOSS_CLASS.list_0 = new List<int>();
		}
	}
}