...
function MissIon267(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<124 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000575 = GetQuestItme(UserWorldId, 900000575, 20)  --kiem tra vat pham nhiem vu
              if bool900000575 then --du yeu cau
                  AddQuestItme(UserWorldId,900000575,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000575 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 108 ) -- Y: ( 301 ) --
