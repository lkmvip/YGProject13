  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<10 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000655 = GetQuestItme(UserWorldId, 900000655, 5)  --kiem tra vat pham nhiem vu
              if bool900000655 then --du yeu cau
                  AddQuestItme(UserWorldId,900000655,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000655 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 94 ) -- Y: ( 65 ) --
  ...
  elseif StepQuest==5 then
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
		  ...
		  local weiz909000004=GetPackage(UserWorldId)  --vi tri con trong
