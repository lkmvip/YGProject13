...
function MissIon577(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<139 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 139 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000733 = GetQuestItme(UserWorldId, 900000733, 20)  --kiem tra vat pham nhiem vu
              if bool900000733 then --du yeu cau
                  AddQuestItme(UserWorldId,900000733,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000733 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 26000 ) -- X: ( 265 ) -- Y: ( 239 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz800000061=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,800000061,weiz800000061,1) 
                  AddExpToCharacter(UserWorldId,1500000000) 
        end 
