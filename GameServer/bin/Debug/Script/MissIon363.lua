...
function MissIon363(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000186=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000186,weiz1008000186,1) 
        end 
