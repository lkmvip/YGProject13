...
function MissIon263(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<121 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000571 = GetQuestItme(UserWorldId, 900000571, 1)  --kiem tra vat pham nhiem vu
              if bool900000571 then --du yeu cau
                  AddQuestItme(UserWorldId,900000571,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<121 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000571,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
