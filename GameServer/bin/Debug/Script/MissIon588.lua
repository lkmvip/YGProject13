...
function MissIon588(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<134 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 134 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000744 = GetQuestItme(UserWorldId, 900000744, 20)  --kiem tra vat pham nhiem vu
              if bool900000744 then --du yeu cau
                  AddQuestItme(UserWorldId,900000744,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000744 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 26000 ) -- X: ( 464 ) -- Y: ( 100 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000079=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000079,weiz1008000079,1) 
                  AddExpToCharacter(UserWorldId,800000000) 
        end 
