...
function MissIon264(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<118 then 
          ...
          elseif QuestLevel==2 then
                  AddQuestItme(UserWorldId,900000573,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              local  bool900000573 = GetQuestItme(UserWorldId, 900000573, 1)  --kiem tra vat pham nhiem vu
              if bool900000573 then --du yeu cau
                  AddQuestItme(UserWorldId,900000573,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000573,1) --them vat pham nhiem vu cho buoc tiep theo
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000023=GetPackages(UserWorldId,4)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,250000000) 
        end 
