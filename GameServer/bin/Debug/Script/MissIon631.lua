...
--Ten nhiem vu: ([GM] [????? 2? ??]) --- So buoc: (1)
function MissIon631(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<35 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool430203003 = GetQuestItme(UserWorldId, 430203003, 1)  --kiem tra vat pham nhiem vu
              if bool430203003 then --du yeu cau
                  AddQuestItme(UserWorldId,430203003,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<35 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,430203003,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz430203004=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,430203004,weiz430203004,1) 
        end 
