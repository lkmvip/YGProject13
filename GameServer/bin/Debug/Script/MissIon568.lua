...
function MissIon568(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<49 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 49 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000724 = GetQuestItme(UserWorldId, 900000724, 20)  --kiem tra vat pham nhiem vu
              if bool900000724 then --du yeu cau
                  AddQuestItme(UserWorldId,900000724,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000724 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 283 ) -- Y: ( 474 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz9000568=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,9000568,weiz9000568,1) 
                  AddExpToCharacter(UserWorldId,780000) 
