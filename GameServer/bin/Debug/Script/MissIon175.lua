...
function MissIon175(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<114 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 114 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000503 = GetQuestItme(UserWorldId, 900000503, 10)  --kiem tra vat pham nhiem vu
              if bool900000503 then --du yeu cau
              AddQuestItme(UserWorldId,900000503,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000503 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 5001 ) -- X: ( 0 ) -- Y: ( 0 ) --
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000504 ) -- SO LUONG: ( 10 ) -- BUOC: ( 4 ) --
-- BAN DO: ( 5001 ) -- X: ( 393 ) -- Y: ( 448 ) --
          ...
          elseif QuestLevel==4 then
              ...
              local  bool900000504 = GetQuestItme(UserWorldId, 900000504, 10)  --kiem tra vat pham nhiem vu
              if bool900000504 then --du yeu cau
                  AddQuestItme(UserWorldId,900000504,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000503 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 69 ) -- Y: ( 162 ) --
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz100801=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,100801,weiz100801,1) 
              --tang thuong
