...
--Ten nhiem vu: ([GM] ????? ??? 4/5) --- So buoc: (1)
function MissIon1009(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<0 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000421 = GetQuestItme(UserWorldId, 900000421, 20)  --kiem tra vat pham nhiem vu
              if bool900000421 then --du yeu cau
                  AddQuestItme(UserWorldId,900000421,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000421 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 194 ) -- Y: ( 94 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz800000030=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,800000030,weiz800000030,1) 
              --tang thuong
              local weiz800000032=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,800000032,weiz800000032,1) 
        end 
