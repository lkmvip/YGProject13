...
--Ten nhiem vu: (Tin don thang chuc lan thu 5 (100/ ta)     ) --- So buoc: (0)
function MissIon188(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000617=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000617,weiz1000000617,1) 
        end 
