...
--Ten nhiem vu: (Ã“ƒæ÷¶µƒ√ÿ√‹) --- So buoc: (1)
function MissIon9708(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000633 = GetQuestItme(UserWorldId, 1000000633, 30)  --kiem tra vat pham nhiem vu
              if bool1000000633 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000633,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 1000000633 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000634=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000634,weiz1000000634,1) 
        end 
