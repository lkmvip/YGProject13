...
function MissIon437(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000782 ) -- SO LUONG: ( 3 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 26000 ) -- X: ( 275 ) -- Y: ( 387 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000714 ) -- SO LUONG: ( 2 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 26000 ) -- X: ( 274 ) -- Y: ( 387 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000782 = GetQuestItme(UserWorldId, 900000782, 3)  --kiem tra vat pham nhiem vu
              local  bool1000000714 = GetQuestItme(UserWorldId, 1000000714, 2)  --kiem tra vat pham nhiem vu
              if bool900000782 then --du yeu cau
              if bool1000000714 then --du yeu cau
                  AddQuestItme(UserWorldId,900000782,0) --xoa vat pham nhiem vu
