...
function MissIon118(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000338 ) -- SO LUONG: ( 5 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1001 ) -- X: ( 488 ) -- Y: ( 432 ) --
          ...
          elseif QuestLevel==2 then
              local  bool900000338 = GetQuestItme(UserWorldId, 900000338, 5)  --kiem tra vat pham nhiem vu
              if bool900000338 then --du yeu cau
                  AddQuestItme(UserWorldId,900000338,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000339 ) -- SO LUONG: ( 10 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 1001 ) -- X: ( 487 ) -- Y: ( 422 ) --
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000339 = GetQuestItme(UserWorldId, 900000339, 10)  --kiem tra vat pham nhiem vu
              if bool900000339 then --du yeu cau
                  AddQuestItme(UserWorldId,900000339,0) --xoa vat pham nhiem vu
