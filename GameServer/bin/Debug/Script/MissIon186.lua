...
function MissIon186(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000512 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 5001 ) -- X: ( 193 ) -- Y: ( 163 ) --
 
                  AddQuestItme(UserWorldId,900000526,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
              AddQuest(UserWorldId,QuestId, StatusQuest) 
              SendMissionMsg(UserWorldId,QuestId, 11, StatusQuest)  --cho lam buoc tiep theo la 2
          elseif QuestLevel==2 then
              local  bool900000512 = GetQuestItme(UserWorldId, 900000512, 10)  --kiem tra vat pham nhiem vu
              local  bool900000526 = GetQuestItme(UserWorldId, 900000526, 1)  --kiem tra vat pham nhiem vu
              if bool900000512 then --du yeu cau
              if bool900000526 then --du yeu cau
                  AddQuestItme(UserWorldId,900000512,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000526,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000594,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000594 = GetQuestItme(UserWorldId, 900000594, 1)  --kiem tra vat pham nhiem vu
              if bool900000594 then --du yeu cau
                  AddQuestItme(UserWorldId,900000594,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,909000006,1) --them vat pham cho nhiem vu khac
                  AddExpToCharacter(UserWorldId,68000000) 
        end 
