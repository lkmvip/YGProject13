...
function MissIon265(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<124 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 124 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          elseif QuestLevel==2 then
                  AddQuestItme(UserWorldId,900000572,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              local  bool900000572 = GetQuestItme(UserWorldId, 900000572, 1)  --kiem tra vat pham nhiem vu
              if bool900000572 then --du yeu cau
                  AddQuestItme(UserWorldId,900000572,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000572,1) --them vat pham nhiem vu cho buoc tiep theo
