...
function MissIon528(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<39 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 39 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000682 = GetQuestItme(UserWorldId, 900000682, 1)  --kiem tra vat pham nhiem vu
              if bool900000682 then --du yeu cau
                  AddQuestItme(UserWorldId,900000682,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<39 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000682,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz9000528=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,9000528,weiz9000528,1) 
                  AddExpToCharacter(UserWorldId,160000) 
              --tang thuong
