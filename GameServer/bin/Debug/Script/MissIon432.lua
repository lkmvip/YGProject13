...
function MissIon432(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<122 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000775 = GetQuestItme(UserWorldId, 900000775, 10)  --kiem tra vat pham nhiem vu
              if bool900000775 then --du yeu cau
                  AddQuestItme(UserWorldId,900000775,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000775 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 435 ) -- Y: ( 290 ) --
