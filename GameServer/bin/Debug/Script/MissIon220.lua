...
function MissIon220(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<0 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000450 = GetQuestItme(UserWorldId, 1000000450, 1)  --kiem tra vat pham nhiem vu
              if bool1000000450 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000450,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<0 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,1000000450,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000782=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000782,weiz1000000782,2) 
              --tang thuong
              local weiz1000000789=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000789,weiz1000000789,2) 
              --tang thuong
              local weiz1000000790=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000790,weiz1000000790,2) 
        end 
