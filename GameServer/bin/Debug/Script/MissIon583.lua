...
function MissIon583(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<131 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 131 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000739 = GetQuestItme(UserWorldId, 900000739, 1)  --kiem tra vat pham nhiem vu
              if bool900000739 then --du yeu cau
                  AddQuestItme(UserWorldId,900000739,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<131 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000739,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz1008000266=GetPackage(UserWorldId)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,500000000) 
        end 
