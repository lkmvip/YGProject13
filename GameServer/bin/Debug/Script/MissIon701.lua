...
function MissIon701(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<80 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool909000026 = GetQuestItme(UserWorldId, 909000026, 10)  --kiem tra vat pham nhiem vu
              if bool909000026 then --du yeu cau
                  AddQuestItme(UserWorldId,909000026,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 909000026 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
