...
function MissIon537(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<36 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000691 = GetQuestItme(UserWorldId, 900000691, 10)  --kiem tra vat pham nhiem vu
              if bool900000691 then --du yeu cau
                  AddQuestItme(UserWorldId,900000691,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000691 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 91 ) -- Y: ( 410 ) --
