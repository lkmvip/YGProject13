...
--Ten nhiem vu: (??? ? ?? ?? 3) --- So buoc: (6)
function MissIon169(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<102 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 102 moi co the nhan nhiem vu !", 9, "He thong")
...
-- ID VAT PHAM: ( 900000491 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 5001 ) -- X: ( 237 ) -- Y: ( 40 ) --
 
              StatusQuest=2 
              AddQuest(UserWorldId,QuestId, StatusQuest) 
              SendMissionMsg(UserWorldId,QuestId, 11, StatusQuest)  --cho lam buoc tiep theo la 2
          elseif QuestLevel==2 then
              local  bool900000491 = GetQuestItme(UserWorldId, 900000491, 10)  --kiem tra vat pham nhiem vu
              if bool900000491 then --du yeu cau
                  AddQuestItme(UserWorldId,900000491,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000492 ) -- SO LUONG: ( 10 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 5001 ) -- X: ( 77 ) -- Y: ( 92 ) --
          ...
          elseif QuestLevel==3 then
              local  bool900000492 = GetQuestItme(UserWorldId, 900000492, 10)  --kiem tra vat pham nhiem vu
              if bool900000492 then --du yeu cau
                  AddQuestItme(UserWorldId,900000492,0) --xoa vat pham nhiem vu
          ...
          elseif QuestLevel==5 then
                  AddQuestItme(UserWorldId,900000493,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==6 then
              ...
              local  bool900000493 = GetQuestItme(UserWorldId, 900000493, 1)  --kiem tra vat pham nhiem vu
              if bool900000493 then --du yeu cau
                  AddQuestItme(UserWorldId,900000493,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000113=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000113,weiz1000000113,1) 
                  AddExpToCharacter(UserWorldId,80000000) 
        end 
