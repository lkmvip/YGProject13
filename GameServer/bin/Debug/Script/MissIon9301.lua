...
--Ten nhiem vu: (¶Ò»»Lv.1¡¢Lv.2·À¾ß) --- So buoc: (1)
function MissIon9301(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000456 = GetQuestItme(UserWorldId, 1000000456, 1)  --kiem tra vat pham nhiem vu
              local  bool1000000459 = GetQuestItme(UserWorldId, 1000000459, 1)  --kiem tra vat pham nhiem vu
              if bool1000000456 then --du yeu cau
              if bool1000000459 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000456,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,1000000459,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<1 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,1000000456,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,1000000459,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
