...
function MissIon225(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000600 = GetQuestItme(UserWorldId, 900000600, 5)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000600 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 801 ) -- X: ( 0 ) -- Y: ( 0 ) --
