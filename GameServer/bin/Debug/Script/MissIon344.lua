...
function MissIon344(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<120 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000786 = GetQuestItme(UserWorldId, 1000000786, 4)  --kiem tra vat pham nhiem vu
              local  bool1000000792 = GetQuestItme(UserWorldId, 1000000792, 2)  --kiem tra vat pham nhiem vu
              local  bool1000000772 = GetQuestItme(UserWorldId, 1000000772, 24)  --kiem tra vat pham nhiem vu
              if bool1000000786 then --du yeu cau
              if bool1000000792 then --du yeu cau
              if bool1000000772 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000786,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,1000000792,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,1000000772,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 1000000786 ) -- SO LUONG: ( 4 ) -- BUOC: ( 1 ) --
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000772 ) -- SO LUONG: ( 24 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
