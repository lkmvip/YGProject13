...
function MissIon429(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<130 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
                  AddQuestItme(UserWorldId,900000771,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,900000773,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
              AddQuest(UserWorldId,QuestId, StatusQuest) 
              SendMissionMsg(UserWorldId,QuestId, 11, StatusQuest)  --cho lam buoc tiep theo la 2
          elseif QuestLevel==2 then
              local  bool900000771 = GetQuestItme(UserWorldId, 900000771, 1)  --kiem tra vat pham nhiem vu
              local  bool900000773 = GetQuestItme(UserWorldId, 900000773, 1)  --kiem tra vat pham nhiem vu
              if bool900000771 then --du yeu cau
              if bool900000773 then --du yeu cau
                  AddQuestItme(UserWorldId,900000771,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000773,0) --xoa vat pham nhiem vu
