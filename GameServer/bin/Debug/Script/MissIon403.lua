...
function MissIon403(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000639 ) -- SO LUONG: ( 40 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 25100 ) -- X: ( 314 ) -- Y: ( 442 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000639 = GetQuestItme(UserWorldId, 900000639, 40)  --kiem tra vat pham nhiem vu
              if bool900000639 then --du yeu cau
                  AddQuestItme(UserWorldId,900000639,0) --xoa vat pham nhiem vu
