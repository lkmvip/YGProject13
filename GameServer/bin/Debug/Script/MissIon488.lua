...
--Ten nhiem vu: ([GM] [??? ?? 3?] ??? ?? 3) --- So buoc: (1)
function MissIon488(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<128 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 128 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool909000048 = GetQuestItme(UserWorldId, 909000048, 10)  --kiem tra vat pham nhiem vu
              local  bool909000049 = GetQuestItme(UserWorldId, 909000049, 10)  --kiem tra vat pham nhiem vu
              if bool909000048 then --du yeu cau
              if bool909000049 then --du yeu cau
                  AddQuestItme(UserWorldId,909000048,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,909000049,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 909000048 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 909000049 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz0=GetPackage(UserWorldId)  --vi tri con trong
