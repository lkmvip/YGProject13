...
--Ten nhiem vu: ([GM] [??? ?? 3?] ??? ?? 2) --- So buoc: (1)
function MissIon487(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<127 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool909000046 = GetQuestItme(UserWorldId, 909000046, 10)  --kiem tra vat pham nhiem vu
              local  bool909000047 = GetQuestItme(UserWorldId, 909000047, 10)  --kiem tra vat pham nhiem vu
              if bool909000046 then --du yeu cau
              if bool909000047 then --du yeu cau
                  AddQuestItme(UserWorldId,909000046,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,909000047,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 909000046 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 909000047 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
