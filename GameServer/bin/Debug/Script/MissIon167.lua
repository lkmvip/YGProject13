...
function MissIon167(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000489 ) -- SO LUONG: ( 25 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 5001 ) -- X: ( 243 ) -- Y: ( 39 ) --
 
              StatusQuest=2 
              AddQuest(UserWorldId,QuestId, StatusQuest) 
              SendMissionMsg(UserWorldId,QuestId, 11, StatusQuest)  --cho lam buoc tiep theo la 2
          elseif QuestLevel==2 then
              local  bool900000489 = GetQuestItme(UserWorldId, 900000489, 25)  --kiem tra vat pham nhiem vu
              if bool900000489 then --du yeu cau
                  AddQuestItme(UserWorldId,900000489,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000489 ) -- SO LUONG: ( 25 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 5001 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,64000000) 
              --tang thuong
              ...
              --tang thuong
              local weiz1000000034=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000034,weiz1000000034,1) 
        end 
