...
function MissIon574(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<145 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 145 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000730 = GetQuestItme(UserWorldId, 900000730, 10)  --kiem tra vat pham nhiem vu
              if bool900000730 then --du yeu cau
                  AddQuestItme(UserWorldId,900000730,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000730 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 26000 ) -- X: ( 169 ) -- Y: ( 346 ) --
