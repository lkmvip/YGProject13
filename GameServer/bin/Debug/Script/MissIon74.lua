...
function MissIon74(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<80 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000231 = GetQuestItme(UserWorldId, 900000231, 1)  --kiem tra vat pham nhiem vu
              if bool900000231 then --du yeu cau
              AddQuestItme(UserWorldId,900000231,0) --xoa vat pham nhiem vu
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
                  AddQuestItme(UserWorldId,900000232,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              local  bool900000232 = GetQuestItme(UserWorldId, 900000232, 1)  --kiem tra vat pham nhiem vu
              if bool900000232 then --du yeu cau
                  AddQuestItme(UserWorldId,900000232,0) --xoa vat pham nhiem vu
          ...
          elseif QuestLevel==4 then
                  AddQuestItme(UserWorldId,900000233,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==5 then
              local  bool900000233 = GetQuestItme(UserWorldId, 900000233, 1)  --kiem tra vat pham nhiem vu
              if bool900000233 then --du yeu cau
                  AddQuestItme(UserWorldId,900000233,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000234,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==6 then
              local  bool900000234 = GetQuestItme(UserWorldId, 900000234, 1)  --kiem tra vat pham nhiem vu
              if bool900000234 then --du yeu cau
                  AddQuestItme(UserWorldId,900000234,0) --xoa vat pham nhiem vu
      ...
      if Player.Player_FLD_LEVEL<80 then  
         ...
         if QuestLevel==8 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000231,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
            AddQuest(UserWorldId,QuestId, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000235,1) --them vat pham cho nhiem vu khac
