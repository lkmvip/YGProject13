...
--Ten nhiem vu: (9) --- So buoc: (0)
function MissIon8000265(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<9000001 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 9000001 moi co the nhan nhiem vu !", 9, "He thong")
