...
function MissIon199(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<25 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000413 = GetQuestItme(UserWorldId, 900000413, 5)  --kiem tra vat pham nhiem vu
              if bool900000413 then --du yeu cau
                  AddQuestItme(UserWorldId,900000413,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000413 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 388 ) -- Y: ( 283 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,13500) 
                  AddKiToCharacter(UserWorldId,5000) 
        end 
