...
--Ten nhiem vu: (Tim bi kip vo cong 4 (TC5 - B4) (vat pham)) --- So buoc: (1)
function MissIon183(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<100 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000519 = GetQuestItme(UserWorldId, 900000519, 200)  --kiem tra vat pham nhiem vu
              local  bool900000520 = GetQuestItme(UserWorldId, 900000520, 200)  --kiem tra vat pham nhiem vu
              if bool900000519 then --du yeu cau
              if bool900000520 then --du yeu cau
                  AddQuestItme(UserWorldId,900000519,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000520,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000519 ) -- SO LUONG: ( 200 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 222 ) -- Y: ( 52 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000520 ) -- SO LUONG: ( 200 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 235 ) -- Y: ( 46 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000524,1) --them vat pham cho nhiem vu khac
        end 
