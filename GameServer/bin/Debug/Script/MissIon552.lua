...
function MissIon552(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<41 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000708 = GetQuestItme(UserWorldId, 900000708, 10)  --kiem tra vat pham nhiem vu
              if bool900000708 then --du yeu cau
                  AddQuestItme(UserWorldId,900000708,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000708 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 180 ) -- Y: ( 212 ) --
