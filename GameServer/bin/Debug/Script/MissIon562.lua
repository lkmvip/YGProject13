...
function MissIon562(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<38 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 38 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000718 = GetQuestItme(UserWorldId, 900000718, 10)  --kiem tra vat pham nhiem vu
              if bool900000718 then --du yeu cau
                  AddQuestItme(UserWorldId,900000718,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000718 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 290 ) -- Y: ( 90 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz9000562=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,9000562,weiz9000562,1) 
                  AddExpToCharacter(UserWorldId,135000) 
        end 
