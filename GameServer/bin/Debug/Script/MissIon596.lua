...
function MissIon596(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<56 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 56 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000759 = GetQuestItme(UserWorldId, 900000759, 10)  --kiem tra vat pham nhiem vu
              if bool900000759 then --du yeu cau
              AddQuestItme(UserWorldId,900000759,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000760 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1101 ) -- X: ( 418 ) -- Y: ( 449 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000760 = GetQuestItme(UserWorldId, 900000760, 10)  --kiem tra vat pham nhiem vu
              if bool900000760 then --du yeu cau
                  AddQuestItme(UserWorldId,900000760,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000759 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 414 ) -- Y: ( 412 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,1550000) 
        end 
