...
--Ten nhiem vu: (领取江湖小助手) --- So buoc: (1)
function MissIon9998(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000630=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000630,weiz1008000630,1) 
        end 
