...
--Ten nhiem vu: (»ñÈ¡²ÏË¿) --- So buoc: (1)
function MissIon346(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<120 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000773 = GetQuestItme(UserWorldId, 1000000773, 4)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 1000000773 ) -- SO LUONG: ( 4 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000785=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000785,weiz1000000785,1) 
        end 
