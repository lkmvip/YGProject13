...
--Ten nhiem vu: (集字换大礼活动（一）) --- So buoc: (1)
function MissIon9617(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<10 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000316 = GetQuestItme(UserWorldId, 999000316, 80)  --kiem tra vat pham nhiem vu
              local  bool999000317 = GetQuestItme(UserWorldId, 999000317, 80)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 999000316 ) -- SO LUONG: ( 80 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 999000317 ) -- SO LUONG: ( 80 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
