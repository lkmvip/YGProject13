...
function MissIon154(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<75 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000464 = GetQuestItme(UserWorldId, 900000464, 15)  --kiem tra vat pham nhiem vu
              if bool900000464 then --du yeu cau
              AddQuestItme(UserWorldId,900000464,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000465 ) -- SO LUONG: ( 1 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 5001 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000465 = GetQuestItme(UserWorldId, 900000465, 1)  --kiem tra vat pham nhiem vu
              if bool900000465 then --du yeu cau
                  AddQuestItme(UserWorldId,900000465,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000464 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 461 ) -- Y: ( 270 ) --
