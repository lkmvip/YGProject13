...
function MissIon120(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<83 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000342 = GetQuestItme(UserWorldId, 900000342, 30)  --kiem tra vat pham nhiem vu
              if bool900000342 then --du yeu cau
              AddQuestItme(UserWorldId,900000342,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000343,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000343 = GetQuestItme(UserWorldId, 900000343, 1)  --kiem tra vat pham nhiem vu
              if bool900000343 then --du yeu cau
                  AddQuestItme(UserWorldId,900000343,0) --xoa vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000342 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 488 ) -- Y: ( 423 ) --
