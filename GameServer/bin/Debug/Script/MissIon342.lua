...
function MissIon342(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<118 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000611 = GetQuestItme(UserWorldId, 900000611, 4)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000611 ) -- SO LUONG: ( 4 ) -- BUOC: ( 1 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000659=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000659,weiz1000000659,1) 
        end 
