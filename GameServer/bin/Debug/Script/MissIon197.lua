...
function MissIon197(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<18 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000411 = GetQuestItme(UserWorldId, 900000411, 10)  --kiem tra vat pham nhiem vu
              if bool900000411 then --du yeu cau
              AddQuestItme(UserWorldId,900000411,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000412 ) -- SO LUONG: ( 10 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==3 then
              local  bool900000412 = GetQuestItme(UserWorldId, 900000412, 10)  --kiem tra vat pham nhiem vu
              if bool900000412 then --du yeu cau
                  AddQuestItme(UserWorldId,900000412,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000411 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 146 ) -- Y: ( 255 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz800000028=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,800000028,weiz800000028,1) 
        end 
