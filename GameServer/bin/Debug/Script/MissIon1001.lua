...
--Ten nhiem vu: ([GM] ????? ??? 1/5) --- So buoc: (1)
function MissIon1001(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<0 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000418 = GetQuestItme(UserWorldId, 900000418, 30)  --kiem tra vat pham nhiem vu
              if bool900000418 then --du yeu cau
                  AddQuestItme(UserWorldId,900000418,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000418 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
