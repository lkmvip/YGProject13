...
function MissIon364(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<120 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000599 = GetQuestItme(UserWorldId, 999000599, 10)  --kiem tra vat pham nhiem vu
              if bool999000599 then --du yeu cau
                  AddQuestItme(UserWorldId,999000599,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000599 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 131 ) -- Y: ( 39 ) --
