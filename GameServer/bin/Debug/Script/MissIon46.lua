...
function MissIon46(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000100 = GetQuestItme(UserWorldId, 900000100, 10)  --kiem tra vat pham nhiem vu
              if bool900000100 then --du yeu cau
              AddQuestItme(UserWorldId,900000100,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000100 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 292 ) -- Y: ( 176 ) --
