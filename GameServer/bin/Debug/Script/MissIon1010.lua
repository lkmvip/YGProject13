...
--Ten nhiem vu: ([GM] ????? ??? 5/5) --- So buoc: (1)
function MissIon1010(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<0 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000422 = GetQuestItme(UserWorldId, 900000422, 20)  --kiem tra vat pham nhiem vu
              if bool900000422 then --du yeu cau
                  AddQuestItme(UserWorldId,900000422,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000422 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 470 ) -- Y: ( 163 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz605000001=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,605000001,weiz605000001,1) 
        end 
