...
function MissIon256(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<123 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000563 = GetQuestItme(UserWorldId, 900000563, 10)  --kiem tra vat pham nhiem vu
              if bool900000563 then --du yeu cau
                  AddQuestItme(UserWorldId,900000563,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000563 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 109 ) -- Y: ( 294 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz800000023=GetPackages(UserWorldId,3)  --vi tri con trong
