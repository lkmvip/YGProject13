...
--Ten nhiem vu: (老玩家专属任务—兑换20张礼券) --- So buoc: (1)
function MissIon9120(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000120 = GetQuestItme(UserWorldId, 999000120, 20)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 999000120 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
