...
function MissIon144(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<95 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 95 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000362 = GetQuestItme(UserWorldId, 900000362, 30)  --kiem tra vat pham nhiem vu
              if bool900000362 then --du yeu cau
              AddQuestItme(UserWorldId,900000362,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000362 ) -- SO LUONG: ( 30 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1001 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==2 then
              ...
              if bool900000362 then --du yeu cau
                  AddQuestItme(UserWorldId,900000362,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000363,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000363 = GetQuestItme(UserWorldId, 900000363, 1)  --kiem tra vat pham nhiem vu
              if bool900000363 then --du yeu cau
                  AddQuestItme(UserWorldId,900000363,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000362 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 2201 ) -- X: ( 438 ) -- Y: ( 447 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz9000145=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,9000145,weiz9000145,1) 
              --tang thuong
              local weiz800000024=GetPackages(UserWorldId,4)  --vi tri con trong
                  ...
                  AddItmeProp(UserWorldId,800000024,weiz800000024[2],1,chiso,0,0,0,0,0,0,0,0)
                  AddItmeProp(UserWorldId,800000024,weiz800000024[3],1,chiso,0,0,0,0,0,0,0,0)
                  AddExpToCharacter(UserWorldId,48000000) 
        end 
