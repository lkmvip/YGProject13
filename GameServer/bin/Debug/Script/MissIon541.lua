...
function MissIon541(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<38 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000695 = GetQuestItme(UserWorldId, 900000695, 20)  --kiem tra vat pham nhiem vu
              if bool900000695 then --du yeu cau
                  AddQuestItme(UserWorldId,900000695,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000695 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 237 ) -- Y: ( 227 ) --
