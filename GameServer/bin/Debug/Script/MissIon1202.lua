...
--Ten nhiem vu: ([高手] 错误的教导) --- So buoc: (1)
function MissIon1202(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<24 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 24 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000174 = GetQuestItme(UserWorldId, 999000174, 10)  --kiem tra vat pham nhiem vu
              if bool999000174 then --du yeu cau
                  AddQuestItme(UserWorldId,999000174,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000174 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 35 ) -- Y: ( 184 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz13=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,13,weiz13,1) 
                  AddExpToCharacter(UserWorldId,10000) 
        end 
