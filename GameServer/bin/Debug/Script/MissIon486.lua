...
--Ten nhiem vu: ([GM] [??? ?? 3?] ??? ?? 1) --- So buoc: (1)
function MissIon486(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<126 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool909000044 = GetQuestItme(UserWorldId, 909000044, 10)  --kiem tra vat pham nhiem vu
              local  bool909000045 = GetQuestItme(UserWorldId, 909000045, 10)  --kiem tra vat pham nhiem vu
              if bool909000044 then --du yeu cau
              if bool909000045 then --du yeu cau
                  AddQuestItme(UserWorldId,909000044,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,909000045,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 909000044 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 909000045 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
