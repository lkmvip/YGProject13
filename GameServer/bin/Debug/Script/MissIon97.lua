...
function MissIon97(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<74 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000279 = GetQuestItme(UserWorldId, 900000279, 5)  --kiem tra vat pham nhiem vu
              local  bool900000280 = GetQuestItme(UserWorldId, 900000280, 5)  --kiem tra vat pham nhiem vu
              local  bool900000281 = GetQuestItme(UserWorldId, 900000281, 10)  --kiem tra vat pham nhiem vu
              if bool900000279 then --du yeu cau
              if bool900000280 then --du yeu cau
              if bool900000281 then --du yeu cau
              AddQuestItme(UserWorldId,900000279,0) --xoa vat pham nhiem vu
              AddQuestItme(UserWorldId,900000280,0) --xoa vat pham nhiem vu
              AddQuestItme(UserWorldId,900000281,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000279 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 59 ) -- Y: ( 155 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000280 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000281 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 0 ) -- Y: ( 0 ) --
