...
function MissIon69(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<63 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 63 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000205 = GetQuestItme(UserWorldId, 900000205, 15)  --kiem tra vat pham nhiem vu
              if bool900000205 then --du yeu cau
                  AddQuestItme(UserWorldId,900000205,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000205 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 315 ) -- Y: ( 347 ) --
