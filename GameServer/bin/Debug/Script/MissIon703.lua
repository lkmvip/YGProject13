...
function MissIon703(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<110 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool909000028 = GetQuestItme(UserWorldId, 909000028, 10)  --kiem tra vat pham nhiem vu
              if bool909000028 then --du yeu cau
                  AddQuestItme(UserWorldId,909000028,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 909000028 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
