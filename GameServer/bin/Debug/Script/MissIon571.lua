...
function MissIon571(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<52 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000727 = GetQuestItme(UserWorldId, 900000727, 20)  --kiem tra vat pham nhiem vu
              if bool900000727 then --du yeu cau
                  AddQuestItme(UserWorldId,900000727,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000727 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 72 ) -- Y: ( 450 ) --
