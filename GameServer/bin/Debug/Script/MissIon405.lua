...
function MissIon405(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<126 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000641 = GetQuestItme(UserWorldId, 900000641, 10)  --kiem tra vat pham nhiem vu
              if bool900000641 then --du yeu cau
                  AddQuestItme(UserWorldId,900000641,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000641 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 238 ) -- Y: ( 438 ) --
