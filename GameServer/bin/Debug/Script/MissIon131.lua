...
function MissIon131(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<90 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000346 = GetQuestItme(UserWorldId, 900000346, 7)  --kiem tra vat pham nhiem vu
              if bool900000346 then --du yeu cau
              AddQuestItme(UserWorldId,900000346,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000347 ) -- SO LUONG: ( 7 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==3 then
              local  bool900000347 = GetQuestItme(UserWorldId, 900000347, 7)  --kiem tra vat pham nhiem vu
              if bool900000347 then --du yeu cau
                  AddQuestItme(UserWorldId,900000347,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000346 ) -- SO LUONG: ( 7 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1301 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,909000007,1) --them vat pham cho nhiem vu khac
