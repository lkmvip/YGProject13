...
--Ten nhiem vu: (ÉñÃØµÄ°Ù±¦¶Ò»») --- So buoc: (1)
function MissIon9996(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1008000609 = GetQuestItme(UserWorldId, 1008000609, 1)  --kiem tra vat pham nhiem vu
              if bool1008000609 then --du yeu cau
                  AddQuestItme(UserWorldId,1008000609,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<200 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,1008000609,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
