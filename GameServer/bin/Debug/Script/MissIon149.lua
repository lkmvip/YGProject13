...
function MissIon149(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<98 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000371 = GetQuestItme(UserWorldId, 900000371, 50)  --kiem tra vat pham nhiem vu
              if bool900000371 then --du yeu cau
                  AddQuestItme(UserWorldId,900000371,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000371 ) -- SO LUONG: ( 50 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 2101 ) -- X: ( 58 ) -- Y: ( 193 ) --
