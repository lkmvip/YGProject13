...
function MissIon71(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<64 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000207 = GetQuestItme(UserWorldId, 900000207, 20)  --kiem tra vat pham nhiem vu
              if bool900000207 then --du yeu cau
              AddQuestItme(UserWorldId,900000207,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000207 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 353 ) -- Y: ( 346 ) --
