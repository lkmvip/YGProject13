...
--Ten nhiem vu: (—∞’“…¢¬‰µƒ¡È ﬁ√ÿºÆ 2) --- So buoc: (1)
function MissIon1007(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000419 = GetQuestItme(UserWorldId, 900000419, 20)  --kiem tra vat pham nhiem vu
              if bool900000419 then --du yeu cau
                  AddQuestItme(UserWorldId,900000419,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000419 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 276 ) -- Y: ( 141 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000076=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000076,weiz1008000076,1) 
        end 
