...
function MissIon601(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<80 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool100204004 = GetQuestItme(UserWorldId, 100204004, 1)  --kiem tra vat pham nhiem vu
              if bool100204004 then --du yeu cau
                  AddQuestItme(UserWorldId,100204004,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<80 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,100204004,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz100204005=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,100204005,weiz100204005,1) 
              --tang thuong
