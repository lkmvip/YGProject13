...
function MissIon560(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<36 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 36 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000716 = GetQuestItme(UserWorldId, 900000716, 10)  --kiem tra vat pham nhiem vu
              if bool900000716 then --du yeu cau
                  AddQuestItme(UserWorldId,900000716,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000716 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 454 ) -- Y: ( 67 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz700005=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,700005,weiz700005,1) 
                  AddExpToCharacter(UserWorldId,45000) 
        end 
