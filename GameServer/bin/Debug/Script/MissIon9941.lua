...
--Ten nhiem vu: (»¶Ï²Ó­¹úÇì ½±Àø¶Ò²»Í£) --- So buoc: (1)
function MissIon9941(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000290 = GetQuestItme(UserWorldId, 999000290, 100)  --kiem tra vat pham nhiem vu
              if bool999000290 then --du yeu cau
                  AddQuestItme(UserWorldId,999000290,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000290 ) -- SO LUONG: ( 100 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000137=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000137,weiz1000000137,10) 
              --tang thuong
              local weiz1000000901=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000901,weiz1000000901,10) 
              --tang thuong
              local weiz9009217=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,9009217,weiz9009217,1) 
        end 
