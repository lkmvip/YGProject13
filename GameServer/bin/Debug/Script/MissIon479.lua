...
function MissIon479(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<80 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000797 = GetQuestItme(UserWorldId, 900000797, 1)  --kiem tra vat pham nhiem vu
              if bool900000797 then --du yeu cau
                  AddQuestItme(UserWorldId,900000797,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<80 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000797,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,10000000) 
