...
function MissIon166(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<97 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000488 = GetQuestItme(UserWorldId, 900000488, 20)  --kiem tra vat pham nhiem vu
              if bool900000488 then --du yeu cau
                  AddQuestItme(UserWorldId,900000488,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000488 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 199 ) -- Y: ( 157 ) --
