...
--Ten nhiem vu: (Ä§ÃðÏîÁ´¶Ò»»ÈÎÎñ) --- So buoc: (1)
function MissIon8089(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000742 = GetQuestItme(UserWorldId, 999000742, 250)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 999000742 ) -- SO LUONG: ( 250 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000006=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000006,weiz1000006,1) 
        end 
