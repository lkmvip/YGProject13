...
function MissIon507(UserWorldId,QuestId, StepQuest, StatusQuest)
        ...
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000002=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,750) 
                  AddKiToCharacter(UserWorldId,500) 
                  AddMoneyToCharacter(UserWorldId,30000) 
                  SendSysMsg(UserWorldId,"Nhan duoc 30000 tien vang!", 9, "He thong")
        end 
