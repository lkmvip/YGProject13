...
--Ten nhiem vu: (兑换成品属性提升符) --- So buoc: (1)
function MissIon9909(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000184 = GetQuestItme(UserWorldId, 999000184, 1)  --kiem tra vat pham nhiem vu
              if bool999000184 then --du yeu cau
                  AddQuestItme(UserWorldId,999000184,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<1 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,999000184,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000137=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000137,weiz1008000137,1) 
        end 
