...
function MissIon261(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<116 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000569 = GetQuestItme(UserWorldId, 900000569, 1)  --kiem tra vat pham nhiem vu
              if bool900000569 then --du yeu cau
                  AddQuestItme(UserWorldId,900000569,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<116 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000569,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
