...
--Ten nhiem vu: ([GM] [????? 8? ??]) --- So buoc: (1)
function MissIon637(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<130 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool430203009 = GetQuestItme(UserWorldId, 430203009, 1)  --kiem tra vat pham nhiem vu
              local  bool900000762 = GetQuestItme(UserWorldId, 900000762, 4)  --kiem tra vat pham nhiem vu
              if bool430203009 then --du yeu cau
              if bool900000762 then --du yeu cau
                  AddQuestItme(UserWorldId,430203009,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<130 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,430203009,1) --them vat pham nhiem vu cho buoc tiep theo
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000762 ) -- SO LUONG: ( 4 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz430203010=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,430203010,weiz430203010,1) 
        end 
