...
--Ten nhiem vu: (自然守护者) --- So buoc: (1)
function MissIon9916(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<10 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000224 = GetQuestItme(UserWorldId, 999000224, 20)  --kiem tra vat pham nhiem vu
              local  bool999000225 = GetQuestItme(UserWorldId, 999000225, 20)  --kiem tra vat pham nhiem vu
              local  bool999000226 = GetQuestItme(UserWorldId, 999000226, 20)  --kiem tra vat pham nhiem vu
              local  bool999000227 = GetQuestItme(UserWorldId, 999000227, 20)  --kiem tra vat pham nhiem vu
              local  bool999000228 = GetQuestItme(UserWorldId, 999000228, 20)  --kiem tra vat pham nhiem vu
              if bool999000224 then --du yeu cau
              if bool999000225 then --du yeu cau
              if bool999000226 then --du yeu cau
              if bool999000227 then --du yeu cau
              if bool999000228 then --du yeu cau
                  AddQuestItme(UserWorldId,999000224,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,999000225,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,999000226,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,999000227,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,999000228,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000224 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 999000225 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 999000226 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 999000227 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 999000228 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,999000350,5) --them vat pham cho nhiem vu khac
              AddQuestItme(UserWorldId,999000350,10) --them vat pham cho nhiem vu khac
        end 
