...
function MissIon353(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<119 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000625 = GetQuestItme(UserWorldId, 900000625, 20)  --kiem tra vat pham nhiem vu
              local  bool900000616 = GetQuestItme(UserWorldId, 900000616, 1)  --kiem tra vat pham nhiem vu
              local  bool900000617 = GetQuestItme(UserWorldId, 900000617, 1)  --kiem tra vat pham nhiem vu
              if bool900000625 then --du yeu cau
              if bool900000616 then --du yeu cau
              if bool900000617 then --du yeu cau
                  AddQuestItme(UserWorldId,900000625,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000616,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000617,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000625 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
                  AddQuestItme(UserWorldId,900000616,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,900000617,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,25000000) 
        end 
