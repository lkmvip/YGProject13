...
function MissIon9158(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<106 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 106 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000223 = GetQuestItme(UserWorldId, 999000223, 1)  --kiem tra vat pham nhiem vu
              if bool999000223 then --du yeu cau
                  AddQuestItme(UserWorldId,999000223,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<106 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,999000223,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000312=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000312,weiz1000000312,2) 
                  AddExpToCharacter(UserWorldId,120000000) 
              --tang thuong
              local weiz800000024=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddKiToCharacter(UserWorldId,250000) 
        end 
