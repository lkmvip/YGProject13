...
function MissIon159(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<85 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000471 = GetQuestItme(UserWorldId, 900000471, 20)  --kiem tra vat pham nhiem vu
              if bool900000471 then --du yeu cau
                  AddQuestItme(UserWorldId,900000471,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000471 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 71 ) -- Y: ( 385 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddKiToCharacter(UserWorldId,55000) 
              --tang thuong
