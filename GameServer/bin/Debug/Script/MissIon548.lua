...
function MissIon548(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<52 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 52 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000702 = GetQuestItme(UserWorldId, 900000702, 20)  --kiem tra vat pham nhiem vu
              if bool900000702 then --du yeu cau
                  AddQuestItme(UserWorldId,900000702,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000702 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 372 ) -- Y: ( 437 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000002=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,1115000) 
        end 
