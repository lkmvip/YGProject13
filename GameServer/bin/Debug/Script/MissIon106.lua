...
--Ten nhiem vu: (???? ????? 3) --- So buoc: (2)
function MissIon106(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<81 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 81 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000321 = GetQuestItme(UserWorldId, 900000321, 20)  --kiem tra vat pham nhiem vu
              if bool900000321 then --du yeu cau
              AddQuestItme(UserWorldId,900000321,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000322,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000322 = GetQuestItme(UserWorldId, 900000322, 1)  --kiem tra vat pham nhiem vu
              if bool900000322 then --du yeu cau
                  AddQuestItme(UserWorldId,900000322,0) --xoa vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000321 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 489 ) -- Y: ( 430 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,13800000) 
              --tang thuong
