...
function MissIon595(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<58 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000758 = GetQuestItme(UserWorldId, 900000758, 10)  --kiem tra vat pham nhiem vu
              if bool900000758 then --du yeu cau
                  AddQuestItme(UserWorldId,900000758,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000758 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 336 ) -- Y: ( 223 ) --
