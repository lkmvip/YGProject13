...
function MissIon589(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<137 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 137 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000745 = GetQuestItme(UserWorldId, 900000745, 20)  --kiem tra vat pham nhiem vu
              if bool900000745 then --du yeu cau
                  AddQuestItme(UserWorldId,900000745,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000745 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 26000 ) -- X: ( 463 ) -- Y: ( 102 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000062=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,800000062,weiz800000062,1) 
                  AddExpToCharacter(UserWorldId,1100000000) 
        end 
