...
function MissIon345(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<120 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000792 = GetQuestItme(UserWorldId, 1000000792, 2)  --kiem tra vat pham nhiem vu
              local  bool1000000787 = GetQuestItme(UserWorldId, 1000000787, 2)  --kiem tra vat pham nhiem vu
              local  bool1000000785 = GetQuestItme(UserWorldId, 1000000785, 2)  --kiem tra vat pham nhiem vu
              local  bool1000000773 = GetQuestItme(UserWorldId, 1000000773, 16)  --kiem tra vat pham nhiem vu
              if bool1000000792 then --du yeu cau
              if bool1000000787 then --du yeu cau
              if bool1000000785 then --du yeu cau
              if bool1000000773 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000792,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,1000000787,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,1000000785,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,1000000773,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 1000000792 ) -- SO LUONG: ( 2 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000787 ) -- SO LUONG: ( 2 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000785 ) -- SO LUONG: ( 2 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000773 ) -- SO LUONG: ( 16 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
