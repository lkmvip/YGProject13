...
--Ten nhiem vu: (???? ?? 1) --- So buoc: (5)
function MissIon123(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<84 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 84 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000389 = GetQuestItme(UserWorldId, 900000389, 50)  --kiem tra vat pham nhiem vu
              if bool900000389 then --du yeu cau
              AddQuestItme(UserWorldId,900000389,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000389,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              local  bool900000389 = GetQuestItme(UserWorldId, 900000389, 1)  --kiem tra vat pham nhiem vu
              if bool900000389 then --du yeu cau
                  AddQuestItme(UserWorldId,900000389,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000389 ) -- SO LUONG: ( 10 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 201 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==3 then
              local  bool900000389 = GetQuestItme(UserWorldId, 900000389, 10)  --kiem tra vat pham nhiem vu
              if bool900000389 then --du yeu cau
                  AddQuestItme(UserWorldId,900000389,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000389 ) -- SO LUONG: ( 10 ) -- BUOC: ( 4 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000389 ) -- SO LUONG: ( 50 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 59 ) -- Y: ( 156 ) --
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000004=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,18000000) 
              --tang thuong
