...
function MissIon435(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<127 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000779 = GetQuestItme(UserWorldId, 900000779, 10)  --kiem tra vat pham nhiem vu
              if bool900000779 then --du yeu cau
                  AddQuestItme(UserWorldId,900000779,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000779 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 26000 ) -- X: ( 414 ) -- Y: ( 225 ) --
