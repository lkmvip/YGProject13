...
function MissIon430(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000564=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000564,weiz1000000564,1) 
