...
--Ten nhiem vu: (´òÔìÑªºì¶ú»·) --- So buoc: (1)
function MissIon9304(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000199 = GetQuestItme(UserWorldId, 1000000199, 30)  --kiem tra vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000199 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz14=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,14,weiz14,1) 
        end 
