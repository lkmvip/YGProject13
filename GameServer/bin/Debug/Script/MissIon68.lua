...
function MissIon68(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<62 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000202 = GetQuestItme(UserWorldId, 900000202, 5)  --kiem tra vat pham nhiem vu
              local  bool900000203 = GetQuestItme(UserWorldId, 900000203, 5)  --kiem tra vat pham nhiem vu
              local  bool900000204 = GetQuestItme(UserWorldId, 900000204, 10)  --kiem tra vat pham nhiem vu
              if bool900000202 then --du yeu cau
              if bool900000203 then --du yeu cau
              if bool900000204 then --du yeu cau
              AddQuestItme(UserWorldId,900000202,0) --xoa vat pham nhiem vu
              AddQuestItme(UserWorldId,900000203,0) --xoa vat pham nhiem vu
              AddQuestItme(UserWorldId,900000204,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000202 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 80 ) -- Y: ( 69 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000203 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 80 ) -- Y: ( 71 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000204 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 158 ) -- Y: ( 71 ) --
