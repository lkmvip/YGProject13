...
function MissIon130(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000396 ) -- SO LUONG: ( 15 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1301 ) -- X: ( 393 ) -- Y: ( 140 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000396 = GetQuestItme(UserWorldId, 900000396, 15)  --kiem tra vat pham nhiem vu
              if bool900000396 then --du yeu cau
                  AddQuestItme(UserWorldId,900000396,0) --xoa vat pham nhiem vu
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz1000000030=GetPackage(UserWorldId)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,25500000) 
        end 
