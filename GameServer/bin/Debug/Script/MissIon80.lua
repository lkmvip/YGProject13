...
function MissIon80(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<80 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000247 = GetQuestItme(UserWorldId, 900000247, 10)  --kiem tra vat pham nhiem vu
              local  bool900000248 = GetQuestItme(UserWorldId, 900000248, 10)  --kiem tra vat pham nhiem vu
              if bool900000247 then --du yeu cau
              if bool900000248 then --du yeu cau
                  AddQuestItme(UserWorldId,900000247,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000248,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000247 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 59 ) -- Y: ( 156 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000248 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000249,1) --them vat pham cho nhiem vu khac
