...
function MissIon715(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<135 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool909000040 = GetQuestItme(UserWorldId, 909000040, 1)  --kiem tra vat pham nhiem vu
              if bool909000040 then --du yeu cau
                  AddQuestItme(UserWorldId,909000040,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<135 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,909000040,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
