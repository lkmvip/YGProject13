...
function MissIon147(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<97 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
                  AddQuestItme(UserWorldId,900000368,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
              AddQuest(UserWorldId,QuestId, StatusQuest) 
              SendMissionMsg(UserWorldId,QuestId, 11, StatusQuest)  --cho lam buoc tiep theo la 2
          elseif QuestLevel==2 then
              local  bool900000368 = GetQuestItme(UserWorldId, 900000368, 1)  --kiem tra vat pham nhiem vu
              if bool900000368 then --du yeu cau
                  AddQuestItme(UserWorldId,900000368,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000369 ) -- SO LUONG: ( 25 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 2101 ) -- X: ( 141 ) -- Y: ( 396 ) --
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000369 = GetQuestItme(UserWorldId, 900000369, 25)  --kiem tra vat pham nhiem vu
              if bool900000369 then --du yeu cau
                  AddQuestItme(UserWorldId,900000369,0) --xoa vat pham nhiem vu
