...
--Ten nhiem vu: (第三次转职申请(灵兽)) --- So buoc: (6)
function MissIon1005(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000434 = GetQuestItme(UserWorldId, 900000434, 30)  --kiem tra vat pham nhiem vu
              if bool900000434 then --du yeu cau
              AddQuestItme(UserWorldId,900000434,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000435 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1001 ) -- X: ( 489 ) -- Y: ( 423 ) --
          ...
          elseif QuestLevel==2 then
              local  bool900000435 = GetQuestItme(UserWorldId, 900000435, 10)  --kiem tra vat pham nhiem vu
              if bool900000435 then --du yeu cau
                  AddQuestItme(UserWorldId,900000435,0) --xoa vat pham nhiem vu
          ...
          elseif QuestLevel==4 then
                  AddQuestItme(UserWorldId,900000436,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==5 then
              local  bool900000436 = GetQuestItme(UserWorldId, 900000436, 1)  --kiem tra vat pham nhiem vu
              if bool900000436 then --du yeu cau
                  AddQuestItme(UserWorldId,900000436,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000437 ) -- SO LUONG: ( 5 ) -- BUOC: ( 6 ) --
-- BAN DO: ( 1001 ) -- X: ( 488 ) -- Y: ( 421 ) --
          ...
          elseif QuestLevel==6 then
              ...
              local  bool900000437 = GetQuestItme(UserWorldId, 900000437, 5)  --kiem tra vat pham nhiem vu
              if bool900000437 then --du yeu cau
                  AddQuestItme(UserWorldId,900000437,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000434 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 488 ) -- Y: ( 422 ) --
