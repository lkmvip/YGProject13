...
function MissIon163(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<93 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000480 = GetQuestItme(UserWorldId, 900000480, 20)  --kiem tra vat pham nhiem vu
              if bool900000480 then --du yeu cau
              AddQuestItme(UserWorldId,900000480,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000481 ) -- SO LUONG: ( 20 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 5001 ) -- X: ( 235 ) -- Y: ( 307 ) --
          ...
          elseif QuestLevel==2 then
              local  bool900000481 = GetQuestItme(UserWorldId, 900000481, 20)  --kiem tra vat pham nhiem vu
              if bool900000481 then --du yeu cau
                  AddQuestItme(UserWorldId,900000481,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000480 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 314 ) -- Y: ( 205 ) --
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000004=GetPackages(UserWorldId,4)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,40000000) 
        end 
