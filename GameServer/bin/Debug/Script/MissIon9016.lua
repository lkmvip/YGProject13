...
--Ten nhiem vu: (情人节的巧克力) --- So buoc: (1)
function MissIon9016(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000138 = GetQuestItme(UserWorldId, 999000138, 15)  --kiem tra vat pham nhiem vu
              local  bool999000142 = GetQuestItme(UserWorldId, 999000142, 15)  --kiem tra vat pham nhiem vu
              local  bool999000139 = GetQuestItme(UserWorldId, 999000139, 15)  --kiem tra vat pham nhiem vu
              if bool999000138 then --du yeu cau
              if bool999000142 then --du yeu cau
              if bool999000139 then --du yeu cau
                  AddQuestItme(UserWorldId,999000138,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,999000142,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,999000139,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000138 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 999000142 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 999000139 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000907=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000907,weiz1000000907,1) 
              --tang thuong
              local weiz1000000908=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000908,weiz1000000908,1) 
        end 
