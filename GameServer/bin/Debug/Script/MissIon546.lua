...
function MissIon546(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<50 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000700 = GetQuestItme(UserWorldId, 900000700, 10)  --kiem tra vat pham nhiem vu
              if bool900000700 then --du yeu cau
                  AddQuestItme(UserWorldId,900000700,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000700 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 427 ) -- Y: ( 355 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000001=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,920000) 
        end 
