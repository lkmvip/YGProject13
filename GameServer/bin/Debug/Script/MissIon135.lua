...
function MissIon135(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<88 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 88 moi co the nhan nhiem vu !", 9, "He thong")
...
-- ID VAT PHAM: ( 900000349 ) -- SO LUONG: ( 20 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1101 ) -- X: ( 60 ) -- Y: ( 155 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000349 = GetQuestItme(UserWorldId, 900000349, 20)  --kiem tra vat pham nhiem vu
              if bool900000349 then --du yeu cau
                  AddQuestItme(UserWorldId,900000349,0) --xoa vat pham nhiem vu
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz1000000030=GetPackage(UserWorldId)  --vi tri con trong
                  ...
                  AddKiToCharacter(UserWorldId,70000) 
        end 
