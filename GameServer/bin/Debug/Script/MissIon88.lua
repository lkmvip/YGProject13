...
function MissIon88(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<69 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 69 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000302 = GetQuestItme(UserWorldId, 900000302, 15)  --kiem tra vat pham nhiem vu
              if bool900000302 then --du yeu cau
              AddQuestItme(UserWorldId,900000302,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000303,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              local  bool900000303 = GetQuestItme(UserWorldId, 900000303, 1)  --kiem tra vat pham nhiem vu
              if bool900000303 then --du yeu cau
                  AddQuestItme(UserWorldId,900000303,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000303,1) --them vat pham nhiem vu cho buoc tiep theo
...
-- ID VAT PHAM: ( 900000302 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1301 ) -- X: ( 78 ) -- Y: ( 308 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz9000088=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,9000088,weiz9000088,1) 
                  AddExpToCharacter(UserWorldId,4400000) 
              --tang thuong
              local weiz1008000261=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000261,weiz1008000261,1) 
        end 
