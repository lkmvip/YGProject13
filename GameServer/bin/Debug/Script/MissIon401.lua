...
function MissIon401(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<122 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000637 = GetQuestItme(UserWorldId, 900000637, 50)  --kiem tra vat pham nhiem vu
              if bool900000637 then --du yeu cau
                  AddQuestItme(UserWorldId,900000637,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000637 ) -- SO LUONG: ( 50 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 453 ) -- Y: ( 283 ) --
