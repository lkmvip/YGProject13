...
function MissIon518(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<26 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 26 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000660 = GetQuestItme(UserWorldId, 900000660, 1)  --kiem tra vat pham nhiem vu
              if bool900000660 then --du yeu cau
                  AddQuestItme(UserWorldId,900000660,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<26 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000660,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz800000002=GetPackages(UserWorldId,4)  --vi tri con trong
                  ...
                  AddItmeProp(UserWorldId,800000002,weiz800000002[3],1,chiso,0,0,0,0,0,0,0,0)
                  AddExpToCharacter(UserWorldId,16500) 
        end 
