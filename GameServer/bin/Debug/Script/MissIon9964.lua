...
--Ten nhiem vu: (ºÈ×íµÄÐ¡Â¹) --- So buoc: (1)
function MissIon9964(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000434 = GetQuestItme(UserWorldId, 999000434, 50)  --kiem tra vat pham nhiem vu
              if bool999000434 then --du yeu cau
                  AddQuestItme(UserWorldId,999000434,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000434 ) -- SO LUONG: ( 50 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000889=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000889,weiz1008000889,1) 
              --tang thuong
              local weiz9009964=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,9009964,weiz9009964,1) 
        end 
