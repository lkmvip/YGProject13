...
function MissIon545(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<49 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000699 = GetQuestItme(UserWorldId, 900000699, 15)  --kiem tra vat pham nhiem vu
              if bool900000699 then --du yeu cau
                  AddQuestItme(UserWorldId,900000699,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000699 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 58 ) -- Y: ( 79 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz9000545=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,9000545,weiz9000545,1) 
