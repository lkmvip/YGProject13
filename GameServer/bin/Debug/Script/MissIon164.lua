...
--Ten nhiem vu: (??? ??) --- So buoc: (6)
function MissIon164(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000482 ) -- SO LUONG: ( 20 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 5001 ) -- X: ( 238 ) -- Y: ( 304 ) --
          ...
          elseif QuestLevel==3 then
              local  bool900000482 = GetQuestItme(UserWorldId, 900000482, 20)  --kiem tra vat pham nhiem vu
              if bool900000482 then --du yeu cau
                  AddQuestItme(UserWorldId,900000482,0) --xoa vat pham nhiem vu
          ...
          elseif QuestLevel==4 then
                  AddQuestItme(UserWorldId,900000483,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==5 then
              local  bool900000483 = GetQuestItme(UserWorldId, 900000483, 1)  --kiem tra vat pham nhiem vu
              if bool900000483 then --du yeu cau
                  AddQuestItme(UserWorldId,900000483,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddKiToCharacter(UserWorldId,150000) 
              --tang thuong
