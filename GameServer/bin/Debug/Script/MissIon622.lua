...
function MissIon622(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<140 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool100204009 = GetQuestItme(UserWorldId, 100204009, 1)  --kiem tra vat pham nhiem vu
              local  bool900000762 = GetQuestItme(UserWorldId, 900000762, 5)  --kiem tra vat pham nhiem vu
              local  bool100204010 = GetQuestItme(UserWorldId, 100204010, 1)  --kiem tra vat pham nhiem vu
              if bool100204009 then --du yeu cau
              if bool900000762 then --du yeu cau
              if bool100204010 then --du yeu cau
                  AddQuestItme(UserWorldId,100204009,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000762,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,100204010,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<140 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,100204009,1) --them vat pham nhiem vu cho buoc tiep theo
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000762 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
                  AddQuestItme(UserWorldId,100204010,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz100204026=GetPackage(UserWorldId)  --vi tri con trong
