...
function MissIon190(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<100 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000533 = GetQuestItme(UserWorldId, 900000533, 10)  --kiem tra vat pham nhiem vu
              local  bool900000534 = GetQuestItme(UserWorldId, 900000534, 10)  --kiem tra vat pham nhiem vu
              if bool900000533 then --du yeu cau
              if bool900000534 then --du yeu cau
                  AddQuestItme(UserWorldId,900000533,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000534,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000533 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 113 ) -- Y: ( 80 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000534 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 121 ) -- Y: ( 74 ) --
