...
function MissIon587(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<133 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000743 = GetQuestItme(UserWorldId, 900000743, 20)  --kiem tra vat pham nhiem vu
              if bool900000743 then --du yeu cau
                  AddQuestItme(UserWorldId,900000743,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000743 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 26000 ) -- X: ( 466 ) -- Y: ( 108 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000028=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,800000028,weiz800000028,2) 
