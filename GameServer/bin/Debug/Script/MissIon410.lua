...
function MissIon410(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<130 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000645 = GetQuestItme(UserWorldId, 900000645, 70)  --kiem tra vat pham nhiem vu
              if bool900000645 then --du yeu cau
                  AddQuestItme(UserWorldId,900000645,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000645 ) -- SO LUONG: ( 70 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 6001 ) -- X: ( 0 ) -- Y: ( 0 ) --
