...
function MissIon76(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000238 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1101 ) -- X: ( 59 ) -- Y: ( 157 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000238 = GetQuestItme(UserWorldId, 900000238, 10)  --kiem tra vat pham nhiem vu
              if bool900000238 then --du yeu cau
                  AddQuestItme(UserWorldId,900000238,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000239,1) --them vat pham cho nhiem vu khac
