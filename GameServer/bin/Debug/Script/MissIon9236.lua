...
--Ten nhiem vu: (幸运宝藏的传说) --- So buoc: (1)
function MissIon9236(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000635 = GetQuestItme(UserWorldId, 1000000635, 50)  --kiem tra vat pham nhiem vu
              if bool1000000635 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000635,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 1000000635 ) -- SO LUONG: ( 50 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
