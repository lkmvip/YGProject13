...
--Ten nhiem vu: ([GM] ???? ??) --- So buoc: (1)
function MissIon338(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<118 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 118 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000611 = GetQuestItme(UserWorldId, 900000611, 2)  --kiem tra vat pham nhiem vu
              if bool900000611 then --du yeu cau
                  AddQuestItme(UserWorldId,900000611,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000611 ) -- SO LUONG: ( 2 ) -- BUOC: ( 1 ) --
