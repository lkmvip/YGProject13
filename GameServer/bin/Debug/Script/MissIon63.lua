...
function MissIon63(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000193 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1001 ) -- X: ( 75 ) -- Y: ( 58 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000193 = GetQuestItme(UserWorldId, 900000193, 10)  --kiem tra vat pham nhiem vu
              if bool900000193 then --du yeu cau
                  AddQuestItme(UserWorldId,900000193,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000209,1) --them vat pham cho nhiem vu khac
              --tang thuong
