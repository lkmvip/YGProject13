...
function MissIon585(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<136 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 136 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000741 = GetQuestItme(UserWorldId, 900000741, 5)  --kiem tra vat pham nhiem vu
              if bool900000741 then --du yeu cau
                  AddQuestItme(UserWorldId,900000741,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000741 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 26000 ) -- X: ( 272 ) -- Y: ( 419 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000080=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000080,weiz1008000080,1) 
                  AddExpToCharacter(UserWorldId,1000000000) 
        end 
