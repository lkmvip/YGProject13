...
function MissIon143(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<94 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000353 = GetQuestItme(UserWorldId, 900000353, 20)  --kiem tra vat pham nhiem vu
              if bool900000353 then --du yeu cau
              AddQuestItme(UserWorldId,900000353,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000353 ) -- SO LUONG: ( 20 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1101 ) -- X: ( 0 ) -- Y: ( 0 ) --
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000353 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 2101 ) -- X: ( 360 ) -- Y: ( 49 ) --
