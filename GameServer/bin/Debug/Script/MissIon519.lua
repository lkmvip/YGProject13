...
function MissIon519(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<27 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 27 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000661 = GetQuestItme(UserWorldId, 900000661, 5)  --kiem tra vat pham nhiem vu
              local  bool900000662 = GetQuestItme(UserWorldId, 900000662, 1)  --kiem tra vat pham nhiem vu
              if bool900000661 then --du yeu cau
              if bool900000662 then --du yeu cau
              AddQuestItme(UserWorldId,900000661,0) --xoa vat pham nhiem vu
              AddQuestItme(UserWorldId,900000662,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000661 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 119 ) -- Y: ( 328 ) --
 
                  AddQuestItme(UserWorldId,900000662,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
            AddQuest(UserWorldId,QuestId, StatusQuest)
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000001=GetPackages(UserWorldId,4)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,19500) 
        end 
