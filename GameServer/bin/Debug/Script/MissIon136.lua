...
function MissIon136(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<89 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000350 = GetQuestItme(UserWorldId, 900000350, 20)  --kiem tra vat pham nhiem vu
              if bool900000350 then --du yeu cau
                  AddQuestItme(UserWorldId,900000350,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000350 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 2201 ) -- X: ( 348 ) -- Y: ( 195 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000024=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,28000000) 
        end 
