...
function MissIon65(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<61 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000195 = GetQuestItme(UserWorldId, 900000195, 10)  --kiem tra vat pham nhiem vu
              local  bool900000196 = GetQuestItme(UserWorldId, 900000196, 5)  --kiem tra vat pham nhiem vu
              if bool900000195 then --du yeu cau
              if bool900000196 then --du yeu cau
              AddQuestItme(UserWorldId,900000195,0) --xoa vat pham nhiem vu
              AddQuestItme(UserWorldId,900000196,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000195 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 76 ) -- Y: ( 57 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000196 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 76 ) -- Y: ( 57 ) --
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000210,1) --them vat pham cho nhiem vu khac
