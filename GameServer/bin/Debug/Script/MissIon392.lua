...
function MissIon392(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<140 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1008000389 = GetQuestItme(UserWorldId, 1008000389, 1)  --kiem tra vat pham nhiem vu
              if bool1008000389 then --du yeu cau
                  AddQuestItme(UserWorldId,1008000389,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<140 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,1008000389,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,909000021,50) --them vat pham cho nhiem vu khac
        end 
