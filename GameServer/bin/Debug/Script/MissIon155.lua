...
function MissIon155(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<77 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 77 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000484 = GetQuestItme(UserWorldId, 900000484, 8)  --kiem tra vat pham nhiem vu
              local  bool900000485 = GetQuestItme(UserWorldId, 900000485, 8)  --kiem tra vat pham nhiem vu
              if bool900000484 then --du yeu cau
              if bool900000485 then --du yeu cau
              AddQuestItme(UserWorldId,900000484,0) --xoa vat pham nhiem vu
              AddQuestItme(UserWorldId,900000485,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000486,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000486 = GetQuestItme(UserWorldId, 900000486, 1)  --kiem tra vat pham nhiem vu
              if bool900000486 then --du yeu cau
                  AddQuestItme(UserWorldId,900000486,0) --xoa vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000484 ) -- SO LUONG: ( 8 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 459 ) -- Y: ( 269 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000485 ) -- SO LUONG: ( 8 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 223 ) -- Y: ( 439 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000024=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddKiToCharacter(UserWorldId,40000) 
        end 
