...
function MissIon538(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<40 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000692 = GetQuestItme(UserWorldId, 900000692, 15)  --kiem tra vat pham nhiem vu
              if bool900000692 then --du yeu cau
                  AddQuestItme(UserWorldId,900000692,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000692 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 269 ) -- Y: ( 311 ) --
