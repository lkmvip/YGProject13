...
function MissIon358(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<128 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000620 = GetQuestItme(UserWorldId, 900000620, 1)  --kiem tra vat pham nhiem vu
              if bool900000620 then --du yeu cau
                  AddQuestItme(UserWorldId,900000620,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<128 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000620,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000714=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000714,weiz1000000714,1) 
        end 
