...
--Ten nhiem vu: (ÒÔ¾É»»ÐÂ) --- So buoc: (1)
function MissIon9743(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000923 = GetQuestItme(UserWorldId, 1000000923, 2)  --kiem tra vat pham nhiem vu
              if bool1000000923 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000923,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 1000000923 ) -- SO LUONG: ( 2 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
