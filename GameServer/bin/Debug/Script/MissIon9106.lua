...
--Ten nhiem vu: (打造捉鬼女道士) --- So buoc: (1)
function MissIon9106(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000161 = GetQuestItme(UserWorldId, 1000000161, 60)  --kiem tra vat pham nhiem vu
              ...
              local  bool1000000164 = GetQuestItme(UserWorldId, 1000000164, 60)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 1000000161 ) -- SO LUONG: ( 60 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000164 ) -- SO LUONG: ( 60 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz26900331=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,26900331,weiz26900331,1) 
        end 
