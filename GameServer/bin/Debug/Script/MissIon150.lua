...
function MissIon150(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<99 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000372 = GetQuestItme(UserWorldId, 900000372, 1)  --kiem tra vat pham nhiem vu
              if bool900000372 then --du yeu cau
              AddQuestItme(UserWorldId,900000372,0) --xoa vat pham nhiem vu
              StatusQuest=2 
          ...
          elseif QuestLevel==3 then
                  AddQuestItme(UserWorldId,900000373,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==4 then
              local  bool900000373 = GetQuestItme(UserWorldId, 900000373, 1)  --kiem tra vat pham nhiem vu
              if bool900000373 then --du yeu cau
                  AddQuestItme(UserWorldId,900000373,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000374,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==5 then
              local  bool900000374 = GetQuestItme(UserWorldId, 900000374, 1)  --kiem tra vat pham nhiem vu
              if bool900000374 then --du yeu cau
                  AddQuestItme(UserWorldId,900000374,0) --xoa vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000375 ) -- SO LUONG: ( 50 ) -- BUOC: ( 8 ) --
-- BAN DO: ( 2201 ) -- X: ( 68 ) -- Y: ( 45 ) --
 
                  AddQuestItme(UserWorldId,900000376,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==8 then
              ...
              local  bool900000375 = GetQuestItme(UserWorldId, 900000375, 50)  --kiem tra vat pham nhiem vu
              local  bool900000376 = GetQuestItme(UserWorldId, 900000376, 1)  --kiem tra vat pham nhiem vu
              if bool900000375 then --du yeu cau
              if bool900000376 then --du yeu cau
                  AddQuestItme(UserWorldId,900000375,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000376,0) --xoa vat pham nhiem vu
      ...
      if Player.Player_FLD_LEVEL<99 then  
         ...
         if QuestLevel==9 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000372,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
            AddQuest(UserWorldId,QuestId, StatusQuest)
