...
function MissIon511(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<16 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 16 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000673 = GetQuestItme(UserWorldId, 900000673, 5)  --kiem tra vat pham nhiem vu
              if bool900000673 then --du yeu cau
                  AddQuestItme(UserWorldId,900000673,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000673 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 111 ) -- Y: ( 162 ) --
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000003=GetPackages(UserWorldId,1)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,2000) 
                  AddKiToCharacter(UserWorldId,500) 
        end 
