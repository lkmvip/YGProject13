...
--Ten nhiem vu: ([GM] ??? ?? ??(60?? ??)) --- So buoc: (1)
function MissIon1011(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<0 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000176 = GetQuestItme(UserWorldId, 999000176, 100)  --kiem tra vat pham nhiem vu
              if bool999000176 then --du yeu cau
                  AddQuestItme(UserWorldId,999000176,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000176 ) -- SO LUONG: ( 100 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000258=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000258,weiz1000000258,1) 
        end 
