...
--Ten nhiem vu: (ÖÆ×÷Ö¥ÂéÔÂ±ý) --- So buoc: (1)
function MissIon9024(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000129 = GetQuestItme(UserWorldId, 1000000129, 5)  --kiem tra vat pham nhiem vu
              local  bool1000000131 = GetQuestItme(UserWorldId, 1000000131, 6)  --kiem tra vat pham nhiem vu
              if bool1000000129 then --du yeu cau
              if bool1000000131 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000129,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,1000000131,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 1000000129 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000131 ) -- SO LUONG: ( 6 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000125=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000125,weiz1000000125,1) 
        end 
