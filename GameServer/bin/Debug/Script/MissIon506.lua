...
function MissIon506(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<11 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 11 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000672 = GetQuestItme(UserWorldId, 900000672, 5)  --kiem tra vat pham nhiem vu
              if bool900000672 then --du yeu cau
                  AddQuestItme(UserWorldId,900000672,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000672 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 469 ) -- Y: ( 81 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz700001=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,700001,weiz700001,1) 
                  AddExpToCharacter(UserWorldId,600) 
                  AddKiToCharacter(UserWorldId,300) 
        end 
