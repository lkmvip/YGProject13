...
function MissIon229(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000635 = GetQuestItme(UserWorldId, 900000635, 2)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000635 ) -- SO LUONG: ( 2 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 4001 ) -- X: ( 0 ) -- Y: ( 0 ) --
