...
function MissIon124(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000384 ) -- SO LUONG: ( 40 ) -- BUOC: ( 4 ) --
-- BAN DO: ( 1001 ) -- X: ( 489 ) -- Y: ( 431 ) --
          ...
          elseif QuestLevel==4 then
              local  bool900000384 = GetQuestItme(UserWorldId, 900000384, 40)  --kiem tra vat pham nhiem vu
              if bool900000384 then --du yeu cau
                  AddQuestItme(UserWorldId,900000384,0) --xoa vat pham nhiem vu
