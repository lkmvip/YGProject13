...
function MissIon434(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<126 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000777 = GetQuestItme(UserWorldId, 900000777, 10)  --kiem tra vat pham nhiem vu
              local  bool900000778 = GetQuestItme(UserWorldId, 900000778, 10)  --kiem tra vat pham nhiem vu
              if bool900000777 then --du yeu cau
              if bool900000778 then --du yeu cau
                  AddQuestItme(UserWorldId,900000777,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000778,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000777 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 296 ) -- Y: ( 325 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000778 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 220 ) -- Y: ( 403 ) --
