...
function MissIon591(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<133 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 133 moi co the nhan nhiem vu !", 9, "He thong")
...
-- ID VAT PHAM: ( 900000747 ) -- SO LUONG: ( 20 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 26000 ) -- X: ( 102 ) -- Y: ( 181 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000747 = GetQuestItme(UserWorldId, 900000747, 20)  --kiem tra vat pham nhiem vu
              if bool900000747 then --du yeu cau
                  AddQuestItme(UserWorldId,900000747,0) --xoa vat pham nhiem vu
