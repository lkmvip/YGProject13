...
--Ten nhiem vu: (???? ??? ??) --- So buoc: (11)
function MissIon176(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000505 ) -- SO LUONG: ( 50 ) -- BUOC: ( 10 ) --
-- BAN DO: ( 5001 ) -- X: ( 382 ) -- Y: ( 431 ) --
          ...
          elseif QuestLevel==10 then
              local  bool900000505 = GetQuestItme(UserWorldId, 900000505, 50)  --kiem tra vat pham nhiem vu
              if bool900000505 then --du yeu cau
                  AddQuestItme(UserWorldId,900000505,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000505,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==11 then
              ...
              local  bool900000505 = GetQuestItme(UserWorldId, 900000505, 1)  --kiem tra vat pham nhiem vu
              if bool900000505 then --du yeu cau
                  AddQuestItme(UserWorldId,900000505,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz700801=GetPackage(UserWorldId)  --vi tri con trong
              ...
              local weiz800000023=GetPackages(UserWorldId,1)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,230000000) 
        end 
