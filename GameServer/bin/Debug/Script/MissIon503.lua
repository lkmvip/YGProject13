...
function MissIon503(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<4 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000654 = GetQuestItme(UserWorldId, 900000654, 5)  --kiem tra vat pham nhiem vu
              if bool900000654 then --du yeu cau
                  AddQuestItme(UserWorldId,900000654,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000654 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 252 ) -- Y: ( 175 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000322=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000322,weiz1000000322,1) 
        end 
