...
function MissIon100(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000307 ) -- SO LUONG: ( 5 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1001 ) -- X: ( 488 ) -- Y: ( 432 ) --
 
              StatusQuest=2 
              AddQuest(UserWorldId,QuestId, StatusQuest) 
              SendMissionMsg(UserWorldId,QuestId, 11, StatusQuest)  --cho lam buoc tiep theo la 2
          elseif QuestLevel==2 then
              local  bool900000307 = GetQuestItme(UserWorldId, 900000307, 5)  --kiem tra vat pham nhiem vu
              if bool900000307 then --du yeu cau
                  AddQuestItme(UserWorldId,900000307,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000308 ) -- SO LUONG: ( 10 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 1001 ) -- X: ( 489 ) -- Y: ( 431 ) --
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000308 = GetQuestItme(UserWorldId, 900000308, 10)  --kiem tra vat pham nhiem vu
              if bool900000308 then --du yeu cau
                  AddQuestItme(UserWorldId,900000308,0) --xoa vat pham nhiem vu
