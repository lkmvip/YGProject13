...
--Ten nhiem vu: (全民欢庆大礼包) --- So buoc: (1)
function MissIon9811(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000862=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000862,weiz1008000862,1) 
        end 
