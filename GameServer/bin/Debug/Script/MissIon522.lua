...
function MissIon522(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<31 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 31 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000679 = GetQuestItme(UserWorldId, 900000679, 10)  --kiem tra vat pham nhiem vu
              if bool900000679 then --du yeu cau
                  AddQuestItme(UserWorldId,900000679,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000679 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 360 ) -- Y: ( 479 ) --
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000006=GetPackage(UserWorldId)  --vi tri con trong
                  ...
                  AddKiToCharacter(UserWorldId,2000) 
                  AddExpToCharacter(UserWorldId,41000) 
        end 
