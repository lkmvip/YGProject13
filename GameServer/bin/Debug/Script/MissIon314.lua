...
--Ten nhiem vu: (( CON TRONG )) --- So buoc: (0)
function MissIon314(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000891=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000891,weiz1000000891,1) 
        end 
