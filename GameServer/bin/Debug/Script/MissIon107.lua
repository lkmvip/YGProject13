...
function MissIon107(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<81 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000323 = GetQuestItme(UserWorldId, 900000323, 20)  --kiem tra vat pham nhiem vu
              if bool900000323 then --du yeu cau
              AddQuestItme(UserWorldId,900000323,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000324,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000324 = GetQuestItme(UserWorldId, 900000324, 1)  --kiem tra vat pham nhiem vu
              if bool900000324 then --du yeu cau
                  AddQuestItme(UserWorldId,900000324,0) --xoa vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000323 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
