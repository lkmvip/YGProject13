...
--Ten nhiem vu: (新手卡任务) --- So buoc: (0)
function MissIon9937(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      if Player.Player_FLD_LEVEL<60 then  
         ...
         if QuestLevel==1 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,999000280,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
