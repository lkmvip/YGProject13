...
function MissIon517(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<23 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 23 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000669 = GetQuestItme(UserWorldId, 900000669, 10)  --kiem tra vat pham nhiem vu
              if bool900000669 then --du yeu cau
                  AddQuestItme(UserWorldId,900000669,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000669 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 201 ) -- Y: ( 328 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz400002=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,400002,weiz400002,1) 
                  AddExpToCharacter(UserWorldId,9500) 
        end 
