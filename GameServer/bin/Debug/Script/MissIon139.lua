...
function MissIon139(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<91 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000356 = GetQuestItme(UserWorldId, 900000356, 20)  --kiem tra vat pham nhiem vu
              if bool900000356 then --du yeu cau
              AddQuestItme(UserWorldId,900000356,0) --xoa vat pham nhiem vu
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
                  AddQuestItme(UserWorldId,900000357,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000357 = GetQuestItme(UserWorldId, 900000357, 1)  --kiem tra vat pham nhiem vu
              if bool900000357 then --du yeu cau
                  AddQuestItme(UserWorldId,900000357,0) --xoa vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000356 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 2101 ) -- X: ( 441 ) -- Y: ( 433 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz502010=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,502010,weiz502010,1) 
                  AddExpToCharacter(UserWorldId,33500000) 
        end 
