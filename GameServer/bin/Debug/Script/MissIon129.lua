...
function MissIon129(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000395 ) -- SO LUONG: ( 100 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 1301 ) -- X: ( 393 ) -- Y: ( 140 ) --
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000395 = GetQuestItme(UserWorldId, 900000395, 100)  --kiem tra vat pham nhiem vu
              if bool900000395 then --du yeu cau
                  AddQuestItme(UserWorldId,900000395,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz800000001=GetPackages(UserWorldId,1)  --vi tri con trong
