...
function MissIon555(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<45 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000711 = GetQuestItme(UserWorldId, 900000711, 10)  --kiem tra vat pham nhiem vu
              if bool900000711 then --du yeu cau
                  AddQuestItme(UserWorldId,900000711,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000711 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 287 ) -- Y: ( 416 ) --
