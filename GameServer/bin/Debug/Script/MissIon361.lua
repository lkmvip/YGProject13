...
function MissIon361(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000634 = GetQuestItme(UserWorldId, 900000634, 1)  --kiem tra vat pham nhiem vu
              if bool900000634 then --du yeu cau
                  AddQuestItme(UserWorldId,900000634,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<60 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000634,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,909000013,1) --them vat pham cho nhiem vu khac
              AddQuestItme(UserWorldId,909000018,1) --them vat pham cho nhiem vu khac
              AddQuestItme(UserWorldId,909000020,1) --them vat pham cho nhiem vu khac
        end 
