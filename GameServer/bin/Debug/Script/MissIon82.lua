...
--Ten nhiem vu: (? ?? ?? ?? 5/5) --- So buoc: (7)
function MissIon82(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<80 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000256 = GetQuestItme(UserWorldId, 900000256, 5)  --kiem tra vat pham nhiem vu
              local  bool900000257 = GetQuestItme(UserWorldId, 900000257, 5)  --kiem tra vat pham nhiem vu
              local  bool900000258 = GetQuestItme(UserWorldId, 900000258, 5)  --kiem tra vat pham nhiem vu
              local  bool900000259 = GetQuestItme(UserWorldId, 900000259, 5)  --kiem tra vat pham nhiem vu
              if bool900000256 then --du yeu cau
              if bool900000257 then --du yeu cau
              if bool900000258 then --du yeu cau
              if bool900000259 then --du yeu cau
              AddQuestItme(UserWorldId,900000256,0) --xoa vat pham nhiem vu
              AddQuestItme(UserWorldId,900000257,0) --xoa vat pham nhiem vu
              AddQuestItme(UserWorldId,900000258,0) --xoa vat pham nhiem vu
              AddQuestItme(UserWorldId,900000259,0) --xoa vat pham nhiem vu
              StatusQuest=2 
          ...
          elseif QuestLevel==3 then
                  AddQuestItme(UserWorldId,900000260,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==4 then
              local  bool900000260 = GetQuestItme(UserWorldId, 900000260, 1)  --kiem tra vat pham nhiem vu
              if bool900000260 then --du yeu cau
                  AddQuestItme(UserWorldId,900000260,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000261,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==5 then
              local  bool900000261 = GetQuestItme(UserWorldId, 900000261, 1)  --kiem tra vat pham nhiem vu
              if bool900000261 then --du yeu cau
                  AddQuestItme(UserWorldId,900000261,0) --xoa vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000256 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 65 ) -- Y: ( 151 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000257 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000258 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000259 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddMoneyToCharacter(UserWorldId,5000000) 
                  SendSysMsg(UserWorldId,"Nhan duoc 5000000 tien vang!", 9, "He thong")
                  AddExpToCharacter(UserWorldId,8500000) 
        end 
