...
--Ten nhiem vu: ([??? ?? 3?] ??? ??) --- So buoc: (4)
function MissIon436(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000780 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 26000 ) -- X: ( 411 ) -- Y: ( 225 ) --
 
              StatusQuest=2 
              AddQuest(UserWorldId,QuestId, StatusQuest) 
              SendMissionMsg(UserWorldId,QuestId, 11, StatusQuest)  --cho lam buoc tiep theo la 2
          elseif QuestLevel==2 then
              local  bool900000780 = GetQuestItme(UserWorldId, 900000780, 10)  --kiem tra vat pham nhiem vu
              if bool900000780 then --du yeu cau
                  AddQuestItme(UserWorldId,900000780,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000781,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              local  bool900000781 = GetQuestItme(UserWorldId, 900000781, 1)  --kiem tra vat pham nhiem vu
              if bool900000781 then --du yeu cau
                  AddQuestItme(UserWorldId,900000781,0) --xoa vat pham nhiem vu
