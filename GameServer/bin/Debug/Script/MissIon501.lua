...
function MissIon501(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<2 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 2 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000652 = GetQuestItme(UserWorldId, 900000652, 1)  --kiem tra vat pham nhiem vu
              local  bool900000653 = GetQuestItme(UserWorldId, 900000653, 1)  --kiem tra vat pham nhiem vu
              if bool900000652 then --du yeu cau
              if bool900000653 then --du yeu cau
              AddQuestItme(UserWorldId,900000652,0) --xoa vat pham nhiem vu
              AddQuestItme(UserWorldId,900000653,0) --xoa vat pham nhiem vu
              StatusQuest=2 
      ...
      if Player.Player_FLD_LEVEL<2 then  
         ...
         if QuestLevel==3 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000652,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,900000653,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
            AddQuest(UserWorldId,QuestId, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,266) 
              --tang thuong
              local weiz500001=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,500001,weiz500001,2) 
        end 
