...
--Ten nhiem vu: (八卦老人的嘱托 51-99级领取) --- So buoc: (1)
function MissIon9789(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<51 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 51 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000585 = GetQuestItme(UserWorldId, 999000585, 30)  --kiem tra vat pham nhiem vu
              local  bool999000586 = GetQuestItme(UserWorldId, 999000586, 30)  --kiem tra vat pham nhiem vu
              local  bool999000587 = GetQuestItme(UserWorldId, 999000587, 30)  --kiem tra vat pham nhiem vu
              if bool999000585 then --du yeu cau
              if bool999000586 then --du yeu cau
              if bool999000587 then --du yeu cau
                  AddQuestItme(UserWorldId,999000585,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,999000586,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,999000587,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000585 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1301 ) -- X: ( 305 ) -- Y: ( 199 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 999000586 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1301 ) -- X: ( 268 ) -- Y: ( 270 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 999000587 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1301 ) -- X: ( 265 ) -- Y: ( 376 ) --
