...
function MissIon566(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<37 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000722 = GetQuestItme(UserWorldId, 900000722, 10)  --kiem tra vat pham nhiem vu
              if bool900000722 then --du yeu cau
                  AddQuestItme(UserWorldId,900000722,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000722 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 286 ) -- Y: ( 92 ) --
