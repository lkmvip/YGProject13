...
function MissIon527(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<35 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000681 = GetQuestItme(UserWorldId, 900000681, 1)  --kiem tra vat pham nhiem vu
              if bool900000681 then --du yeu cau
                  AddQuestItme(UserWorldId,900000681,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<35 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000681,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000018=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000018,weiz1008000018,1) 
