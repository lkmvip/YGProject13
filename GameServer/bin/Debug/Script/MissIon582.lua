...
function MissIon582(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<150 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 150 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000738 = GetQuestItme(UserWorldId, 900000738, 10)  --kiem tra vat pham nhiem vu
              if bool900000738 then --du yeu cau
                  AddQuestItme(UserWorldId,900000738,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000738 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 26000 ) -- X: ( 101 ) -- Y: ( 450 ) --
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000061=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,800000061,weiz800000061,2) 
