...
function MissIon704(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<80 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool909000029 = GetQuestItme(UserWorldId, 909000029, 20)  --kiem tra vat pham nhiem vu
              if bool909000029 then --du yeu cau
                  AddQuestItme(UserWorldId,909000029,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 909000029 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,800000) 
        end 
