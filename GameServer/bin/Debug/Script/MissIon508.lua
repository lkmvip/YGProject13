...
function MissIon508(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<13 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 13 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000668 = GetQuestItme(UserWorldId, 900000668, 10)  --kiem tra vat pham nhiem vu
              if bool900000668 then --du yeu cau
                  AddQuestItme(UserWorldId,900000668,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000668 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 207 ) -- Y: ( 180 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz400001=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,400001,weiz400001,1) 
                  AddExpToCharacter(UserWorldId,950) 
        end 
