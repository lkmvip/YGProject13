...
function MissIon578(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<140 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000734 = GetQuestItme(UserWorldId, 900000734, 1)  --kiem tra vat pham nhiem vu
              if bool900000734 then --du yeu cau
                  AddQuestItme(UserWorldId,900000734,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<140 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000734,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000638=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000638,weiz1000000638,5) 
                  AddExpToCharacter(UserWorldId,1700000000) 
        end 
