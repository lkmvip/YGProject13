...
function MissIon102(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000311 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1001 ) -- X: ( 489 ) -- Y: ( 431 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000312 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1001 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==2 then
              local  bool900000311 = GetQuestItme(UserWorldId, 900000311, 10)  --kiem tra vat pham nhiem vu
              local  bool900000312 = GetQuestItme(UserWorldId, 900000312, 10)  --kiem tra vat pham nhiem vu
              if bool900000311 then --du yeu cau
              if bool900000312 then --du yeu cau
                  AddQuestItme(UserWorldId,900000311,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000312,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000313,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              local  bool900000313 = GetQuestItme(UserWorldId, 900000313, 1)  --kiem tra vat pham nhiem vu
              if bool900000313 then --du yeu cau
                  AddQuestItme(UserWorldId,900000313,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000314,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==4 then
              ...
              local  bool900000314 = GetQuestItme(UserWorldId, 900000314, 1)  --kiem tra vat pham nhiem vu
              if bool900000314 then --du yeu cau
                  AddQuestItme(UserWorldId,900000314,0) --xoa vat pham nhiem vu
