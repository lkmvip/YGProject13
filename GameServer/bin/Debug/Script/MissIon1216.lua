...
--Ten nhiem vu: (达到目标!! 34级庆祝礼物) --- So buoc: (0)
function MissIon1216(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<34 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 34 moi co the nhan nhiem vu !", 9, "He thong")
