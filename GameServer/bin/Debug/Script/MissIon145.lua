...
function MissIon145(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<95 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000364 = GetQuestItme(UserWorldId, 900000364, 30)  --kiem tra vat pham nhiem vu
              if bool900000364 then --du yeu cau
              AddQuestItme(UserWorldId,900000364,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000364 ) -- SO LUONG: ( 30 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1101 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==2 then
              ...
              if bool900000364 then --du yeu cau
                  AddQuestItme(UserWorldId,900000364,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000365,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000365 = GetQuestItme(UserWorldId, 900000365, 1)  --kiem tra vat pham nhiem vu
              if bool900000365 then --du yeu cau
                  AddQuestItme(UserWorldId,900000365,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000364 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 2101 ) -- X: ( 365 ) -- Y: ( 43 ) --
