...
function MissIon219(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<0 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000449 = GetQuestItme(UserWorldId, 1000000449, 1)  --kiem tra vat pham nhiem vu
              if bool1000000449 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000449,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<0 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,1000000449,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
        ...
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              local weiz1000000779=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000779,weiz1000000779,2) 
              --tang thuong
              local weiz1000000782=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000782,weiz1000000782,3) 
              --tang thuong
              local weiz1000000789=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000789,weiz1000000789,4) 
              --tang thuong
