...
function MissIon94(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<73 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000272 = GetQuestItme(UserWorldId, 900000272, 20)  --kiem tra vat pham nhiem vu
              if bool900000272 then --du yeu cau
              AddQuestItme(UserWorldId,900000272,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000272 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000273,1) --them vat pham cho nhiem vu khac
              --tang thuong
