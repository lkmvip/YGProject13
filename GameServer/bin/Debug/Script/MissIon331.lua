...
function MissIon331(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<121 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000615 = GetQuestItme(UserWorldId, 900000615, 5)  --kiem tra vat pham nhiem vu
              if bool900000615 then --du yeu cau
                  AddQuestItme(UserWorldId,900000615,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000615 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
