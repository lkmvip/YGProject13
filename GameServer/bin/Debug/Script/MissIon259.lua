...
function MissIon259(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<120 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000567 = GetQuestItme(UserWorldId, 900000567, 30)  --kiem tra vat pham nhiem vu
              if bool900000567 then --du yeu cau
                  AddQuestItme(UserWorldId,900000567,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000567 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 307 ) -- Y: ( 357 ) --
