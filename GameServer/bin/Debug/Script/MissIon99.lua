...
function MissIon99(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<76 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000285 = GetQuestItme(UserWorldId, 900000285, 10)  --kiem tra vat pham nhiem vu
              if bool900000285 then --du yeu cau
              AddQuestItme(UserWorldId,900000285,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000286,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,900000287,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              local  bool900000286 = GetQuestItme(UserWorldId, 900000286, 1)  --kiem tra vat pham nhiem vu
              local  bool900000287 = GetQuestItme(UserWorldId, 900000287, 1)  --kiem tra vat pham nhiem vu
              if bool900000286 then --du yeu cau
              if bool900000287 then --du yeu cau
                  AddQuestItme(UserWorldId,900000286,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000287,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000286,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,900000287,1) --them vat pham nhiem vu cho buoc tiep theo
...
-- ID VAT PHAM: ( 900000285 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 58 ) -- Y: ( 155 ) --
