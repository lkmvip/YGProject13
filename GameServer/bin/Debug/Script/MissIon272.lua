...
--Ten nhiem vu: (????? ???? 1) --- So buoc: (3)
function MissIon272(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<116 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 116 moi co the nhan nhiem vu !", 9, "He thong")
...
-- ID VAT PHAM: ( 900000580 ) -- SO LUONG: ( 20 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 25100 ) -- X: ( 128 ) -- Y: ( 43 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000582 ) -- SO LUONG: ( 20 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 25100 ) -- X: ( 450 ) -- Y: ( 283 ) --
 
              StatusQuest=2 
              AddQuest(UserWorldId,QuestId, StatusQuest) 
              SendMissionMsg(UserWorldId,QuestId, 11, StatusQuest)  --cho lam buoc tiep theo la 2
          elseif QuestLevel==2 then
              local  bool900000580 = GetQuestItme(UserWorldId, 900000580, 20)  --kiem tra vat pham nhiem vu
              local  bool900000582 = GetQuestItme(UserWorldId, 900000582, 20)  --kiem tra vat pham nhiem vu
              if bool900000580 then --du yeu cau
              if bool900000582 then --du yeu cau
                  AddQuestItme(UserWorldId,900000580,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000582,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000582 ) -- SO LUONG: ( 10 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000580 ) -- SO LUONG: ( 10 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000582 = GetQuestItme(UserWorldId, 900000582, 10)  --kiem tra vat pham nhiem vu
              local  bool900000580 = GetQuestItme(UserWorldId, 900000580, 10)  --kiem tra vat pham nhiem vu
              if bool900000582 then --du yeu cau
              if bool900000580 then --du yeu cau
                  AddQuestItme(UserWorldId,900000582,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000580,0) --xoa vat pham nhiem vu
