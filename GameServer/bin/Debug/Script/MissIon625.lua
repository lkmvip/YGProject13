...
function MissIon625(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz200204027=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,200204027,weiz200204027,1) 
        end 
