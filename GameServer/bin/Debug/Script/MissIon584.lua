...
function MissIon584(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<132 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 132 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000740 = GetQuestItme(UserWorldId, 900000740, 20)  --kiem tra vat pham nhiem vu
              if bool900000740 then --du yeu cau
                  AddQuestItme(UserWorldId,900000740,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000740 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 26000 ) -- X: ( 282 ) -- Y: ( 417 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000060=GetPackage(UserWorldId)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,600000000) 
        end 
