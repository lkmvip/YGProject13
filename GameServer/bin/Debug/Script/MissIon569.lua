...
function MissIon569(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<50 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000725 = GetQuestItme(UserWorldId, 900000725, 10)  --kiem tra vat pham nhiem vu
              if bool900000725 then --du yeu cau
                  AddQuestItme(UserWorldId,900000725,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000725 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 125 ) -- Y: ( 397 ) --
