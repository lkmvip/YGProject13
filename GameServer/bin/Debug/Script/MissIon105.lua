...
function MissIon105(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<79 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000320 = GetQuestItme(UserWorldId, 900000320, 20)  --kiem tra vat pham nhiem vu
              if bool900000320 then --du yeu cau
                  AddQuestItme(UserWorldId,900000320,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000320 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
