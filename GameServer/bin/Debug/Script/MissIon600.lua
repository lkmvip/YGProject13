...
function MissIon600(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool100204003 = GetQuestItme(UserWorldId, 100204003, 1)  --kiem tra vat pham nhiem vu
              if bool100204003 then --du yeu cau
                  AddQuestItme(UserWorldId,100204003,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<60 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,100204003,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz100204004=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,100204004,weiz100204004,1) 
        end 
