...
--Ten nhiem vu: (端午节活动任务) --- So buoc: (1)
function MissIon9397(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000393 = GetQuestItme(UserWorldId, 999000393, 15)  --kiem tra vat pham nhiem vu
              local  bool999000394 = GetQuestItme(UserWorldId, 999000394, 15)  --kiem tra vat pham nhiem vu
              local  bool999000395 = GetQuestItme(UserWorldId, 999000395, 15)  --kiem tra vat pham nhiem vu
              if bool999000393 then --du yeu cau
              if bool999000394 then --du yeu cau
              if bool999000395 then --du yeu cau
                  AddQuestItme(UserWorldId,999000393,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,999000394,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,999000395,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000393 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 999000394 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 999000395 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
