...
function MissIon504(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<7 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 7 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000671 = GetQuestItme(UserWorldId, 900000671, 5)  --kiem tra vat pham nhiem vu
              if bool900000671 then --du yeu cau
                  AddQuestItme(UserWorldId,900000671,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000671 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 186 ) -- Y: ( 80 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz100001=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,100001,weiz100001,1) 
                  AddExpToCharacter(UserWorldId,500) 
                  AddKiToCharacter(UserWorldId,200) 
        end 
