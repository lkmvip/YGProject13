...
--Ten nhiem vu: (全民欢喜度中秋) --- So buoc: (1)
function MissIon9820(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<25 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000055 = GetQuestItme(UserWorldId, 999000055, 15)  --kiem tra vat pham nhiem vu
              local  bool999000053 = GetQuestItme(UserWorldId, 999000053, 15)  --kiem tra vat pham nhiem vu
              local  bool999000142 = GetQuestItme(UserWorldId, 999000142, 15)  --kiem tra vat pham nhiem vu
              if bool999000055 then --du yeu cau
              if bool999000053 then --du yeu cau
              if bool999000142 then --du yeu cau
                  AddQuestItme(UserWorldId,999000055,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,999000053,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000055 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 999000053 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
