...
function MissIon254(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<130 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000561 = GetQuestItme(UserWorldId, 900000561, 20)  --kiem tra vat pham nhiem vu
              if bool900000561 then --du yeu cau
                  AddQuestItme(UserWorldId,900000561,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000561 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 254 ) -- Y: ( 67 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000590,1) --them vat pham cho nhiem vu khac
              --tang thuong
