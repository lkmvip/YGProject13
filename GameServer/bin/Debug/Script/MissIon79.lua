...
--Ten nhiem vu: (? ?? ?? ?? 4/5) --- So buoc: (1)
function MissIon79(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<80 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000244 = GetQuestItme(UserWorldId, 900000244, 10)  --kiem tra vat pham nhiem vu
              local  bool900000245 = GetQuestItme(UserWorldId, 900000245, 10)  --kiem tra vat pham nhiem vu
              if bool900000244 then --du yeu cau
              if bool900000245 then --du yeu cau
                  AddQuestItme(UserWorldId,900000244,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000245,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000244 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 489 ) -- Y: ( 431 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000245 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 488 ) -- Y: ( 431 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000246,1) --them vat pham cho nhiem vu khac
