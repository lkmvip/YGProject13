...
function MissIon171(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<107 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 107 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000495 = GetQuestItme(UserWorldId, 900000495, 10)  --kiem tra vat pham nhiem vu
              local  bool900000496 = GetQuestItme(UserWorldId, 900000496, 10)  --kiem tra vat pham nhiem vu
              if bool900000495 then --du yeu cau
              if bool900000496 then --du yeu cau
                  AddQuestItme(UserWorldId,900000495,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000496,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000495 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 74 ) -- Y: ( 89 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000496 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 62 ) -- Y: ( 86 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000023=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,130000000) 
        end 
