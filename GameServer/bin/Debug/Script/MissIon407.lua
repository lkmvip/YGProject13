...
function MissIon407(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<128 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000643 = GetQuestItme(UserWorldId, 900000643, 10)  --kiem tra vat pham nhiem vu
              if bool900000643 then --du yeu cau
                  AddQuestItme(UserWorldId,900000643,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000643 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 92 ) -- Y: ( 286 ) --
