...
function MissIon521(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<30 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 30 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000675 = GetQuestItme(UserWorldId, 900000675, 15)  --kiem tra vat pham nhiem vu
              if bool900000675 then --du yeu cau
                  AddQuestItme(UserWorldId,900000675,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000675 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 110 ) -- Y: ( 330 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000002=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,34000) 
        end 
