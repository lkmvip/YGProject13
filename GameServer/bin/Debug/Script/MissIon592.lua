...
function MissIon592(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<135 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 135 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000748 = GetQuestItme(UserWorldId, 900000748, 5)  --kiem tra vat pham nhiem vu
              if bool900000748 then --du yeu cau
                  AddQuestItme(UserWorldId,900000748,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000748 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 26000 ) -- X: ( 106 ) -- Y: ( 183 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000639=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000639,weiz1000000639,5) 
                  AddExpToCharacter(UserWorldId,900000000) 
        end 
