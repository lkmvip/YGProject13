...
--Ten nhiem vu: (达到目标!! 25级庆祝礼物) --- So buoc: (0)
function MissIon1211(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000106=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000106,weiz1008000106,1) 
              --tang thuong
