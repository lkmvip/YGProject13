...
function MissIon257(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<123 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000564 = GetQuestItme(UserWorldId, 900000564, 10)  --kiem tra vat pham nhiem vu
              if bool900000564 then --du yeu cau
              AddQuestItme(UserWorldId,900000564,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000564 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000564 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 326 ) -- Y: ( 441 ) --
