...
function MissIon426(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<100 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000768 = GetQuestItme(UserWorldId, 900000768, 1)  --kiem tra vat pham nhiem vu
              local  bool900000772 = GetQuestItme(UserWorldId, 900000772, 3)  --kiem tra vat pham nhiem vu
              if bool900000768 then --du yeu cau
              if bool900000772 then --du yeu cau
                  AddQuestItme(UserWorldId,900000768,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000772,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<100 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000768,1) --them vat pham nhiem vu cho buoc tiep theo
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000772 ) -- SO LUONG: ( 3 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
