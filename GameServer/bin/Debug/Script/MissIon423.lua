...
function MissIon423(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      if Player.Player_FLD_LEVEL<35 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              AddQuestItme(UserWorldId,900000666,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000667,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000667 = GetQuestItme(UserWorldId, 900000667, 1)  --kiem tra vat pham nhiem vu
              if bool900000667 then --du yeu cau
                  AddQuestItme(UserWorldId,900000667,0) --xoa vat pham nhiem vu
