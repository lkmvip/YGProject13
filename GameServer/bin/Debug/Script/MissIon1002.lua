...
--Ten nhiem vu: ((??15) ? ?? ?? ??) --- So buoc: (6)
function MissIon1002(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<15 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 15 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
                  AddQuestItme(UserWorldId,900000424,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
              AddQuest(UserWorldId,QuestId, StatusQuest) 
              SendMissionMsg(UserWorldId,QuestId, 11, StatusQuest)  --cho lam buoc tiep theo la 2
          elseif QuestLevel==2 then
              local  bool900000424 = GetQuestItme(UserWorldId, 900000424, 1)  --kiem tra vat pham nhiem vu
              if bool900000424 then --du yeu cau
                  AddQuestItme(UserWorldId,900000424,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000425 ) -- SO LUONG: ( 5 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 101 ) -- X: ( 119 ) -- Y: ( 258 ) --
          ...
          elseif QuestLevel==3 then
              local  bool900000425 = GetQuestItme(UserWorldId, 900000425, 5)  --kiem tra vat pham nhiem vu
              if bool900000425 then --du yeu cau
                  AddQuestItme(UserWorldId,900000425,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000426 ) -- SO LUONG: ( 5 ) -- BUOC: ( 4 ) --
-- BAN DO: ( 101 ) -- X: ( 149 ) -- Y: ( 161 ) --
          ...
          elseif QuestLevel==4 then
              local  bool900000426 = GetQuestItme(UserWorldId, 900000426, 5)  --kiem tra vat pham nhiem vu
              if bool900000426 then --du yeu cau
                  AddQuestItme(UserWorldId,900000426,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000425 ) -- SO LUONG: ( 5 ) -- BUOC: ( 5 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000426 ) -- SO LUONG: ( 5 ) -- BUOC: ( 5 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==5 then
              ...
              if bool900000426 then --du yeu cau
                  AddQuestItme(UserWorldId,900000425,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000426,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000427,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==6 then
              ...
              local  bool900000427 = GetQuestItme(UserWorldId, 900000427, 1)  --kiem tra vat pham nhiem vu
              if bool900000427 then --du yeu cau
                  AddQuestItme(UserWorldId,900000427,0) --xoa vat pham nhiem vu
