...
function MissIon90(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<71 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000262 = GetQuestItme(UserWorldId, 900000262, 20)  --kiem tra vat pham nhiem vu
              if bool900000262 then --du yeu cau
              AddQuestItme(UserWorldId,900000262,0) --xoa vat pham nhiem vu
              StatusQuest=2 
          ...
          elseif QuestLevel==3 then
                  AddQuestItme(UserWorldId,900000263,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==4 then
              ...
              local  bool900000263 = GetQuestItme(UserWorldId, 900000263, 1)  --kiem tra vat pham nhiem vu
              if bool900000263 then --du yeu cau
                  AddQuestItme(UserWorldId,900000263,0) --xoa vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000262 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 490 ) -- Y: ( 430 ) --
