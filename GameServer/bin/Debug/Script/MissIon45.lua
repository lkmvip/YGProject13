...
--Ten nhiem vu: (? ?? ?? ?? ио) --- So buoc: (2)
function MissIon45(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000098 = GetQuestItme(UserWorldId, 900000098, 10)  --kiem tra vat pham nhiem vu
              if bool900000098 then --du yeu cau
              AddQuestItme(UserWorldId,900000098,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000098 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 191 ) -- Y: ( 371 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,350000) 
