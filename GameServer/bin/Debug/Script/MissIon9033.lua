...
--Ten nhiem vu: (æ¸ªÍ ’ºØ¡Ó) --- So buoc: (1)
function MissIon9033(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000607 = GetQuestItme(UserWorldId, 999000607, 30)  --kiem tra vat pham nhiem vu
              if bool999000607 then --du yeu cau
                  AddQuestItme(UserWorldId,999000607,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000607 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
