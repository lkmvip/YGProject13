...
function MissIon533(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<48 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 48 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000687 = GetQuestItme(UserWorldId, 900000687, 1)  --kiem tra vat pham nhiem vu
              if bool900000687 then --du yeu cau
              AddQuestItme(UserWorldId,900000687,0) --xoa vat pham nhiem vu
              StatusQuest=2 
      ...
      if Player.Player_FLD_LEVEL<48 then  
         ...
         if QuestLevel==3 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000687,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
            AddQuest(UserWorldId,QuestId, StatusQuest)
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000004=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,670000) 
        end 
