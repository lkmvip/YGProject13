...
function MissIon132(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<93 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 93 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000397 = GetQuestItme(UserWorldId, 900000397, 60)  --kiem tra vat pham nhiem vu
              if bool900000397 then --du yeu cau
              AddQuestItme(UserWorldId,900000397,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000398 ) -- SO LUONG: ( 2 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 1301 ) -- X: ( 393 ) -- Y: ( 141 ) --
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000398 = GetQuestItme(UserWorldId, 900000398, 2)  --kiem tra vat pham nhiem vu
              if bool900000398 then --du yeu cau
                  AddQuestItme(UserWorldId,900000398,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000397 ) -- SO LUONG: ( 60 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1301 ) -- X: ( 393 ) -- Y: ( 141 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000001=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddKiToCharacter(UserWorldId,130000) 
        end 
