...
function MissIon330(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<119 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000614 = GetQuestItme(UserWorldId, 900000614, 5)  --kiem tra vat pham nhiem vu
              if bool900000614 then --du yeu cau
                  AddQuestItme(UserWorldId,900000614,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000614 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
