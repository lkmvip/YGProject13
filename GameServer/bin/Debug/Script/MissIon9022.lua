...
--Ten nhiem vu: (ÖÆ×÷ÜíÝïÔÂ±ý) --- So buoc: (1)
function MissIon9022(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000127 = GetQuestItme(UserWorldId, 1000000127, 5)  --kiem tra vat pham nhiem vu
              local  bool1000000131 = GetQuestItme(UserWorldId, 1000000131, 6)  --kiem tra vat pham nhiem vu
              if bool1000000127 then --du yeu cau
              if bool1000000131 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000127,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 1000000127 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000123=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000123,weiz1000000123,1) 
        end 
