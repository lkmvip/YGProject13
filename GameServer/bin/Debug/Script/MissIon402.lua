...
function MissIon402(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<123 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
                  AddQuestItme(UserWorldId,900000638,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000638 = GetQuestItme(UserWorldId, 900000638, 1)  --kiem tra vat pham nhiem vu
              if bool900000638 then --du yeu cau
                  AddQuestItme(UserWorldId,900000638,0) --xoa vat pham nhiem vu
