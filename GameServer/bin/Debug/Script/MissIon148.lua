...
function MissIon148(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<98 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 98 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000370 = GetQuestItme(UserWorldId, 900000370, 50)  --kiem tra vat pham nhiem vu
              if bool900000370 then --du yeu cau
                  AddQuestItme(UserWorldId,900000370,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000370 ) -- SO LUONG: ( 50 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 2201 ) -- X: ( 147 ) -- Y: ( 458 ) --
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000029=GetPackages(UserWorldId,1)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,60000000) 
              --tang thuong
