...
function MissIon86(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<67 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 67 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000300 = GetQuestItme(UserWorldId, 900000300, 20)  --kiem tra vat pham nhiem vu
              if bool900000300 then --du yeu cau
                  AddQuestItme(UserWorldId,900000300,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000300 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1301 ) -- X: ( 171 ) -- Y: ( 142 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,3100000) 
                  AddKiToCharacter(UserWorldId,20000) 
        end 
