...
function MissIon360(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<115 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 115 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000655 = GetQuestItme(UserWorldId, 1000000655, 1)  --kiem tra vat pham nhiem vu
              local  bool1000000656 = GetQuestItme(UserWorldId, 1000000656, 1)  --kiem tra vat pham nhiem vu
              local  bool1000000657 = GetQuestItme(UserWorldId, 1000000657, 1)  --kiem tra vat pham nhiem vu
              if bool1000000655 then --du yeu cau
              if bool1000000656 then --du yeu cau
              if bool1000000657 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000655,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,1000000656,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,1000000657,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<115 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,1000000655,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,1000000656,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,1000000657,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000654=GetPackage(UserWorldId)  --vi tri con trong
