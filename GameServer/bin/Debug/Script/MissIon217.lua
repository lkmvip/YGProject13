...
function MissIon217(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<0 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000447 = GetQuestItme(UserWorldId, 1000000447, 1)  --kiem tra vat pham nhiem vu
              if bool1000000447 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000447,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<0 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,1000000447,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000783=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000783,weiz1000000783,3) 
        end 
