...
function MissIon570(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<47 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 47 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000726 = GetQuestItme(UserWorldId, 900000726, 15)  --kiem tra vat pham nhiem vu
              if bool900000726 then --du yeu cau
                  AddQuestItme(UserWorldId,900000726,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000726 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 327 ) -- Y: ( 460 ) --
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000002=GetPackages(UserWorldId,3)  --vi tri con trong
              ...
              local weiz1000000030=GetPackage(UserWorldId)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,570000) 
