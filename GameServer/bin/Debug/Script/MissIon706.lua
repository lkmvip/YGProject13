...
function MissIon706(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<110 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool909000031 = GetQuestItme(UserWorldId, 909000031, 20)  --kiem tra vat pham nhiem vu
              if bool909000031 then --du yeu cau
                  AddQuestItme(UserWorldId,909000031,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 909000031 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
