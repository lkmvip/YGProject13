...
function MissIon605(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<130 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool100204008 = GetQuestItme(UserWorldId, 100204008, 1)  --kiem tra vat pham nhiem vu
              if bool100204008 then --du yeu cau
                  AddQuestItme(UserWorldId,100204008,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<130 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,100204008,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz100204009=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,100204009,weiz100204009,1) 
              --tang thuong
              local weiz1008001020=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008001020,weiz1008001020,4) 
        end 
