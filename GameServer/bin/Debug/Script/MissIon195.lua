...
function MissIon195(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<12 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 12 moi co the nhan nhiem vu !", 9, "He thong")
...
-- ID VAT PHAM: ( 900000415 ) -- SO LUONG: ( 4 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000415 = GetQuestItme(UserWorldId, 900000415, 4)  --kiem tra vat pham nhiem vu
              if bool900000415 then --du yeu cau
                  AddQuestItme(UserWorldId,900000415,0) --xoa vat pham nhiem vu
