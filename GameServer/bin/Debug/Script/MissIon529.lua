...
function MissIon529(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<41 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 41 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
                  AddQuestItme(UserWorldId,900000683,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000683 = GetQuestItme(UserWorldId, 900000683, 1)  --kiem tra vat pham nhiem vu
              if bool900000683 then --du yeu cau
                  AddQuestItme(UserWorldId,900000683,0) --xoa vat pham nhiem vu
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000006=GetPackage(UserWorldId)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,225000) 
        end 
