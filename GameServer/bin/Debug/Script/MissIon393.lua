...
function MissIon393(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<35 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000787 = GetQuestItme(UserWorldId, 900000787, 1)  --kiem tra vat pham nhiem vu
              if bool900000787 then --du yeu cau
                  AddQuestItme(UserWorldId,900000787,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<35 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000787,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,909000012,1) --them vat pham cho nhiem vu khac
              AddQuestItme(UserWorldId,909000019,1) --them vat pham cho nhiem vu khac
              AddQuestItme(UserWorldId,909000014,1) --them vat pham cho nhiem vu khac
        end 
