...
--Ten nhiem vu: (ÎäÑ«½±Àø»î¶¯(Ð°ÅÉ)) --- So buoc: (0)
function MissIon9908(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_Zx==1 then
          SendSysMsg(UserWorldId,"Chinh phai khong the nhan nhiem vu !", 9, "He thong")
