...
--Ten nhiem vu: ([GM] [????? 7? ??]) --- So buoc: (1)
function MissIon636(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<120 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool430203008 = GetQuestItme(UserWorldId, 430203008, 1)  --kiem tra vat pham nhiem vu
              local  bool900000762 = GetQuestItme(UserWorldId, 900000762, 3)  --kiem tra vat pham nhiem vu
              if bool430203008 then --du yeu cau
              if bool900000762 then --du yeu cau
                  AddQuestItme(UserWorldId,430203008,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<120 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,430203008,1) --them vat pham nhiem vu cho buoc tiep theo
