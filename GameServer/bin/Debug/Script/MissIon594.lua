...
function MissIon594(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<56 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000756 = GetQuestItme(UserWorldId, 900000756, 10)  --kiem tra vat pham nhiem vu
              if bool900000756 then --du yeu cau
              AddQuestItme(UserWorldId,900000756,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000757 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1001 ) -- X: ( 350 ) -- Y: ( 221 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000757 = GetQuestItme(UserWorldId, 900000757, 10)  --kiem tra vat pham nhiem vu
              if bool900000757 then --du yeu cau
                  AddQuestItme(UserWorldId,900000757,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000756 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 384 ) -- Y: ( 209 ) --
