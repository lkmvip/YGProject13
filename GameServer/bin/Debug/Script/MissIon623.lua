...
--Ten nhiem vu: ([????? 9? ??]) --- So buoc: (1)
function MissIon623(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<140 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool200204009 = GetQuestItme(UserWorldId, 200204009, 1)  --kiem tra vat pham nhiem vu
              ...
              if bool200204009 then --du yeu cau
              if bool900000762 then --du yeu cau
              if bool200204010 then --du yeu cau
                  AddQuestItme(UserWorldId,200204009,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<140 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,200204009,1) --them vat pham nhiem vu cho buoc tiep theo
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz200204026=GetPackage(UserWorldId)  --vi tri con trong
