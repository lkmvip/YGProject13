...
function MissIon580(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<147 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 147 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000736 = GetQuestItme(UserWorldId, 900000736, 20)  --kiem tra vat pham nhiem vu
              if bool900000736 then --du yeu cau
                  AddQuestItme(UserWorldId,900000736,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000736 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 26000 ) -- X: ( 64 ) -- Y: ( 389 ) --
