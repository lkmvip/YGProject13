...
function MissIon539(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<36 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000693 = GetQuestItme(UserWorldId, 900000693, 15)  --kiem tra vat pham nhiem vu
              if bool900000693 then --du yeu cau
                  AddQuestItme(UserWorldId,900000693,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000693 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 203 ) -- Y: ( 239 ) --
