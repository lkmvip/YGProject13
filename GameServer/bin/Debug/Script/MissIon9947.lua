...
--Ten nhiem vu: (打造玄天耳环) --- So buoc: (1)
function MissIon9947(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000161 = GetQuestItme(UserWorldId, 1000000161, 3)  --kiem tra vat pham nhiem vu
              local  bool1000000162 = GetQuestItme(UserWorldId, 1000000162, 3)  --kiem tra vat pham nhiem vu
              local  bool1000000163 = GetQuestItme(UserWorldId, 1000000163, 3)  --kiem tra vat pham nhiem vu
              local  bool1000000164 = GetQuestItme(UserWorldId, 1000000164, 3)  --kiem tra vat pham nhiem vu
              local  bool1000000199 = GetQuestItme(UserWorldId, 1000000199, 3)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 1000000161 ) -- SO LUONG: ( 3 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 339 ) -- Y: ( 100 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000162 ) -- SO LUONG: ( 3 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 339 ) -- Y: ( 101 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000163 ) -- SO LUONG: ( 3 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 338 ) -- Y: ( 101 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000164 ) -- SO LUONG: ( 3 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 338 ) -- Y: ( 101 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000199 ) -- SO LUONG: ( 3 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 338 ) -- Y: ( 101 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz6=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,6,weiz6,1) 
        end 
