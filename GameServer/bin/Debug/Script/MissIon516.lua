...
function MissIon516(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<22 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000676 = GetQuestItme(UserWorldId, 900000676, 10)  --kiem tra vat pham nhiem vu
              if bool900000676 then --du yeu cau
                  AddQuestItme(UserWorldId,900000676,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000676 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 201 ) -- Y: ( 332 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz2=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,2,weiz2,1) 
                  AddExpToCharacter(UserWorldId,7800) 
        end 
