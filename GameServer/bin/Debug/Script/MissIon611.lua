...
--Ten nhiem vu: ([????? 5? ??]) --- So buoc: (1)
function MissIon611(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<100 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool200204005 = GetQuestItme(UserWorldId, 200204005, 1)  --kiem tra vat pham nhiem vu
              local  bool900000762 = GetQuestItme(UserWorldId, 900000762, 1)  --kiem tra vat pham nhiem vu
              if bool200204005 then --du yeu cau
              if bool900000762 then --du yeu cau
                  AddQuestItme(UserWorldId,200204005,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<100 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,200204005,1) --them vat pham nhiem vu cho buoc tiep theo
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz200204006=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,200204006,weiz200204006,1) 
        end 
