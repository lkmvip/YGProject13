...
--Ten nhiem vu: (打造隔体传功) --- So buoc: (1)
function MissIon9961(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000161 = GetQuestItme(UserWorldId, 1000000161, 35)  --kiem tra vat pham nhiem vu
              local  bool1000000162 = GetQuestItme(UserWorldId, 1000000162, 35)  --kiem tra vat pham nhiem vu
              local  bool1000000163 = GetQuestItme(UserWorldId, 1000000163, 4)  --kiem tra vat pham nhiem vu
              local  bool1000000164 = GetQuestItme(UserWorldId, 1000000164, 35)  --kiem tra vat pham nhiem vu
              local  bool1000000199 = GetQuestItme(UserWorldId, 1000000199, 35)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 1000000161 ) -- SO LUONG: ( 35 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 338 ) -- Y: ( 101 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000162 ) -- SO LUONG: ( 35 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 338 ) -- Y: ( 101 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000163 ) -- SO LUONG: ( 4 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 338 ) -- Y: ( 101 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000164 ) -- SO LUONG: ( 35 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 338 ) -- Y: ( 101 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000199 ) -- SO LUONG: ( 35 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 338 ) -- Y: ( 101 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000130=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000130,weiz1008000130,1) 
        end 
