...
function MissIon146(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<97 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 97 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
                  AddQuestItme(UserWorldId,900000366,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
              AddQuest(UserWorldId,QuestId, StatusQuest) 
              SendMissionMsg(UserWorldId,QuestId, 11, StatusQuest)  --cho lam buoc tiep theo la 2
          elseif QuestLevel==2 then
              local  bool900000366 = GetQuestItme(UserWorldId, 900000366, 1)  --kiem tra vat pham nhiem vu
              if bool900000366 then --du yeu cau
                  AddQuestItme(UserWorldId,900000366,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000367 ) -- SO LUONG: ( 25 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 2201 ) -- X: ( 142 ) -- Y: ( 455 ) --
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000367 = GetQuestItme(UserWorldId, 900000367, 25)  --kiem tra vat pham nhiem vu
              if bool900000367 then --du yeu cau
                  AddQuestItme(UserWorldId,900000367,0) --xoa vat pham nhiem vu
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz1000000030=GetPackage(UserWorldId)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,56000000) 
        end 
