...
--Ten nhiem vu: (达到目标!! 30级庆祝礼物) --- So buoc: (0)
function MissIon1214(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000333=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000333,weiz1008000333,1) 
                 Addexporll(UserWorldId,9001214,10800000) 
        end 
