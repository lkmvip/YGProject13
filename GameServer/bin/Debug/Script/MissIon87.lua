...
function MissIon87(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<68 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 68 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000301 = GetQuestItme(UserWorldId, 900000301, 20)  --kiem tra vat pham nhiem vu
              if bool900000301 then --du yeu cau
                  AddQuestItme(UserWorldId,900000301,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000301 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1301 ) -- X: ( 79 ) -- Y: ( 306 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
                  ...
                  AddKiToCharacter(UserWorldId,25000) 
                  AddMoneyToCharacter(UserWorldId,1800000) 
                  SendSysMsg(UserWorldId,"Nhan duoc 1800000 tien vang!", 9, "He thong")
                  AddExpToCharacter(UserWorldId,3700000) 
        end 
