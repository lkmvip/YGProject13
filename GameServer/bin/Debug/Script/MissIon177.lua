...
function MissIon177(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<0 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000506 = GetQuestItme(UserWorldId, 900000506, 1)  --kiem tra vat pham nhiem vu
              if bool900000506 then --du yeu cau
              AddQuestItme(UserWorldId,900000506,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000507,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000507 = GetQuestItme(UserWorldId, 900000507, 1)  --kiem tra vat pham nhiem vu
              if bool900000507 then --du yeu cau
                  AddQuestItme(UserWorldId,900000507,0) --xoa vat pham nhiem vu
      ...
      if Player.Player_FLD_LEVEL<0 then  
         ...
         if QuestLevel==3 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000506,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
            AddQuest(UserWorldId,QuestId, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000618=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000618,weiz1000000618,1) 
        end 
