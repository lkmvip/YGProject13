...
--Ten nhiem vu: (È«ÐÂµÄÌ½Ë÷) --- So buoc: (0)
function MissIon9395(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000098=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000098,weiz1008000098,1) 
              --tang thuong
              local weiz1008000107=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000107,weiz1008000107,1) 
              --tang thuong
              local weiz1008000109=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000109,weiz1008000109,1) 
              --tang thuong
              local weiz1008000108=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000108,weiz1008000108,1) 
        end 
