...
--Ten nhiem vu: (打造侠客行囊(宝盒)) --- So buoc: (1)
function MissIon9303(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000131=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000131,weiz1008000131,1) 
        end 
