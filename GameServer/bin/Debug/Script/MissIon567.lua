...
function MissIon567(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<44 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000723 = GetQuestItme(UserWorldId, 900000723, 20)  --kiem tra vat pham nhiem vu
              if bool900000723 then --du yeu cau
                  AddQuestItme(UserWorldId,900000723,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000723 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 286 ) -- Y: ( 410 ) --
