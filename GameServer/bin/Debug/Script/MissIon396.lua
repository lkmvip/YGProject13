...
function MissIon396(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<35 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool909000017 = GetQuestItme(UserWorldId, 909000017, 50)  --kiem tra vat pham nhiem vu
              if bool909000017 then --du yeu cau
                  AddQuestItme(UserWorldId,909000017,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 909000017 ) -- SO LUONG: ( 50 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 298 ) -- Y: ( 35 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008001327=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008001327,weiz1008001327,1) 
        end 
