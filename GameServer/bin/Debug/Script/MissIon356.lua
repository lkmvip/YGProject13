...
function MissIon356(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<122 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000618 = GetQuestItme(UserWorldId, 900000618, 1)  --kiem tra vat pham nhiem vu
              if bool900000618 then --du yeu cau
                  AddQuestItme(UserWorldId,900000618,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<122 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000618,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
