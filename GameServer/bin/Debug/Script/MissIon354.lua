...
function MissIon354(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<122 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000626 = GetQuestItme(UserWorldId, 900000626, 1)  --kiem tra vat pham nhiem vu
              local  bool900000627 = GetQuestItme(UserWorldId, 900000627, 1)  --kiem tra vat pham nhiem vu
              if bool900000626 then --du yeu cau
              if bool900000627 then --du yeu cau
                  AddQuestItme(UserWorldId,900000626,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000627,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<122 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000626,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,900000627,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
