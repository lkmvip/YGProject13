...
function MissIon700(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool909000025 = GetQuestItme(UserWorldId, 909000025, 10)  --kiem tra vat pham nhiem vu
              if bool909000025 then --du yeu cau
                  AddQuestItme(UserWorldId,909000025,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 909000025 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,600000) 
        end 
