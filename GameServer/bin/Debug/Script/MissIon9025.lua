...
--Ten nhiem vu: (制作豆子月饼) --- So buoc: (1)
function MissIon9025(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000130 = GetQuestItme(UserWorldId, 1000000130, 5)  --kiem tra vat pham nhiem vu
              local  bool1000000131 = GetQuestItme(UserWorldId, 1000000131, 6)  --kiem tra vat pham nhiem vu
              if bool1000000130 then --du yeu cau
              if bool1000000131 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000130,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 1000000130 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000126=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000126,weiz1000000126,1) 
        end 
