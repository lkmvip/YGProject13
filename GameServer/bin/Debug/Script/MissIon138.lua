...
function MissIon138(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<91 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000354 = GetQuestItme(UserWorldId, 900000354, 20)  --kiem tra vat pham nhiem vu
              if bool900000354 then --du yeu cau
              AddQuestItme(UserWorldId,900000354,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000354 ) -- SO LUONG: ( 20 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1001 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==2 then
              ...
              if bool900000354 then --du yeu cau
                  AddQuestItme(UserWorldId,900000354,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000355,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000355 = GetQuestItme(UserWorldId, 900000355, 1)  --kiem tra vat pham nhiem vu
              if bool900000355 then --du yeu cau
                  AddQuestItme(UserWorldId,900000355,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000354 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 2201 ) -- X: ( 67 ) -- Y: ( 183 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz501010=GetPackage(UserWorldId)  --vi tri con trong
