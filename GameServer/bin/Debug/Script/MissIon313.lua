...
--Ten nhiem vu: (Che tao tra nhan sam (nhan vat nu)     ) --- So buoc: (3)
function MissIon313(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<0 then 
          ...
          elseif QuestLevel==2 then
                  AddQuestItme(UserWorldId,900000554,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000554 = GetQuestItme(UserWorldId, 900000554, 1)  --kiem tra vat pham nhiem vu
              if bool900000554 then --du yeu cau
                  AddQuestItme(UserWorldId,900000554,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000632=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000632,weiz1000000632,1) 
              --tang thuong
              local weiz1000000312=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000312,weiz1000000312,5) 
        end 
