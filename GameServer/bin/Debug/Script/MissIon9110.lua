...
--Ten nhiem vu: (¥Ú‘Ï—™∫ÏœÓ¡¥) --- So buoc: (1)
function MissIon9110(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool100015 = GetQuestItme(UserWorldId, 100015, 1)  --kiem tra vat pham nhiem vu
              local  bool1000000161 = GetQuestItme(UserWorldId, 1000000161, 30)  --kiem tra vat pham nhiem vu
              local  bool1000000162 = GetQuestItme(UserWorldId, 1000000162, 60)  --kiem tra vat pham nhiem vu
              local  bool1000000163 = GetQuestItme(UserWorldId, 1000000163, 60)  --kiem tra vat pham nhiem vu
              local  bool1000000164 = GetQuestItme(UserWorldId, 1000000164, 30)  --kiem tra vat pham nhiem vu
              local  bool1000000199 = GetQuestItme(UserWorldId, 1000000199, 60)  --kiem tra vat pham nhiem vu
              if bool100015 then --du yeu cau
              ...
              if bool1000000199 then --du yeu cau
                  AddQuestItme(UserWorldId,100015,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<1 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,100015,1) --them vat pham nhiem vu cho buoc tiep theo
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000161 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000162 ) -- SO LUONG: ( 60 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000163 ) -- SO LUONG: ( 60 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000164 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000199 ) -- SO LUONG: ( 60 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz100018=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,100018,weiz100018,1) 
        end 
