...
function MissIon156(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<79 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000468 = GetQuestItme(UserWorldId, 900000468, 10)  --kiem tra vat pham nhiem vu
              if bool900000468 then --du yeu cau
                  AddQuestItme(UserWorldId,900000468,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000468 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 219 ) -- Y: ( 441 ) --
