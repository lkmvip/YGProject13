...
function MissIon1103(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<45 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 45 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000752 = GetQuestItme(UserWorldId, 900000752, 10)  --kiem tra vat pham nhiem vu
              local  bool900000753 = GetQuestItme(UserWorldId, 900000753, 10)  --kiem tra vat pham nhiem vu
              if bool900000752 then --du yeu cau
              if bool900000753 then --du yeu cau
                  AddQuestItme(UserWorldId,900000752,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000753,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000752 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 337 ) -- Y: ( 459 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000753 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 161 ) -- Y: ( 95 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000451,1) --them vat pham cho nhiem vu khac
        end 
