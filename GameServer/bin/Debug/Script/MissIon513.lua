...
function MissIon513(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<18 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 18 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000657 = GetQuestItme(UserWorldId, 900000657, 1)  --kiem tra vat pham nhiem vu
              if bool900000657 then --du yeu cau
              AddQuestItme(UserWorldId,900000657,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000658,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              local  bool900000658 = GetQuestItme(UserWorldId, 900000658, 1)  --kiem tra vat pham nhiem vu
              if bool900000658 then --du yeu cau
                  AddQuestItme(UserWorldId,900000658,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000659,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000659 = GetQuestItme(UserWorldId, 900000659, 1)  --kiem tra vat pham nhiem vu
              if bool900000659 then --du yeu cau
                  AddQuestItme(UserWorldId,900000659,0) --xoa vat pham nhiem vu
      ...
      if Player.Player_FLD_LEVEL<18 then  
         ...
         if QuestLevel==4 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000657,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
            AddQuest(UserWorldId,QuestId, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000902=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000902,weiz1000000902,5) 
                  AddExpToCharacter(UserWorldId,3200) 
        end 
