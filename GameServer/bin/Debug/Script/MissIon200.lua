...
function MissIon200(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<0 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000135 = GetQuestItme(UserWorldId, 999000135, 1)  --kiem tra vat pham nhiem vu
              if bool999000135 then --du yeu cau
                  AddQuestItme(UserWorldId,999000135,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<0 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,999000135,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
        ...
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              local weiz1000000654=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000654,weiz1000000654,5) 
        end 
