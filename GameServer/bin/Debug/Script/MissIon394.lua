...
function MissIon394(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<35 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000787 = GetQuestItme(UserWorldId, 900000787, 3)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000787 ) -- SO LUONG: ( 3 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 7301 ) -- X: ( 0 ) -- Y: ( 0 ) --
