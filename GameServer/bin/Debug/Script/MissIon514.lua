...
function MissIon514(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<19 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 19 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000677 = GetQuestItme(UserWorldId, 900000677, 10)  --kiem tra vat pham nhiem vu
              if bool900000677 then --du yeu cau
                  AddQuestItme(UserWorldId,900000677,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000677 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 233 ) -- Y: ( 238 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000003=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,4200) 
        end 
