...
function MissIon359(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<122 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000622 = GetQuestItme(UserWorldId, 900000622, 10)  --kiem tra vat pham nhiem vu
              if bool900000622 then --du yeu cau
                  AddQuestItme(UserWorldId,900000622,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000622 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000618,1) --them vat pham cho nhiem vu khac
              AddQuestItme(UserWorldId,900000619,1) --them vat pham cho nhiem vu khac
        end 
