...
function MissIon104(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<79 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 79 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000319 = GetQuestItme(UserWorldId, 900000319, 20)  --kiem tra vat pham nhiem vu
              if bool900000319 then --du yeu cau
                  AddQuestItme(UserWorldId,900000319,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000319 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz9000104=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,9000104,weiz9000104,1) 
              --tang thuong
              local weiz1000000030=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000030,weiz1000000030,4) 
                  AddExpToCharacter(UserWorldId,11500000) 
        end 
