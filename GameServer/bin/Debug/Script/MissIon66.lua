...
function MissIon66(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<61 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 61 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000197 = GetQuestItme(UserWorldId, 900000197, 10)  --kiem tra vat pham nhiem vu
              local  bool900000198 = GetQuestItme(UserWorldId, 900000198, 5)  --kiem tra vat pham nhiem vu
              if bool900000197 then --du yeu cau
              if bool900000198 then --du yeu cau
              AddQuestItme(UserWorldId,900000197,0) --xoa vat pham nhiem vu
              AddQuestItme(UserWorldId,900000198,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000197 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 81 ) -- Y: ( 69 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000198 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 81 ) -- Y: ( 71 ) --
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000212,1) --them vat pham cho nhiem vu khac
                  AddMoneyToCharacter(UserWorldId,1200000) 
                  SendSysMsg(UserWorldId,"Nhan duoc 1200000 tien vang!", 9, "He thong")
              --tang thuong
              local weiz800000004=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,1700000) 
        end 
