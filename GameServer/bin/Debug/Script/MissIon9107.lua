...
--Ten nhiem vu: (Ñý»¨Çà²ÝµÄÃØÃÜ) --- So buoc: (1)
function MissIon9107(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000162 = GetQuestItme(UserWorldId, 1000000162, 1)  --kiem tra vat pham nhiem vu
              local  bool1000000163 = GetQuestItme(UserWorldId, 1000000163, 1)  --kiem tra vat pham nhiem vu
              local  bool1000000164 = GetQuestItme(UserWorldId, 1000000164, 1)  --kiem tra vat pham nhiem vu
              local  bool1000000199 = GetQuestItme(UserWorldId, 1000000199, 1)  --kiem tra vat pham nhiem vu
              local  bool1000000161 = GetQuestItme(UserWorldId, 1000000161, 1)  --kiem tra vat pham nhiem vu
      ...
      if Player.Player_FLD_LEVEL<200 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,1000000162,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,1000000163,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,1000000164,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,1000000199,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,1000000161,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000240=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000240,weiz1008000240,1) 
        end 
