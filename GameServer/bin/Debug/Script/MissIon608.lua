...
function MissIon608(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<35 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool200204002 = GetQuestItme(UserWorldId, 200204002, 1)  --kiem tra vat pham nhiem vu
              if bool200204002 then --du yeu cau
                  AddQuestItme(UserWorldId,200204002,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<35 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,200204002,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz200204003=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,200204003,weiz200204003,1) 
        end 
