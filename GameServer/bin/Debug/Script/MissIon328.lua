...
function MissIon328(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<117 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 117 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000613 = GetQuestItme(UserWorldId, 900000613, 10)  --kiem tra vat pham nhiem vu
              if bool900000613 then --du yeu cau
                  AddQuestItme(UserWorldId,900000613,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000613 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 132 ) -- Y: ( 33 ) --
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000427=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000427,weiz1008000427,1) 
              --tang thuong
              local weiz1008000428=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000428,weiz1008000428,1) 
              --tang thuong
              local weiz1008000429=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000429,weiz1008000429,1) 
              --tang thuong
              local weiz1008000430=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000430,weiz1008000430,1) 
        end 
