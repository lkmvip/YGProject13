...
--Ten nhiem vu: (Thu hoi hu phe 1 (115)  ) --- So buoc: (1)
function MissIon250(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<115 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000556 = GetQuestItme(UserWorldId, 900000556, 10)  --kiem tra vat pham nhiem vu
              if bool900000556 then --du yeu cau
                  AddQuestItme(UserWorldId,900000556,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000556 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 130 ) -- Y: ( 41 ) --
