...
--Ten nhiem vu: (±¶œ‰÷–µƒ–“‘À–«) --- So buoc: (1)
function MissIon9308(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000480=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000480,weiz1000000480,1) 
        end 
