...
function MissIon366(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000600 = GetQuestItme(UserWorldId, 900000600, 30)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000600 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 801 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000530=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000530,weiz1000000530,1) 
        end 
