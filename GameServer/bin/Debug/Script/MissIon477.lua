...
--Ten nhiem vu: ([GM] [??? 2? ??] ??? ????) --- So buoc: (2)
function MissIon477(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<35 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000666 = GetQuestItme(UserWorldId, 900000666, 10)  --kiem tra vat pham nhiem vu
              if bool900000666 then --du yeu cau
              AddQuestItme(UserWorldId,900000666,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000665,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000665 = GetQuestItme(UserWorldId, 900000665, 1)  --kiem tra vat pham nhiem vu
              if bool900000665 then --du yeu cau
                  AddQuestItme(UserWorldId,900000665,0) --xoa vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000666 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 420 ) -- Y: ( 345 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,909100001,85091) --them vat pham cho nhiem vu khac
        end 
