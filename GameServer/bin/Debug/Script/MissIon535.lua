...
function MissIon535(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<54 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000689 = GetQuestItme(UserWorldId, 900000689, 1)  --kiem tra vat pham nhiem vu
              if bool900000689 then --du yeu cau
              AddQuestItme(UserWorldId,900000689,0) --xoa vat pham nhiem vu
              StatusQuest=2 
      ...
      if Player.Player_FLD_LEVEL<54 then  
         ...
         if QuestLevel==3 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000689,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
            AddQuest(UserWorldId,QuestId, StatusQuest)
