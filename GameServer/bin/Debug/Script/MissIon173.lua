...
function MissIon173(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<111 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 111 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000500 = GetQuestItme(UserWorldId, 900000500, 100)  --kiem tra vat pham nhiem vu
              if bool900000500 then --du yeu cau
              AddQuestItme(UserWorldId,900000500,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000501 ) -- SO LUONG: ( 100 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 5001 ) -- X: ( 71 ) -- Y: ( 163 ) --
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000501 = GetQuestItme(UserWorldId, 900000501, 100)  --kiem tra vat pham nhiem vu
              if bool900000501 then --du yeu cau
                  AddQuestItme(UserWorldId,900000501,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000500 ) -- SO LUONG: ( 100 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 72 ) -- Y: ( 161 ) --
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000029=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,170000000) 
              --tang thuong
