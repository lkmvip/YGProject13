...
--Ten nhiem vu: (Ê¥µ®×£¸£) --- So buoc: (1)
function MissIon8032(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<30 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000656 = GetQuestItme(UserWorldId, 999000656, 10)  --kiem tra vat pham nhiem vu
              if bool999000656 then --du yeu cau
                  AddQuestItme(UserWorldId,999000656,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000656 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
