...
function MissIon547(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<47 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000701 = GetQuestItme(UserWorldId, 900000701, 15)  --kiem tra vat pham nhiem vu
              if bool900000701 then --du yeu cau
                  AddQuestItme(UserWorldId,900000701,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000701 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 59 ) -- Y: ( 81 ) --
