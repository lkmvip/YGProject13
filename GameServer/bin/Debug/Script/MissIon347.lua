...
--Ten nhiem vu: (获取粗造的虎皮) --- So buoc: (1)
function MissIon347(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<120 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000772 = GetQuestItme(UserWorldId, 1000000772, 6)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 1000000772 ) -- SO LUONG: ( 6 ) -- BUOC: ( 1 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000786=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000786,weiz1000000786,1) 
        end 
