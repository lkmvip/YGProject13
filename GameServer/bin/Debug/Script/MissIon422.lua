...
function MissIon422(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<35 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000664 = GetQuestItme(UserWorldId, 900000664, 10)  --kiem tra vat pham nhiem vu
              if bool900000664 then --du yeu cau
              AddQuestItme(UserWorldId,900000664,0) --xoa vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000664 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 85 ) -- Y: ( 333 ) --
