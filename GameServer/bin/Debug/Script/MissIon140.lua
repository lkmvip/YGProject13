...
function MissIon140(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<92 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000358 = GetQuestItme(UserWorldId, 900000358, 30)  --kiem tra vat pham nhiem vu
              if bool900000358 then --du yeu cau
              AddQuestItme(UserWorldId,900000358,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000358 ) -- SO LUONG: ( 30 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1001 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==2 then
              ...
              if bool900000358 then --du yeu cau
                  AddQuestItme(UserWorldId,900000358,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000359,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000359 = GetQuestItme(UserWorldId, 900000359, 1)  --kiem tra vat pham nhiem vu
              if bool900000359 then --du yeu cau
                  AddQuestItme(UserWorldId,900000359,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000358 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 2201 ) -- X: ( 448 ) -- Y: ( 59 ) --
