...
--Ten nhiem vu: ([高手] 变更的玩偶) --- So buoc: (1)
function MissIon1201(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<22 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 22 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000173 = GetQuestItme(UserWorldId, 999000173, 10)  --kiem tra vat pham nhiem vu
              if bool999000173 then --du yeu cau
                  AddQuestItme(UserWorldId,999000173,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000173 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 95 ) -- Y: ( 443 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz700019=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,700019,weiz700019,1) 
                  AddExpToCharacter(UserWorldId,7000) 
        end 
