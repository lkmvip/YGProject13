...
--Ten nhiem vu: (????? ??(??? 10?)) --- So buoc: (1)
function MissIon20(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<0 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000905 = GetQuestItme(UserWorldId, 1000000905, 10)  --kiem tra vat pham nhiem vu
              if bool1000000905 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000905,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 1000000905 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000426=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000426,weiz1000000426,10) 
        end 
