...
--Ten nhiem vu: (? ?? ?? ?? 2/5) --- So buoc: (2)
function MissIon75(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000236 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1001 ) -- X: ( 489 ) -- Y: ( 432 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000236 = GetQuestItme(UserWorldId, 900000236, 10)  --kiem tra vat pham nhiem vu
              if bool900000236 then --du yeu cau
                  AddQuestItme(UserWorldId,900000236,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000237,1) --them vat pham cho nhiem vu khac
