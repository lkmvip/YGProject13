...
function MissIon627(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008001512=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008001512,weiz1008001512,1) 
        end 
