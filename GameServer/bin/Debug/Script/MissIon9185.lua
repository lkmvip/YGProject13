...
--Ten nhiem vu: (我的急速激情(男)) --- So buoc: (1)
function MissIon9185(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool16900136 = GetQuestItme(UserWorldId, 16900136, 1)  --kiem tra vat pham nhiem vu
              ...
              if bool16900136 then --du yeu cau
              ...
              if bool1000000199 then --du yeu cau
                  AddQuestItme(UserWorldId,16900136,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<1 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,16900136,1) --them vat pham nhiem vu cho buoc tiep theo
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz16900311=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,16900311,weiz16900311,1) 
        end 
