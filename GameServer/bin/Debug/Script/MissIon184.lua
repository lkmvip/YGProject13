...
--Ten nhiem vu: (?? ?? ??? ??(??-5)) --- So buoc: (5)
function MissIon184(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<100 then 
          ...
          elseif QuestLevel==2 then
                  AddQuestItme(UserWorldId,900000525,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              local  bool900000525 = GetQuestItme(UserWorldId, 900000525, 1)  --kiem tra vat pham nhiem vu
              if bool900000525 then --du yeu cau
                  AddQuestItme(UserWorldId,900000525,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000525,1) --them vat pham nhiem vu cho buoc tiep theo
