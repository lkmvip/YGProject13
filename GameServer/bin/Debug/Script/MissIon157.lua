...
function MissIon157(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<81 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000469 = GetQuestItme(UserWorldId, 900000469, 10)  --kiem tra vat pham nhiem vu
              if bool900000469 then --du yeu cau
                  AddQuestItme(UserWorldId,900000469,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000469 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 119 ) -- Y: ( 416 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000024=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddKiToCharacter(UserWorldId,45000) 
        end 
