...
function MissIon126(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<86 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 86 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
                  AddQuestItme(UserWorldId,900000385,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
              AddQuest(UserWorldId,QuestId, StatusQuest) 
              SendMissionMsg(UserWorldId,QuestId, 11, StatusQuest)  --cho lam buoc tiep theo la 2
          elseif QuestLevel==2 then
              local  bool900000385 = GetQuestItme(UserWorldId, 900000385, 1)  --kiem tra vat pham nhiem vu
              if bool900000385 then --du yeu cau
                  AddQuestItme(UserWorldId,900000385,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000386,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              local  bool900000386 = GetQuestItme(UserWorldId, 900000386, 1)  --kiem tra vat pham nhiem vu
              if bool900000386 then --du yeu cau
                  AddQuestItme(UserWorldId,900000386,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000387,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==4 then
              local  bool900000387 = GetQuestItme(UserWorldId, 900000387, 1)  --kiem tra vat pham nhiem vu
              if bool900000387 then --du yeu cau
                  AddQuestItme(UserWorldId,900000387,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000388,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==5 then
              ...
              local  bool900000388 = GetQuestItme(UserWorldId, 900000388, 1)  --kiem tra vat pham nhiem vu
              if bool900000388 then --du yeu cau
                  AddQuestItme(UserWorldId,900000388,0) --xoa vat pham nhiem vu
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz1008000263=GetPackage(UserWorldId)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,21500000) 
        end 
