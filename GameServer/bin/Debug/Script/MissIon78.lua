...
--Ten nhiem vu: (? ?? ?? ?? 3/5) --- So buoc: (6)
function MissIon78(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000242 ) -- SO LUONG: ( 50 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==2 then
              local  bool900000242 = GetQuestItme(UserWorldId, 900000242, 50)  --kiem tra vat pham nhiem vu
              if bool900000242 then --du yeu cau
                  AddQuestItme(UserWorldId,900000242,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000242 ) -- SO LUONG: ( 50 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 201 ) -- X: ( 0 ) -- Y: ( 0 ) --
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000242 ) -- SO LUONG: ( 10 ) -- BUOC: ( 5 ) --
-- BAN DO: ( 201 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==5 then
              local  bool900000242 = GetQuestItme(UserWorldId, 900000242, 10)  --kiem tra vat pham nhiem vu
              if bool900000242 then --du yeu cau
                  AddQuestItme(UserWorldId,900000242,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000242 ) -- SO LUONG: ( 100 ) -- BUOC: ( 6 ) --
-- BAN DO: ( 1101 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==6 then
              ...
              local  bool900000242 = GetQuestItme(UserWorldId, 900000242, 100)  --kiem tra vat pham nhiem vu
              if bool900000242 then --du yeu cau
                  AddQuestItme(UserWorldId,900000242,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000243,1) --them vat pham cho nhiem vu khac
