...
function MissIon590(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<143 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 143 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          elseif QuestLevel==2 then
                  AddQuestItme(UserWorldId,900000746,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000746 = GetQuestItme(UserWorldId, 900000746, 1)  --kiem tra vat pham nhiem vu
              if bool900000746 then --du yeu cau
                  AddQuestItme(UserWorldId,900000746,0) --xoa vat pham nhiem vu
