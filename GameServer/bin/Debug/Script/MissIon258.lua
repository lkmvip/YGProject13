...
function MissIon258(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<121 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000565 = GetQuestItme(UserWorldId, 900000565, 20)  --kiem tra vat pham nhiem vu
              if bool900000565 then --du yeu cau
              AddQuestItme(UserWorldId,900000565,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000565 ) -- SO LUONG: ( 20 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==2 then
              ...
              if bool900000565 then --du yeu cau
                  AddQuestItme(UserWorldId,900000565,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000566,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000566 = GetQuestItme(UserWorldId, 900000566, 1)  --kiem tra vat pham nhiem vu
              if bool900000566 then --du yeu cau
                  AddQuestItme(UserWorldId,900000566,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000565 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 253 ) -- Y: ( 440 ) --
