...
--Ten nhiem vu: (Ä§Ãð½äÖ¸¶Ò»»ÈÎÎñ) --- So buoc: (1)
function MissIon8090(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000742 = GetQuestItme(UserWorldId, 999000742, 300)  --kiem tra vat pham nhiem vu
              if bool999000742 then --du yeu cau
                  AddQuestItme(UserWorldId,999000742,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 999000742 ) -- SO LUONG: ( 300 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000007=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000007,weiz1000007,1) 
        end 
