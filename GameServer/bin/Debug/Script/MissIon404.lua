...
function MissIon404(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<125 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000640 = GetQuestItme(UserWorldId, 900000640, 30)  --kiem tra vat pham nhiem vu
              if bool900000640 then --du yeu cau
                  AddQuestItme(UserWorldId,900000640,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000640 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 305 ) -- Y: ( 357 ) --
