...
function MissIon542(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<46 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000696 = GetQuestItme(UserWorldId, 900000696, 20)  --kiem tra vat pham nhiem vu
              if bool900000696 then --du yeu cau
                  AddQuestItme(UserWorldId,900000696,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000696 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 103 ) -- Y: ( 98 ) --
