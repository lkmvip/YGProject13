...
function MissIon543(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<42 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 42 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000697 = GetQuestItme(UserWorldId, 900000697, 1)  --kiem tra vat pham nhiem vu
              if bool900000697 then --du yeu cau
                  AddQuestItme(UserWorldId,900000697,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<42 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000697,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000001=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,260000) 
        end 
