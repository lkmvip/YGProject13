...
--Ten nhiem vu: (八卦老人的嘱托 25-50级领取) --- So buoc: (1)
function MissIon9803(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<25 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 25 moi co the nhan nhiem vu !", 9, "He thong")
