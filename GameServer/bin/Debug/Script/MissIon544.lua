...
function MissIon544(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<43 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000698 = GetQuestItme(UserWorldId, 900000698, 5)  --kiem tra vat pham nhiem vu
              if bool900000698 then --du yeu cau
                  AddQuestItme(UserWorldId,900000698,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000698 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 415 ) -- Y: ( 77 ) --
