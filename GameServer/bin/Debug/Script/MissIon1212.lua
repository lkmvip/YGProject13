...
--Ten nhiem vu: (达到目标!! 26级庆祝礼物) --- So buoc: (0)
function MissIon1212(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000033=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000033,weiz1008000033,1) 
              --tang thuong
