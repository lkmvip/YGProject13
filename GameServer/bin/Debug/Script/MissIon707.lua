...
function MissIon707(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<120 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool909000032 = GetQuestItme(UserWorldId, 909000032, 20)  --kiem tra vat pham nhiem vu
              if bool909000032 then --du yeu cau
                  AddQuestItme(UserWorldId,909000032,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 909000032 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 352 ) -- Y: ( 129 ) --
