...
--Ten nhiem vu: (Ä§Ãð¶ú»·¶Ò»»ÈÎÎñ) --- So buoc: (1)
function MissIon8088(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000005=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000005,weiz1000005,1) 
        end 
