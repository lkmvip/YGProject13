...
function MissIon334(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<118 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000611 = GetQuestItme(UserWorldId, 900000611, 3)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000611 ) -- SO LUONG: ( 3 ) -- BUOC: ( 1 ) --
