...
function MissIon367(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000635 = GetQuestItme(UserWorldId, 900000635, 10)  --kiem tra vat pham nhiem vu
              if bool900000635 then --du yeu cau
                  AddQuestItme(UserWorldId,900000635,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000635 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 4001 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000531=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000531,weiz1000000531,1) 
              --tang thuong
              local weiz1000000535=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000535,weiz1000000535,1) 
        end 
