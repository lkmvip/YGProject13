...
function MissIon93(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<72 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000269 = GetQuestItme(UserWorldId, 900000269, 10)  --kiem tra vat pham nhiem vu
              local  bool900000270 = GetQuestItme(UserWorldId, 900000270, 5)  --kiem tra vat pham nhiem vu
              if bool900000269 then --du yeu cau
              if bool900000270 then --du yeu cau
                  AddQuestItme(UserWorldId,900000269,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000270,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000269 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 60 ) -- Y: ( 155 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000270 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000271,1) --them vat pham cho nhiem vu khac
              --tang thuong
