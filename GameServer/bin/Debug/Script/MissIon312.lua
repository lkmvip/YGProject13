...
--Ten nhiem vu: (Che tao xu ly ca tuoi (nhan vat nam)      ) --- So buoc: (3)
function MissIon312(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000555 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1301 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==2 then
              local  bool900000555 = GetQuestItme(UserWorldId, 900000555, 10)  --kiem tra vat pham nhiem vu
              if bool900000555 then --du yeu cau
                  AddQuestItme(UserWorldId,900000555,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000553 ) -- SO LUONG: ( 10 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000553 = GetQuestItme(UserWorldId, 900000553, 10)  --kiem tra vat pham nhiem vu
              if bool900000553 then --du yeu cau
                  AddQuestItme(UserWorldId,900000553,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000631=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000631,weiz1000000631,1) 
        end 
