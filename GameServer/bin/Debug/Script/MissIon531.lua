...
function MissIon531(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<44 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000685 = GetQuestItme(UserWorldId, 900000685, 10)  --kiem tra vat pham nhiem vu
              if bool900000685 then --du yeu cau
                  AddQuestItme(UserWorldId,900000685,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000685 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 142 ) -- Y: ( 152 ) --
