...
--Ten nhiem vu: (???? ?? 2) --- So buoc: (5)
function MissIon125(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<85 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 85 moi co the nhan nhiem vu !", 9, "He thong")
...
-- ID VAT PHAM: ( 900000390 ) -- SO LUONG: ( 40 ) -- BUOC: ( 4 ) --
-- BAN DO: ( 1101 ) -- X: ( 60 ) -- Y: ( 155 ) --
          ...
          elseif QuestLevel==4 then
              local  bool900000390 = GetQuestItme(UserWorldId, 900000390, 40)  --kiem tra vat pham nhiem vu
              if bool900000390 then --du yeu cau
                  AddQuestItme(UserWorldId,900000390,0) --xoa vat pham nhiem vu
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz1000000030=GetPackage(UserWorldId)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,19500000) 
        end 
