...
function MissIon509(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<14 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 14 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000670 = GetQuestItme(UserWorldId, 900000670, 10)  --kiem tra vat pham nhiem vu
              if bool900000670 then --du yeu cau
                  AddQuestItme(UserWorldId,900000670,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000670 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 91 ) -- Y: ( 70 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000102=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000102,weiz1000000102,50) 
                  AddExpToCharacter(UserWorldId,1200) 
        end 
