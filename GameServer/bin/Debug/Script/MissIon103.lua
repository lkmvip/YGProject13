...
--Ten nhiem vu: (???? ????? 2) --- So buoc: (4)
function MissIon103(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<78 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 78 moi co the nhan nhiem vu !", 9, "He thong")
...
-- ID VAT PHAM: ( 900000315 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1101 ) -- X: ( 59 ) -- Y: ( 155 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000316 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1101 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==2 then
              local  bool900000315 = GetQuestItme(UserWorldId, 900000315, 10)  --kiem tra vat pham nhiem vu
              local  bool900000316 = GetQuestItme(UserWorldId, 900000316, 10)  --kiem tra vat pham nhiem vu
              if bool900000315 then --du yeu cau
              if bool900000316 then --du yeu cau
                  AddQuestItme(UserWorldId,900000315,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000316,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000317,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              local  bool900000317 = GetQuestItme(UserWorldId, 900000317, 1)  --kiem tra vat pham nhiem vu
              if bool900000317 then --du yeu cau
                  AddQuestItme(UserWorldId,900000317,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000318,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==4 then
              ...
              local  bool900000318 = GetQuestItme(UserWorldId, 900000318, 1)  --kiem tra vat pham nhiem vu
              if bool900000318 then --du yeu cau
                  AddQuestItme(UserWorldId,900000318,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,10500000) 
              --tang thuong
