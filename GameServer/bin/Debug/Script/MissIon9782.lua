...
--Ten nhiem vu: (ÔªÏü½Ú½±Àø¶Ò»») --- So buoc: (1)
function MissIon9782(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1008000405 = GetQuestItme(UserWorldId, 1008000405, 1)  --kiem tra vat pham nhiem vu
              if bool1008000405 then --du yeu cau
                  AddQuestItme(UserWorldId,1008000405,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<200 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,1008000405,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
