...
function MissIon101(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000309 ) -- SO LUONG: ( 5 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1101 ) -- X: ( 59 ) -- Y: ( 155 ) --
          ...
          elseif QuestLevel==2 then
              local  bool900000309 = GetQuestItme(UserWorldId, 900000309, 5)  --kiem tra vat pham nhiem vu
              if bool900000309 then --du yeu cau
                  AddQuestItme(UserWorldId,900000309,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000310 ) -- SO LUONG: ( 10 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 1101 ) -- X: ( 59 ) -- Y: ( 156 ) --
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000310 = GetQuestItme(UserWorldId, 900000310, 10)  --kiem tra vat pham nhiem vu
              if bool900000310 then --du yeu cau
                  AddQuestItme(UserWorldId,900000310,0) --xoa vat pham nhiem vu
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,9600000) 
              --tang thuong
              local weiz1008000262=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000262,weiz1008000262,1) 
        end 
