...
function MissIon433(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<125 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000784 = GetQuestItme(UserWorldId, 900000784, 1)  --kiem tra vat pham nhiem vu
              if bool900000784 then --du yeu cau
              AddQuestItme(UserWorldId,900000784,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000776 ) -- SO LUONG: ( 40 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 25100 ) -- X: ( 332 ) -- Y: ( 421 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000776 = GetQuestItme(UserWorldId, 900000776, 40)  --kiem tra vat pham nhiem vu
              if bool900000776 then --du yeu cau
                  AddQuestItme(UserWorldId,900000776,0) --xoa vat pham nhiem vu
      ...
      if Player.Player_FLD_LEVEL<125 then  
         ...
         if QuestLevel==3 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000784,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
            AddQuest(UserWorldId,QuestId, StatusQuest)
