...
function MissIon161(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<89 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 89 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000476 = GetQuestItme(UserWorldId, 900000476, 30)  --kiem tra vat pham nhiem vu
              if bool900000476 then --du yeu cau
              AddQuestItme(UserWorldId,900000476,0) --xoa vat pham nhiem vu
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
                  AddQuestItme(UserWorldId,900000477,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              ...
              local  bool900000477 = GetQuestItme(UserWorldId, 900000477, 1)  --kiem tra vat pham nhiem vu
              if bool900000477 then --du yeu cau
                  AddQuestItme(UserWorldId,900000477,0) --xoa vat pham nhiem vu
...
-- ID VAT PHAM: ( 900000476 ) -- SO LUONG: ( 30 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 333 ) -- Y: ( 247 ) --
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000029=GetPackages(UserWorldId,1)  --vi tri con trong
                  ...
                  AddKiToCharacter(UserWorldId,80000) 
              --tang thuong
