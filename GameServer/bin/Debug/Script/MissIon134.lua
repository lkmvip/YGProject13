...
function MissIon134(UserWorldId,QuestId, StepQuest, StatusQuest)
...
-- ID VAT PHAM: ( 900000348 ) -- SO LUONG: ( 20 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 1001 ) -- X: ( 489 ) -- Y: ( 431 ) --
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000348 = GetQuestItme(UserWorldId, 900000348, 20)  --kiem tra vat pham nhiem vu
              if bool900000348 then --du yeu cau
                  AddQuestItme(UserWorldId,900000348,0) --xoa vat pham nhiem vu
