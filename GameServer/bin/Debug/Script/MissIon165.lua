...
function MissIon165(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<97 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000487 = GetQuestItme(UserWorldId, 900000487, 20)  --kiem tra vat pham nhiem vu
              if bool900000487 then --du yeu cau
                  AddQuestItme(UserWorldId,900000487,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000487 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 184 ) -- Y: ( 197 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz9001211=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,9001211,weiz9001211,1) 
                  AddKiToCharacter(UserWorldId,180000) 
        end 
