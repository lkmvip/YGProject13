...
--Ten nhiem vu: (Œ‰¡÷’‰±¶ªÿ¿°(“ª∞„)) --- So buoc: (1)
function MissIon9030(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool890000001 = GetQuestItme(UserWorldId, 890000001, 5)  --kiem tra vat pham nhiem vu
              if bool890000001 then --du yeu cau
                  AddQuestItme(UserWorldId,890000001,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 890000001 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000893=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000893,weiz1008000893,1) 
        end 
