...
--Ten nhiem vu: (¶Ô´ºÁª ËÍºÃÀñ£¡) --- So buoc: (1)
function MissIon9253(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<10 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000437 = GetQuestItme(UserWorldId, 999000437, 1)  --kiem tra vat pham nhiem vu
              local  bool999000438 = GetQuestItme(UserWorldId, 999000438, 1)  --kiem tra vat pham nhiem vu
              if bool999000437 then --du yeu cau
              if bool999000438 then --du yeu cau
                  AddQuestItme(UserWorldId,999000437,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,999000438,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<10 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,999000437,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,999000438,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
