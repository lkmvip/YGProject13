...
function MissIon534(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<51 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000688 = GetQuestItme(UserWorldId, 900000688, 20)  --kiem tra vat pham nhiem vu
              if bool900000688 then --du yeu cau
                  AddQuestItme(UserWorldId,900000688,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000688 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 369 ) -- Y: ( 415 ) --
        ...
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000006=GetPackage(UserWorldId)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,1020000) 
        end 
