...
function MissIon406(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<127 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
                  AddQuestItme(UserWorldId,900000642,1) --them vat pham nhiem vu cho buoc tiep theo
              StatusQuest=2 
          ...
          elseif QuestLevel==2 then
              ...
              local  bool900000642 = GetQuestItme(UserWorldId, 900000642, 1)  --kiem tra vat pham nhiem vu
              if bool900000642 then --du yeu cau
                  AddQuestItme(UserWorldId,900000642,0) --xoa vat pham nhiem vu
