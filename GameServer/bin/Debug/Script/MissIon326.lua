...
function MissIon326(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000301=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000301,weiz1008000301,1) 
