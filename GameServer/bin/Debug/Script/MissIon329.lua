...
function MissIon329(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<117 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000621 = GetQuestItme(UserWorldId, 900000621, 10)  --kiem tra vat pham nhiem vu
              if bool900000621 then --du yeu cau
                  AddQuestItme(UserWorldId,900000621,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000621 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
      ...
      local controng=GetPackages(UserWorldId,4)  --vi tri con trong
        if controng.Count < 4 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008000431=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000431,weiz1008000431,1) 
              --tang thuong
              local weiz1008000432=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000432,weiz1008000432,1) 
              --tang thuong
              local weiz1008000433=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000433,weiz1008000433,1) 
              --tang thuong
              local weiz1008000434=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008000434,weiz1008000434,1) 
        end 
