...
--Ten nhiem vu: (±ä·ÏÎª±¦) --- So buoc: (1)
function MissIon9742(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000877=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000877,weiz1000000877,1) 
        end 
