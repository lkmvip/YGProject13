...
function MissIon70(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<63 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000206 = GetQuestItme(UserWorldId, 900000206, 15)  --kiem tra vat pham nhiem vu
              if bool900000206 then --du yeu cau
                  AddQuestItme(UserWorldId,900000206,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000206 ) -- SO LUONG: ( 15 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 235 ) -- Y: ( 418 ) --
