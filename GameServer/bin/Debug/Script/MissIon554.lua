...
function MissIon554(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<43 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 43 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000710 = GetQuestItme(UserWorldId, 900000710, 10)  --kiem tra vat pham nhiem vu
              if bool900000710 then --du yeu cau
                  AddQuestItme(UserWorldId,900000710,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000710 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 474 ) -- Y: ( 429 ) --
        ...
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              local weiz800000001=GetPackages(UserWorldId,2)  --vi tri con trong
                  ...
                  AddExpToCharacter(UserWorldId,310000) 
        end 
