...
function MissIon597(UserWorldId,QuestId, StepQuest, StatusQuest)
  local Player = GetPlayer(UserWorldId)
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<58 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 58 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000761 = GetQuestItme(UserWorldId, 900000761, 10)  --kiem tra vat pham nhiem vu
              if bool900000761 then --du yeu cau
                  AddQuestItme(UserWorldId,900000761,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000761 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1101 ) -- X: ( 418 ) -- Y: ( 457 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,1650000) 
        end 
