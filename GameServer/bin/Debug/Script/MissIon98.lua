...
function MissIon98(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<76 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000282 = GetQuestItme(UserWorldId, 900000282, 10)  --kiem tra vat pham nhiem vu
              if bool900000282 then --du yeu cau
              AddQuestItme(UserWorldId,900000282,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000283,1) --them vat pham nhiem vu cho buoc tiep theo
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000282 ) -- SO LUONG: ( 10 ) -- BUOC: ( 2 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==2 then
              local  bool900000283 = GetQuestItme(UserWorldId, 900000283, 1)  --kiem tra vat pham nhiem vu
              local  bool900000282 = GetQuestItme(UserWorldId, 900000282, 10)  --kiem tra vat pham nhiem vu
              if bool900000283 then --du yeu cau
              if bool900000282 then --du yeu cau
                  AddQuestItme(UserWorldId,900000283,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000282,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000283,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,900000284,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==3 then
              local  bool900000283 = GetQuestItme(UserWorldId, 900000283, 1)  --kiem tra vat pham nhiem vu
              local  bool900000284 = GetQuestItme(UserWorldId, 900000284, 1)  --kiem tra vat pham nhiem vu
              if bool900000283 then --du yeu cau
              if bool900000284 then --du yeu cau
                  AddQuestItme(UserWorldId,900000283,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000284,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000282 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,8800000) 
              --tang thuong
