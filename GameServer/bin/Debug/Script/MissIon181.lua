...
function MissIon181(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<100 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000518 = GetQuestItme(UserWorldId, 900000518, 10)  --kiem tra vat pham nhiem vu
              if bool900000518 then --du yeu cau
                  AddQuestItme(UserWorldId,900000518,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000518 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 5001 ) -- X: ( 237 ) -- Y: ( 285 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000523,1) --them vat pham cho nhiem vu khac
        end 
