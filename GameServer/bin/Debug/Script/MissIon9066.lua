...
--Ten nhiem vu: (传说中的珍宝钥匙) --- So buoc: (1)
function MissIon9066(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1008000081 = GetQuestItme(UserWorldId, 1008000081, 1)  --kiem tra vat pham nhiem vu
              if bool1008000081 then --du yeu cau
                  AddQuestItme(UserWorldId,1008000081,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<1 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,1008000081,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000071=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000071,weiz1000000071,1) 
        end 
