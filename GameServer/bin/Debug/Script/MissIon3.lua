...
--Cac buoc xu li nhiem vu
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<50 then 
          SendSysMsg(UserWorldId,"Ban phai dat cap do 50 moi co the nhan nhiem vu !", 9, "He thong")
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              local  bool900000428 = GetQuestItme(UserWorldId, 900000428, 20)  --kiem tra vat pham nhiem vu
              if bool900000428 then --du yeu cau
              AddQuestItme(UserWorldId,900000428,0) --xoa vat pham nhiem vu
              StatusQuest=2 
...
-- ID VAT PHAM: ( 900000429 ) -- SO LUONG: ( 10 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 301 ) -- X: ( 49 ) -- Y: ( 68 ) --
          ...
          elseif QuestLevel==3 then
              local  bool900000429 = GetQuestItme(UserWorldId, 900000429, 10)  --kiem tra vat pham nhiem vu
              if bool900000429 then --du yeu cau
                  AddQuestItme(UserWorldId,900000429,0) --xoa vat pham nhiem vu
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000428 ) -- SO LUONG: ( 20 ) -- BUOC: ( 4 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000429 ) -- SO LUONG: ( 10 ) -- BUOC: ( 4 ) --
-- BAN DO: ( 101 ) -- X: ( 0 ) -- Y: ( 0 ) --
          ...
          elseif QuestLevel==4 then
              ...
              if bool900000429 then --du yeu cau
                  AddQuestItme(UserWorldId,900000428,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000429,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000430,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==5 then
              ...
              local  bool900000430 = GetQuestItme(UserWorldId, 900000430, 1)  --kiem tra vat pham nhiem vu
              if bool900000430 then --du yeu cau
                  AddQuestItme(UserWorldId,900000430,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000428 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 301 ) -- X: ( 430 ) -- Y: ( 352 ) --
