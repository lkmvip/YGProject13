...
function MissIon1104(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<65 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000751 = GetQuestItme(UserWorldId, 900000751, 10)  --kiem tra vat pham nhiem vu
              if bool900000751 then --du yeu cau
                  AddQuestItme(UserWorldId,900000751,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000751 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1301 ) -- X: ( 74 ) -- Y: ( 155 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              AddQuestItme(UserWorldId,900000462,1) --them vat pham cho nhiem vu khac
        end 
