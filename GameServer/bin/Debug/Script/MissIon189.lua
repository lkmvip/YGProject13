...
--Ten nhiem vu: (Nhiem vu cua Long Ngoc Thanh     ) --- So buoc: (1)
function MissIon189(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<100 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool999000182 = GetQuestItme(UserWorldId, 999000182, 1)  --kiem tra vat pham nhiem vu
              if bool999000182 then --du yeu cau
                  AddQuestItme(UserWorldId,999000182,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<100 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,999000182,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,2000000) 
              AddQuestItme(UserWorldId,909000005,200) --them vat pham cho nhiem vu khac
        end 
