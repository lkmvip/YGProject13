...
--Ten nhiem vu: ([GM] ????? ??? 3/5) --- So buoc: (1)
function MissIon1008(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<0 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000420 = GetQuestItme(UserWorldId, 900000420, 20)  --kiem tra vat pham nhiem vu
              if bool900000420 then --du yeu cau
                  AddQuestItme(UserWorldId,900000420,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000420 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 242 ) -- Y: ( 170 ) --
