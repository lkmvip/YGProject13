...
--Ten nhiem vu: (证物收集令) --- So buoc: (1)
function MissIon9997(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<200 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000703 = GetQuestItme(UserWorldId, 1000000703, 5)  --kiem tra vat pham nhiem vu
              if bool1000000703 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000703,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 1000000703 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1201 ) -- X: ( 171 ) -- Y: ( 266 ) --
