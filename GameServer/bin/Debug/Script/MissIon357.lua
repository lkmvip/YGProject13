...
function MissIon357(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<122 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000619 = GetQuestItme(UserWorldId, 900000619, 1)  --kiem tra vat pham nhiem vu
              if bool900000619 then --du yeu cau
                  AddQuestItme(UserWorldId,900000619,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<122 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,900000619,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000792=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000792,weiz1000000792,1) 
        end 
