...
function MissIon53(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          elseif QuestLevel==2 then
                  AddQuestItme(UserWorldId,900000214,1) --them vat pham nhiem vu cho buoc tiep theo
                  AddQuestItme(UserWorldId,900000215,1) --them vat pham nhiem vu cho buoc tiep theo
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000216 ) -- SO LUONG: ( 2 ) -- BUOC: ( 3 ) --
-- BAN DO: ( 1101 ) -- X: ( 158 ) -- Y: ( 197 ) --
          ...
          elseif QuestLevel==3 then
              local  bool900000214 = GetQuestItme(UserWorldId, 900000214, 1)  --kiem tra vat pham nhiem vu
              local  bool900000215 = GetQuestItme(UserWorldId, 900000215, 1)  --kiem tra vat pham nhiem vu
              local  bool900000216 = GetQuestItme(UserWorldId, 900000216, 2)  --kiem tra vat pham nhiem vu
              if bool900000214 then --du yeu cau
              if bool900000215 then --du yeu cau
              if bool900000216 then --du yeu cau
                  AddQuestItme(UserWorldId,900000214,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000215,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000216,0) --xoa vat pham nhiem vu
          ...
          elseif QuestLevel==4 then
                  AddQuestItme(UserWorldId,900000213,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==5 then
              local  bool900000213 = GetQuestItme(UserWorldId, 900000213, 1)  --kiem tra vat pham nhiem vu
              if bool900000213 then --du yeu cau
                  AddQuestItme(UserWorldId,900000213,0) --xoa vat pham nhiem vu
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000217 ) -- SO LUONG: ( 10 ) -- BUOC: ( 7 ) --
-- BAN DO: ( 1001 ) -- X: ( 83 ) -- Y: ( 463 ) --
          ...
          elseif QuestLevel==7 then
              local  bool900000217 = GetQuestItme(UserWorldId, 900000217, 10)  --kiem tra vat pham nhiem vu
              if bool900000217 then --du yeu cau
                  AddQuestItme(UserWorldId,900000217,0) --xoa vat pham nhiem vu
                  AddQuestItme(UserWorldId,900000218,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==8 then
              local  bool900000218 = GetQuestItme(UserWorldId, 900000218, 1)  --kiem tra vat pham nhiem vu
              if bool900000218 then --du yeu cau
                  AddQuestItme(UserWorldId,900000218,0) --xoa vat pham nhiem vu
          ...
          elseif QuestLevel==9 then
                  AddQuestItme(UserWorldId,900000219,1) --them vat pham nhiem vu cho buoc tiep theo
          ...
          elseif QuestLevel==10 then
              local  bool900000219 = GetQuestItme(UserWorldId, 900000219, 1)  --kiem tra vat pham nhiem vu
              if bool900000219 then --du yeu cau
                  AddQuestItme(UserWorldId,900000219,0) --xoa vat pham nhiem vu
