...
function MissIon137(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<89 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000351 = GetQuestItme(UserWorldId, 900000351, 20)  --kiem tra vat pham nhiem vu
              if bool900000351 then --du yeu cau
                  AddQuestItme(UserWorldId,900000351,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000351 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 2101 ) -- X: ( 226 ) -- Y: ( 149 ) --
