...
function MissIon561(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<37 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000717 = GetQuestItme(UserWorldId, 900000717, 20)  --kiem tra vat pham nhiem vu
              if bool900000717 then --du yeu cau
                  AddQuestItme(UserWorldId,900000717,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000717 ) -- SO LUONG: ( 20 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 201 ) -- X: ( 285 ) -- Y: ( 92 ) --
