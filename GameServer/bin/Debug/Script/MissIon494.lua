...
--Ten nhiem vu: ([GM] _???_[??? 3? ??] ??_?) --- So buoc: (1)
function MissIon494(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<60 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000789 = GetQuestItme(UserWorldId, 900000789, 10)  --kiem tra vat pham nhiem vu
              local  bool900000795 = GetQuestItme(UserWorldId, 900000795, 10)  --kiem tra vat pham nhiem vu
              local  bool900000796 = GetQuestItme(UserWorldId, 900000796, 10)  --kiem tra vat pham nhiem vu
              if bool900000789 then --du yeu cau
              if bool900000795 then --du yeu cau
              if bool900000796 then --du yeu cau
                  AddQuestItme(UserWorldId,900000789,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000795,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,900000796,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000789 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000795 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 0 ) -- Y: ( 0 ) --
 
 
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 900000796 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 1001 ) -- X: ( 0 ) -- Y: ( 0 ) --
