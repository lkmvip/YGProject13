...
function MissIon9709(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<1 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000634 = GetQuestItme(UserWorldId, 1000000634, 1)  --kiem tra vat pham nhiem vu
              if bool1000000634 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000634,0) --xoa item nhiem vu
      ...
      if Player.Player_FLD_LEVEL<1 then  
         ...
         if QuestLevel==2 then 
            SendMissionMsg(UserWorldId,QuestId, 22, StatusQuest) 
                  ...
                  AddQuestItme(UserWorldId,1000000634,1) --them vat pham nhiem vu cho buoc tiep theo
            StatusQuest=1
