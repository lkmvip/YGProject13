...
function MissIon343(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<120 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000788 = GetQuestItme(UserWorldId, 1000000788, 5)  --kiem tra vat pham nhiem vu
              local  bool1000000792 = GetQuestItme(UserWorldId, 1000000792, 2)  --kiem tra vat pham nhiem vu
              local  bool1000000771 = GetQuestItme(UserWorldId, 1000000771, 50)  --kiem tra vat pham nhiem vu
              if bool1000000788 then --du yeu cau
              if bool1000000792 then --du yeu cau
              if bool1000000771 then --du yeu cau
                  AddQuestItme(UserWorldId,1000000788,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,1000000792,0) --xoa item nhiem vu
                  AddQuestItme(UserWorldId,1000000771,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 1000000788 ) -- SO LUONG: ( 5 ) -- BUOC: ( 1 ) --
...
-- VAT PHAM ROT RA KHI DANH QUAI --
-- ID VAT PHAM: ( 1000000771 ) -- SO LUONG: ( 50 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 25100 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1000000789=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000789,weiz1000000789,1) 
        end 
