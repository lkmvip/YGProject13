...
--Ten nhiem vu: (??? ????(30?)) --- So buoc: (1)
function MissIon626(UserWorldId,QuestId, StepQuest, StatusQuest)
      ...
      local controng=GetPackages(UserWorldId,1)  --vi tri con trong
        if controng.Count < 1 then  --neu thung do day 
          ...
          return 
              ...
              --tang thuong
              local weiz1008001511=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1008001511,weiz1008001511,1) 
        end 
