...
function MissIon194(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<10 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool900000409 = GetQuestItme(UserWorldId, 900000409, 10)  --kiem tra vat pham nhiem vu
              if bool900000409 then --du yeu cau
                  AddQuestItme(UserWorldId,900000409,0) --xoa item nhiem vu
...
-- ID VAT PHAM: ( 900000409 ) -- SO LUONG: ( 10 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 101 ) -- X: ( 200 ) -- Y: ( 160 ) --
      ...
      local controng=GetPackages(UserWorldId,3)  --vi tri con trong
        if controng.Count < 3 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,450) 
