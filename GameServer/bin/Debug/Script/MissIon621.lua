...
function MissIon621(UserWorldId,QuestId, StepQuest, StatusQuest)
  ...
  if StepQuest==1 then
      if Player.Player_FLD_LEVEL<120 then 
          ...
          if QuestLevel==1 then  --neu dang o buoc 1
              ...
              local  bool1000000773 = GetQuestItme(UserWorldId, 1000000773, 100)  --kiem tra vat pham nhiem vu
...
-- ID VAT PHAM: ( 1000000773 ) -- SO LUONG: ( 100 ) -- BUOC: ( 1 ) --
-- BAN DO: ( 26000 ) -- X: ( 0 ) -- Y: ( 0 ) --
      ...
      local controng=GetPackages(UserWorldId,2)  --vi tri con trong
        if controng.Count < 2 then  --neu thung do day 
          ...
          return 
                  ...
                  AddExpToCharacter(UserWorldId,1) 
              --tang thuong
              local weiz1000000299=GetPackage(UserWorldId)  --vi tri con trong
                  AddItme(UserWorldId,1000000299,weiz1000000299,1) 
        end 
